...
| `device_build` | `Object` | No |  |
| `device_state` | `Object` | No |  |
| `device_type` | `Object` | No |  |
| `error_counter` | `number` | No |  |
| `error_last_date` | `string` | No |  |
| `id` | `string` | No |  |
| `initialized_by` | `Object` | Yes |  |
| `initialized_date` | `string` | No |  |
| `inject_key` | `Object` | No |  |
| `is_virtual` | `boolean` | No |  |
| `kif` | `Object` | No |  |
| `last_activity_date` | `string` | No |  |
| `location` | `Object` | Yes |  |
| `modified` | `string` | No |  |
| `modified_by` | `Object` | Yes |  |
| `name` | `string` | No |  |
| `note` | `string` | No |  |
| `partner` | `Object` | No |  |
