...
public class DeviceCustodyListEntity extends EntityBase {

  public DeviceCustodyListEntity(SdkClient client, Map<String, Object> entopts) {
    super("device_custody_list", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new DeviceCustodyListEntity(this.client, opts);
  }
