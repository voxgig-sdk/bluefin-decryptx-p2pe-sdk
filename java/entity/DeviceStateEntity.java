...
public class DeviceStateEntity extends EntityBase {

  public DeviceStateEntity(SdkClient client, Map<String, Object> entopts) {
    super("device_state", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new DeviceStateEntity(this.client, opts);
  }
