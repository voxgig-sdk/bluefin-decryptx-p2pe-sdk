...
public class DeviceBuildEntity extends EntityBase {

  public DeviceBuildEntity(SdkClient client, Map<String, Object> entopts) {
    super("device_build", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new DeviceBuildEntity(this.client, opts);
  }
