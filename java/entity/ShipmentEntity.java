...
public class ShipmentEntity extends EntityBase {

  public ShipmentEntity(SdkClient client, Map<String, Object> entopts) {
    super("shipment", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new ShipmentEntity(this.client, opts);
  }
