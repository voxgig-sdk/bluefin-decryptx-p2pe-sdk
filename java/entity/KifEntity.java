...
public class KifEntity extends EntityBase {

  public KifEntity(SdkClient client, Map<String, Object> entopts) {
    super("kif", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new KifEntity(this.client, opts);
  }
