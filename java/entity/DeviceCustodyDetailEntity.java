...
public class DeviceCustodyDetailEntity extends EntityBase {

  public DeviceCustodyDetailEntity(SdkClient client, Map<String, Object> entopts) {
    super("device_custody_detail", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new DeviceCustodyDetailEntity(this.client, opts);
  }
