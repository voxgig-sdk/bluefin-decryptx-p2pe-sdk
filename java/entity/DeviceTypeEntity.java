...
public class DeviceTypeEntity extends EntityBase {

  public DeviceTypeEntity(SdkClient client, Map<String, Object> entopts) {
    super("device_type", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new DeviceTypeEntity(this.client, opts);
  }
