...
public class SuccessEntity extends EntityBase {

  public SuccessEntity(SdkClient client, Map<String, Object> entopts) {
    super("success", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new SuccessEntity(this.client, opts);
  }
