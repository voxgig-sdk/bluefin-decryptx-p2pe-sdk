...
public class DeviceReceiveResultEntity extends EntityBase {

  public DeviceReceiveResultEntity(SdkClient client, Map<String, Object> entopts) {
    super("device_receive_result", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new DeviceReceiveResultEntity(this.client, opts);
  }
