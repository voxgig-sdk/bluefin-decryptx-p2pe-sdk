...
public class DecryptionEntity extends EntityBase {

  public DecryptionEntity(SdkClient client, Map<String, Object> entopts) {
    super("decryption", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new DecryptionEntity(this.client, opts);
  }
