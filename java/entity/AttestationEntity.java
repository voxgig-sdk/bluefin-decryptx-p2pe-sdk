...
public class AttestationEntity extends EntityBase {

  public AttestationEntity(SdkClient client, Map<String, Object> entopts) {
    super("attestation", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new AttestationEntity(this.client, opts);
  }
