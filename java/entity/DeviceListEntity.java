...
public class DeviceListEntity extends EntityBase {

  public DeviceListEntity(SdkClient client, Map<String, Object> entopts) {
    super("device_list", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new DeviceListEntity(this.client, opts);
  }
