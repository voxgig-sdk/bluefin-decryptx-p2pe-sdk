...
public class DeviceRkiActivateResultEntity extends EntityBase {

  public DeviceRkiActivateResultEntity(SdkClient client, Map<String, Object> entopts) {
    super("device_rki_activate_result", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new DeviceRkiActivateResultEntity(this.client, opts);
  }
