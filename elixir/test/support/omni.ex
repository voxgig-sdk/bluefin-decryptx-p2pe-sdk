# BluefinDecryptxP2pe SDK corpus test runner: the vendored @voxgig/omni engine driven
...
# and tm/swift/Tests/BluefinDecryptxP2peSDKTests/OmniResolver.swift.
#
...
defmodule BluefinDecryptxP2pe.Omni do
  ...
  defp sdkprovider(client) do
    utility = BluefinDecryptxP2pe.get_utility(client)
    ...
    %{
      ...
      client: fn options -> sdkprovider(BluefinDecryptxP2pe.test(nil, tostruct(options))) end,
  ...
  def errify(%BluefinDecryptxP2pe.Error{} = err) do
