# Shipment entity test (offline, mock transport)

defmodule BluefinDecryptxP2pe.ShipmentEntityTest do
  use ExUnit.Case
  ...
  defp fixture do
    Json.parse(File.read!("../.sdk/test/entity/shipment/ShipmentTestData.json"))
  end
  ...
  defp first_id do
    existing = H.or_(S.getpath(fixture(), "existing.shipment"), S.jm([]))
  ...
  test "should create instance" do
    ...
    ent = BluefinDecryptxP2pe.shipment(sdk)
    assert ent != nil
  end
  ...
  test "should list records" do
    ...
    result = BluefinDecryptxP2pe.Entity.Shipment.list(ent, S.jm([]))
  ...
  test "should load an existing record" do
    ...
    if id != nil do
      sdk = mk_sdk()
      ent = BluefinDecryptxP2pe.shipment(sdk)
      loaded = BluefinDecryptxP2pe.Entity.Shipment.load(ent, S.jm(["id", id]))
  ...
  test "should create then read back" do
    sdk = BluefinDecryptxP2pe.test(S.jm(["entity", S.jm(["shipment", S.jm([])])]))
    ent = BluefinDecryptxP2pe.shipment(sdk)
    created = BluefinDecryptxP2pe.Entity.Shipment.create(ent, S.jm(["name", "test-create"]))
