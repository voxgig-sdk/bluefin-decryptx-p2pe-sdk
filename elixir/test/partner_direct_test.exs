...
defmodule BluefinDecryptxP2pe.PartnerDirectTest do
  use ExUnit.Case
  ...
  test "should direct list partner" do
    ...
    sdk = mk(canned)
    res = BluefinDecryptxP2pe.direct(sdk, H.deep(%{"path" => "/partner", "method" => "GET", "params" => %{}}))
  ...
  test "should direct load partner" do
    ...
    sdk = mk(canned)
    res = BluefinDecryptxP2pe.direct(sdk, H.deep(%{"path" => "/partner/direct01", "method" => "GET", "params" => %{}}))
    assert S.getprop(res, "ok") == true
    assert H.to_int(S.getprop(res, "status")) == 200
