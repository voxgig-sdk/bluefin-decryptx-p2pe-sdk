# Kif direct test (offline, mock system.fetch)

defmodule BluefinDecryptxP2pe.KifDirectTest do
  use ExUnit.Case
  ...
  test "should direct list kif" do
    canned = S.jt([S.jm(["id", "direct01"]), S.jm(["id", "direct02"])])
    sdk = mk(canned)
    res = BluefinDecryptxP2pe.direct(sdk, H.deep(%{"path" => "/kif", "method" => "GET", "params" => %{}}))
