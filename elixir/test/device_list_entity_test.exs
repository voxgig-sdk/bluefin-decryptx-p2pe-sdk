# DeviceList entity test (offline, mock transport)

defmodule BluefinDecryptxP2pe.DeviceListEntityTest do
  use ExUnit.Case
  ...
  defp fixture do
    Json.parse(File.read!("../.sdk/test/entity/device_list/DeviceListTestData.json"))
  end
  ...
  defp first_id do
    existing = H.or_(S.getpath(fixture(), "existing.device_list"), S.jm([]))
