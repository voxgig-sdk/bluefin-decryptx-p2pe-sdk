...
defmodule BluefinDecryptxP2pe.ClientEntityTest do
  use ExUnit.Case
  ...
  test "should create instance" do
    ...
    ent = BluefinDecryptxP2pe.client(sdk)
    assert ent != nil
  end
  ...
  test "should list records" do
    ...
    result = BluefinDecryptxP2pe.Entity.Client.list(ent, S.jm([]))
  ...
  test "should load an existing record" do
    ...
    if id != nil do
      sdk = mk_sdk()
      ent = BluefinDecryptxP2pe.client(sdk)
      loaded = BluefinDecryptxP2pe.Entity.Client.load(ent, S.jm(["id", id]))
  ...
  test "should create then read back" do
    sdk = BluefinDecryptxP2pe.test(S.jm(["entity", S.jm(["client", S.jm([])])]))
    ent = BluefinDecryptxP2pe.client(sdk)
    created = BluefinDecryptxP2pe.Entity.Client.create(ent, S.jm(["name", "test-create"]))
