# Attestation entity test (offline, mock transport)

defmodule BluefinDecryptxP2pe.AttestationEntityTest do
  use ExUnit.Case
  ...
  defp fixture do
    Json.parse(File.read!("../.sdk/test/entity/attestation/AttestationTestData.json"))
  end
  ...
  defp first_id do
    existing = H.or_(S.getpath(fixture(), "existing.attestation"), S.jm([]))
  ...
  test "should create instance" do
    ...
    ent = BluefinDecryptxP2pe.attestation(sdk)
    assert ent != nil
  end
  ...
  test "should list records" do
    ...
    result = BluefinDecryptxP2pe.Entity.Attestation.list(ent, S.jm([]))
  ...
  test "should load an existing record" do
    ...
    if id != nil do
      sdk = mk_sdk()
      ent = BluefinDecryptxP2pe.attestation(sdk)
      loaded = BluefinDecryptxP2pe.Entity.Attestation.load(ent, S.jm(["id", id]))
  ...
  test "should create then read back" do
    sdk = BluefinDecryptxP2pe.test(S.jm(["entity", S.jm(["attestation", S.jm([])])]))
    ent = BluefinDecryptxP2pe.attestation(sdk)
    created = BluefinDecryptxP2pe.Entity.Attestation.create(ent, S.jm(["name", "test-create"]))
