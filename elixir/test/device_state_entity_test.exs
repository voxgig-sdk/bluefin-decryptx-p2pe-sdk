# DeviceState entity test (offline, mock transport)

defmodule BluefinDecryptxP2pe.DeviceStateEntityTest do
  use ExUnit.Case
  ...
  defp fixture do
    Json.parse(File.read!("../.sdk/test/entity/device_state/DeviceStateTestData.json"))
  end
  ...
  defp first_id do
    existing = H.or_(S.getpath(fixture(), "existing.device_state"), S.jm([]))
