# DeviceCustodyDetail direct test (offline, mock system.fetch)

defmodule BluefinDecryptxP2pe.DeviceCustodyDetailDirectTest do
  use ExUnit.Case
  ...
  test "should direct load device_custody_detail" do
    canned = S.jm(["id", "direct01"])
    sdk = mk(canned)
    res = BluefinDecryptxP2pe.direct(sdk, H.deep(%{"path" => "/device_custody_detail/direct01", "method" => "GET", "params" => %{}}))
