# DeviceState direct test (offline, mock system.fetch)

defmodule BluefinDecryptxP2pe.DeviceStateDirectTest do
  use ExUnit.Case
  ...
  test "should direct list device_state" do
    canned = S.jt([S.jm(["id", "direct01"]), S.jm(["id", "direct02"])])
    sdk = mk(canned)
    res = BluefinDecryptxP2pe.direct(sdk, H.deep(%{"path" => "/device_state", "method" => "GET", "params" => %{}}))
