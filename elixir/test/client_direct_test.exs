...
defmodule BluefinDecryptxP2pe.ClientDirectTest do
  use ExUnit.Case
  ...
  test "should direct list client" do
    ...
    sdk = mk(canned)
    res = BluefinDecryptxP2pe.direct(sdk, H.deep(%{"path" => "/client", "method" => "GET", "params" => %{}}))
  ...
  test "should direct load client" do
    ...
    sdk = mk(canned)
    res = BluefinDecryptxP2pe.direct(sdk, H.deep(%{"path" => "/client/direct01", "method" => "GET", "params" => %{}}))
    assert S.getprop(res, "ok") == true
    assert H.to_int(S.getprop(res, "status")) == 200
