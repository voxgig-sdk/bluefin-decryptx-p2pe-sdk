...
defmodule BluefinDecryptxP2pe do
  alias Voxgig.Struct, as: S
  alias BluefinDecryptxP2pe.Helpers, as: H
  alias BluefinDecryptxP2pe.{Utility, Context, Spec}
    ...
    if S.islist(feature_order) and S.size(feature_order) > 0 do
      Enum.each(0..(S.size(feature_order) - 1), fn i ->
        ...
        if fom != nil and S.getprop(fom, "active") == true do
          Utility.feature_add(rootctx, BluefinDecryptxP2pe.Features.make_feature(fname))
        end
      end)
    end
      ...
      _ ->
        ...
        cond do
          ...
          S.ismap(fetched) ->
            ...
            content_length =
              if S.ismap(headers), do: BluefinDecryptxP2pe.Feature.header_get(headers, "content-length"), else: nil
  ...
  def graphql(client, query, variables \\ nil, ctrl \\ nil) do
    if not op_allowed?(client, "graphql") do
      ...
      if count == 0 do
        ...
        S.setprop(res, "err", "BluefinDecryptxP2peSDK: graphql: " <> msg)
  ...
  @doc "Entity factory for attestation."
  def attestation(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.Attestation.new(client, entopts)
  end

  @doc "Entity factory for client."
  def client(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.Client.new(client, entopts)
  end

  @doc "Entity factory for create_result."
  def create_result(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.CreateResult.new(client, entopts)
  end

  @doc "Entity factory for decryption."
  def decryption(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.Decryption.new(client, entopts)
  end

  @doc "Entity factory for device."
  def device(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.Device.new(client, entopts)
  end

  @doc "Entity factory for device_build."
  def device_build(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.DeviceBuild.new(client, entopts)
  end

  @doc "Entity factory for device_custody_detail."
  def device_custody_detail(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.DeviceCustodyDetail.new(client, entopts)
  end

  @doc "Entity factory for device_custody_list."
  def device_custody_list(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.DeviceCustodyList.new(client, entopts)
  end

  @doc "Entity factory for device_list."
  def device_list(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.DeviceList.new(client, entopts)
  end

  @doc "Entity factory for device_receive_result."
  def device_receive_result(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.DeviceReceiveResult.new(client, entopts)
  end

  @doc "Entity factory for device_rki_activate_result."
  def device_rki_activate_result(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.DeviceRkiActivateResult.new(client, entopts)
  end

  @doc "Entity factory for device_state."
  def device_state(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.DeviceState.new(client, entopts)
  end

  @doc "Entity factory for device_type."
  def device_type(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.DeviceType.new(client, entopts)
  end

  @doc "Entity factory for inject_key."
  def inject_key(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.InjectKey.new(client, entopts)
  end

  @doc "Entity factory for kif."
  def kif(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.Kif.new(client, entopts)
  end

  @doc "Entity factory for location."
  def location(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.Location.new(client, entopts)
  end

  @doc "Entity factory for partner."
  def partner(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.Partner.new(client, entopts)
  end

  @doc "Entity factory for shipment."
  def shipment(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.Shipment.new(client, entopts)
  end

  @doc "Entity factory for success."
  def success(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.Success.new(client, entopts)
  end

  @doc "Entity factory for transaction."
  def transaction(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.Transaction.new(client, entopts)
  end

  @doc "Entity factory for update_result."
  def update_result(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.UpdateResult.new(client, entopts)
  end

  @doc "Entity factory for user."
  def user(client, entopts \\ nil) do
    BluefinDecryptxP2pe.Entity.User.new(client, entopts)
  end
