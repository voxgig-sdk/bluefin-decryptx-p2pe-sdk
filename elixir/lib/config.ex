...
# BluefinDecryptxP2pe.Helpers.deep/1). Do not edit by hand.

defmodule BluefinDecryptxP2pe.Config do
  def make_config do
    BluefinDecryptxP2pe.Helpers.deep(%{
      "main" => %{"name" => "BluefinDecryptxP2pe"},
      "feature" => %{
        "test" => %{
          "options" => %{
            "active" => false
