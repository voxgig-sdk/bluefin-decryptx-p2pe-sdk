...
defmodule BluefinDecryptxP2pe.Types do
  ...
  Members:
    * `"created"` — String.t() (optional)
    * `"deviceTypeMode"` — String.t() (optional)
    * `"hardwareVersion"` — String.t() (optional)
    * `"id"` — String.t() (optional)
    * `"isActive"` — boolean() (optional)
