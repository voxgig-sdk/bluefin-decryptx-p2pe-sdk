...
defmodule BluefinDecryptxP2pe.Entity.DeviceRkiActivateResult do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "device_rki_activate_result", entopts)
  end
  ...
  # Returns the created device_rki_activate_result entity map (BluefinDecryptxP2pe.Types.device_rki_activate_result/0)
  ...
  @spec create(map(), BluefinDecryptxP2pe.Types.device_rki_activate_result_create_data() | nil, map() | nil) :: term()
