...
defmodule BluefinDecryptxP2pe.Entity.Kif do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "kif", entopts)
  end
  ...
  # Returns a list of kif entity maps (BluefinDecryptxP2pe.Types.kif/0)
  ...
  @spec list(map(), BluefinDecryptxP2pe.Types.kif_list_match() | nil, map() | nil) :: term()
