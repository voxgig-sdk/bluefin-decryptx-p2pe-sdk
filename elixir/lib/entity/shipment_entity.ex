...
defmodule BluefinDecryptxP2pe.Entity.Shipment do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "shipment", entopts)
  end
  ...
  # Returns the shipment entity map (BluefinDecryptxP2pe.Types.shipment/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinDecryptxP2pe.Types.shipment_load_match() | nil, map() | nil) :: term()
  ...
  # Returns a list of shipment entity maps (BluefinDecryptxP2pe.Types.shipment/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec list(map(), BluefinDecryptxP2pe.Types.shipment_list_match() | nil, map() | nil) :: term()
  ...
  # Returns the created shipment entity map (BluefinDecryptxP2pe.Types.shipment/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec create(map(), BluefinDecryptxP2pe.Types.shipment_create_data() | nil, map() | nil) :: term()
