...
defmodule BluefinDecryptxP2pe.Entity.DeviceList do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "device_list", entopts)
  end
  ...
  # Returns the device_list entity map (BluefinDecryptxP2pe.Types.device_list/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinDecryptxP2pe.Types.device_list_load_match() | nil, map() | nil) :: term()
