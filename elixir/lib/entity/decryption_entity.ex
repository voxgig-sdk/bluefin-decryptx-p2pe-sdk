...
defmodule BluefinDecryptxP2pe.Entity.Decryption do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "decryption", entopts)
  end
  ...
  # Returns the created decryption entity map (BluefinDecryptxP2pe.Types.decryption/0)
  ...
  @spec create(map(), BluefinDecryptxP2pe.Types.decryption_create_data() | nil, map() | nil) :: term()
