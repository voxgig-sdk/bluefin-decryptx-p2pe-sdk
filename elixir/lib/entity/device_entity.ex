...
defmodule BluefinDecryptxP2pe.Entity.Device do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "device", entopts)
  end
  ...
  # Returns the device entity map (BluefinDecryptxP2pe.Types.device/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinDecryptxP2pe.Types.device_load_match() | nil, map() | nil) :: term()
  ...
  # Returns a list of device entity maps (BluefinDecryptxP2pe.Types.device/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec list(map(), BluefinDecryptxP2pe.Types.device_list_match() | nil, map() | nil) :: term()
  ...
  # Returns the created device entity map (BluefinDecryptxP2pe.Types.device/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec create(map(), BluefinDecryptxP2pe.Types.device_create_data() | nil, map() | nil) :: term()
