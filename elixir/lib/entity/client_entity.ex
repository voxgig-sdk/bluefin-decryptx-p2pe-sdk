...
defmodule BluefinDecryptxP2pe.Entity.Client do
  ...
  # Returns the client entity map (BluefinDecryptxP2pe.Types.client/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinDecryptxP2pe.Types.client_load_match() | nil, map() | nil) :: term()
  ...
  # Returns a list of client entity maps (BluefinDecryptxP2pe.Types.client/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec list(map(), BluefinDecryptxP2pe.Types.client_list_match() | nil, map() | nil) :: term()
  ...
  # Returns the created client entity map (BluefinDecryptxP2pe.Types.client/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec create(map(), BluefinDecryptxP2pe.Types.client_create_data() | nil, map() | nil) :: term()
  ...
  # Returns the removed client entity map (BluefinDecryptxP2pe.Types.client/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec remove(map(), BluefinDecryptxP2pe.Types.client_remove_match() | nil, map() | nil) :: term()
