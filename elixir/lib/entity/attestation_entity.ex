...
defmodule BluefinDecryptxP2pe.Entity.Attestation do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "attestation", entopts)
  end
  ...
  # Returns the attestation entity map (BluefinDecryptxP2pe.Types.attestation/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinDecryptxP2pe.Types.attestation_load_match() | nil, map() | nil) :: term()
  ...
  # Returns a list of attestation entity maps (BluefinDecryptxP2pe.Types.attestation/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec list(map(), BluefinDecryptxP2pe.Types.attestation_list_match() | nil, map() | nil) :: term()
  ...
  # Returns the created attestation entity map (BluefinDecryptxP2pe.Types.attestation/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec create(map(), BluefinDecryptxP2pe.Types.attestation_create_data() | nil, map() | nil) :: term()
