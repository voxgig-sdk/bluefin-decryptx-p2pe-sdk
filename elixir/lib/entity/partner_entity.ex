...
defmodule BluefinDecryptxP2pe.Entity.Partner do
  ...
  # Returns the partner entity map (BluefinDecryptxP2pe.Types.partner/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinDecryptxP2pe.Types.partner_load_match() | nil, map() | nil) :: term()
  ...
  # Returns a list of partner entity maps (BluefinDecryptxP2pe.Types.partner/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec list(map(), BluefinDecryptxP2pe.Types.partner_list_match() | nil, map() | nil) :: term()
  ...
  # Returns the created partner entity map (BluefinDecryptxP2pe.Types.partner/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec create(map(), BluefinDecryptxP2pe.Types.partner_create_data() | nil, map() | nil) :: term()
