...
defmodule BluefinDecryptxP2pe.Entity.DeviceCustodyList do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "device_custody_list", entopts)
  end
  ...
  # Returns a list of device_custody_list entity maps (BluefinDecryptxP2pe.Types.device_custody_list/0)
  ...
  @spec list(map(), BluefinDecryptxP2pe.Types.device_custody_list_list_match() | nil, map() | nil) :: term()
