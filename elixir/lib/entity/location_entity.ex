...
defmodule BluefinDecryptxP2pe.Entity.Location do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "location", entopts)
  end
  ...
  # Returns the location entity map (BluefinDecryptxP2pe.Types.location/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinDecryptxP2pe.Types.location_load_match() | nil, map() | nil) :: term()
  ...
  # Returns a list of location entity maps (BluefinDecryptxP2pe.Types.location/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec list(map(), BluefinDecryptxP2pe.Types.location_list_match() | nil, map() | nil) :: term()
  ...
  # Returns the created location entity map (BluefinDecryptxP2pe.Types.location/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec create(map(), BluefinDecryptxP2pe.Types.location_create_data() | nil, map() | nil) :: term()
  ...
  # Returns the removed location entity map (BluefinDecryptxP2pe.Types.location/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec remove(map(), BluefinDecryptxP2pe.Types.location_remove_match() | nil, map() | nil) :: term()
