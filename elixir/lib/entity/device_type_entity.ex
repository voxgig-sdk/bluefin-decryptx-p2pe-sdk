...
defmodule BluefinDecryptxP2pe.Entity.DeviceType do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "device_type", entopts)
  end
  ...
  # Returns the device_type entity map (BluefinDecryptxP2pe.Types.device_type/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinDecryptxP2pe.Types.device_type_load_match() | nil, map() | nil) :: term()
  ...
  # Returns a list of device_type entity maps (BluefinDecryptxP2pe.Types.device_type/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec list(map(), BluefinDecryptxP2pe.Types.device_type_list_match() | nil, map() | nil) :: term()
