...
defmodule BluefinDecryptxP2pe.Entity.User do
  ...
  # Returns the user entity map (BluefinDecryptxP2pe.Types.user/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinDecryptxP2pe.Types.user_load_match() | nil, map() | nil) :: term()
  ...
  # Returns the removed user entity map (BluefinDecryptxP2pe.Types.user/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec remove(map(), BluefinDecryptxP2pe.Types.user_remove_match() | nil, map() | nil) :: term()
