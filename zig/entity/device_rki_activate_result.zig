// DeviceRkiActivateResult entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EntResult = union(enum) {
    ok: *DeviceRkiActivateResultEntity,
...
pub const DeviceRkiActivateResultEntity = struct {
    name: []const u8 = "device_rki_activate_result",
    ...
    pub fn new(client: *sdk.BluefinDecryptxP2peSDK, entopts_in: Value) *DeviceRkiActivateResultEntity {
        ...
        const e = h.A().create(DeviceRkiActivateResultEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *DeviceRkiActivateResultEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *DeviceRkiActivateResultEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *DeviceRkiActivateResultEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *DeviceRkiActivateResultEntity, ctx: *Context, post_done: *const fn (*DeviceRkiActivateResultEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *DeviceRkiActivateResultEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *DeviceRkiActivateResultEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *DeviceRkiActivateResultEntity, ctx: *Context, post_done: *const fn (*DeviceRkiActivateResultEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *DeviceRkiActivateResultEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *DeviceRkiActivateResultEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return DeviceRkiActivateResultEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *DeviceRkiActivateResultEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *DeviceRkiActivateResultEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *DeviceRkiActivateResultEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *DeviceRkiActivateResultEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *DeviceRkiActivateResultEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *DeviceRkiActivateResultEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *DeviceRkiActivateResultEntity, ctx: *Context) void {
    ...
    pub fn update(self: *DeviceRkiActivateResultEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *DeviceRkiActivateResultEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
