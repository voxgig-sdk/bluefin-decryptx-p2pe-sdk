...
pub const DeviceRkiActivateResultEntity = struct {
    ...
    pub fn load(self: *DeviceRkiActivateResultEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *DeviceRkiActivateResultEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *DeviceRkiActivateResultEntity, reqdata: Value, ctrl: Value) OpResult {
    ...
    pub fn update(self: *DeviceRkiActivateResultEntity, _reqdata: Value, _ctrl: Value) OpResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *DeviceRkiActivateResultEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
