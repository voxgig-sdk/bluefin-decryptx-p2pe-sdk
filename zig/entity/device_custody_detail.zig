// DeviceCustodyDetail entity client (generated — mirrors the go/rust Entity fragment).
...
pub const DeviceCustodyDetailEntity = struct {
    name: []const u8 = "device_custody_detail",
    ...
    pub fn new(client: *sdk.BluefinDecryptxP2peSDK, entopts_in: Value) *DeviceCustodyDetailEntity {
        ...
        const e = h.A().create(DeviceCustodyDetailEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *DeviceCustodyDetailEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *DeviceCustodyDetailEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *DeviceCustodyDetailEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *DeviceCustodyDetailEntity, ctx: *Context, post_done: *const fn (*DeviceCustodyDetailEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *DeviceCustodyDetailEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *DeviceCustodyDetailEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *DeviceCustodyDetailEntity, ctx: *Context, post_done: *const fn (*DeviceCustodyDetailEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *DeviceCustodyDetailEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *DeviceCustodyDetailEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return DeviceCustodyDetailEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *DeviceCustodyDetailEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *DeviceCustodyDetailEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *DeviceCustodyDetailEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *DeviceCustodyDetailEntity, reqmatch: Value, ctrl: Value) EntResult {
    ...
    fn load_post_done(self: *DeviceCustodyDetailEntity, ctx: *Context) void {
    ...
    pub fn list(self: *DeviceCustodyDetailEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("list", self.name) };
    }

    pub fn create(self: *DeviceCustodyDetailEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("create", self.name) };
    }

    pub fn update(self: *DeviceCustodyDetailEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *DeviceCustodyDetailEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
