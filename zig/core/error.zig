// BluefinDecryptxP2peError: the SDK error type (mirrors go core/error.go / the rust
...
pub const BluefinDecryptxP2peError = struct {
    sdk: []const u8 = "BluefinDecryptxP2pe",
    code: []const u8,
    msg: []const u8,
    ...
    pub fn make(code: []const u8, msg: []const u8) *BluefinDecryptxP2peError {
        const e = mem.a().create(BluefinDecryptxP2peError) catch unreachable;
        e.* = .{ .sdk = "BluefinDecryptxP2pe", .code = code, .msg = msg };
        return e;
    }
};
