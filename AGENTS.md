# BluefinDecryptxP2pe SDK — Agent Guide
...
**Entities** (22): `Attestation`, `Client`, `CreateResult`, `Decryption`, `Device`, `DeviceBuild`, `DeviceCustodyDetail`, `DeviceCustodyList`, `DeviceList`, `DeviceReceiveResult`, `DeviceRkiActivateResult`, `DeviceState`, `DeviceType`, `InjectKey`, `Kif`, `Location`, `Partner`, `Shipment`, `Success`, `Transaction`, `UpdateResult`, `User`.
