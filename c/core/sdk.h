// BluefinDecryptxP2pe SDK — umbrella runtime header (template; BluefinDecryptxP2pe tokens
...
#ifndef BLUEFINDECRYPTXP2PE_SDK_H
#define BLUEFINDECRYPTXP2PE_SDK_H
...
typedef struct BluefinDecryptxP2peSDK BluefinDecryptxP2peSDK;
...
// ===========================================================================
// Error (mirrors core/error.rs BluefinDecryptxP2peError)
// ===========================================================================

typedef struct PNError {
  char* sdk;   // "BluefinDecryptxP2pe"
...
// ===========================================================================
// Entity (vtable; mirrors core/types.rs Entity + BluefinDecryptxP2peEntity)
// ===========================================================================
...
typedef struct EntityVT {
  ...
  // CRUD ops (BluefinDecryptxP2peEntity). On error set *err and return NULL.
...
// ===========================================================================
// SDK client (mirrors Main.fragment BluefinDecryptxP2peSDK) — generic fields.
// ===========================================================================

struct BluefinDecryptxP2peSDK {
  char* mode;             // "live" | "test"
  voxgig_value* options;
  Utility* utility;
...
void sdk_features_push(BluefinDecryptxP2peSDK* sdk, Feature* f);
void sdk_features_insert(BluefinDecryptxP2peSDK* sdk, size_t i, Feature* f);
void sdk_features_replace(BluefinDecryptxP2peSDK* sdk, size_t i, Feature* f);

voxgig_value* sdk_options_map(BluefinDecryptxP2peSDK* sdk); // deep clone of options
Utility* sdk_get_utility(BluefinDecryptxP2peSDK* sdk);      // utility_copy
Context* sdk_get_root_ctx(BluefinDecryptxP2peSDK* sdk);

// Constructors / prepare / direct are in the generated client.c:
BluefinDecryptxP2peSDK* bluefindecryptxp2pe_sdk_new(voxgig_value* options);
BluefinDecryptxP2peSDK* test_sdk(voxgig_value* testopts, voxgig_value* sdkopts);
voxgig_value* sdk_prepare(BluefinDecryptxP2peSDK* sdk, voxgig_value* fetchargs, PNError** err);
voxgig_value* sdk_direct(BluefinDecryptxP2peSDK* sdk, voxgig_value* fetchargs, PNError** err);
voxgig_value* sdk_graphql(BluefinDecryptxP2peSDK* sdk, const char* query,
...
#endif // BLUEFINDECRYPTXP2PE_SDK_H
