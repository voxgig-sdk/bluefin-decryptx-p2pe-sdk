...
int main(void) {
  ...
  Entity* e = bluefin_decryptx_p2pe_device_list(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_decryptx_p2pe_device_list(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = device_list_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_decryptx_p2pe_device_list(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = device_list_stream(pe, "list", NULL, NULL, &perr);
