// Generated instance test for the shipment entity.
...
int main(void) {
  ...
  Entity* e = bluefin_decryptx_p2pe_shipment(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "shipment", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_decryptx_p2pe_shipment(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = shipment_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_decryptx_p2pe_shipment(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = shipment_stream(pe, "list", NULL, NULL, &perr);
