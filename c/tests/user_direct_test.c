...
static BluefinDecryptxP2peSDK* user_direct_setup(voxgig_value* mockres) {
...
int main(void) {
  ...
  // LOAD
  {
    ...
    BluefinDecryptxP2peSDK* sdk = user_direct_setup(mockres);
  ...
  TEST_SUMMARY("bluefin_decryptx_p2pe_user_direct");
}
