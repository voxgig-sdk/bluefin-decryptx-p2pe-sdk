...
int main(void) {
  ...
  Entity* e = bluefin_decryptx_p2pe_success(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_decryptx_p2pe_success(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = success_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_decryptx_p2pe_success(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = success_stream(pe, "list", NULL, NULL, &perr);
