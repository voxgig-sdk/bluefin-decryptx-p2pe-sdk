...
int main(void) {
  ...
  Entity* e = bluefindecryptxp2pe_device_build(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefindecryptxp2pe_device_build(strsdk, NULL);
    PNError* serr = NULL;
    ...
    Entity* pe = bluefindecryptxp2pe_device_build(plainsdk, NULL);
    PNError* perr = NULL;
