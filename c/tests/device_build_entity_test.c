// Generated instance test for the device_build entity.
...
int main(void) {
  ...
  Entity* e = bluefin_decryptx_p2pe_device_build(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "device_build", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_decryptx_p2pe_device_build(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = device_build_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_decryptx_p2pe_device_build(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = device_build_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("device_build_entity");
}
