...
static Context* corpus_ctx(BluefinDecryptxP2peSDK* cl, voxgig_value* ctxmap) {
  CtxSpec cs;
...
static void runset(const char* name, BluefinDecryptxP2peSDK* cl,
                        ctxfn cf, argfn af) {
...
static BluefinDecryptxP2peSDK* SHARED = NULL;
...
static BluefinDecryptxP2peSDK* client_for(const char* section) {
