...
static BluefinDecryptxP2peSDK* transaction_direct_setup(voxgig_value* mockres) {
...
int main(void) {
  ...
  // LIST
  {
    ...
    BluefinDecryptxP2peSDK* sdk = transaction_direct_setup(mockres);
  ...
  TEST_SUMMARY("bluefin_decryptx_p2pe_transaction_direct");
}
