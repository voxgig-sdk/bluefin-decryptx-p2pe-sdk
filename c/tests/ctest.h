// Minimal C test harness for the BluefinDecryptxP2pe SDK test binaries. Each test
...
#ifndef BLUEFINDECRYPTXP2PE_CTEST_H
#define BLUEFINDECRYPTXP2PE_CTEST_H
...
#endif // BLUEFINDECRYPTXP2PE_CTEST_H
