...
static BluefinDecryptxP2peSDK* update_result_direct_setup(voxgig_value* mockres) {
...
int main(void) {
  ...
  // LIST
  {
    ...
    BluefinDecryptxP2peSDK* sdk = update_result_direct_setup(mockres);
  ...
  TEST_SUMMARY("bluefin_decryptx_p2pe_update_result_direct");
}
