...
static BluefinDecryptxP2peSDK* C;
static Utility* U;
...
static void test_primary_fetcher_live(void) {
  ...
  BluefinDecryptxP2peSDK* live = bluefindecryptxp2pe_sdk_new(
...
static void test_primary_fetcher_blocked_test_mode(void) {
  BluefinDecryptxP2peSDK* blocked = bluefindecryptxp2pe_sdk_new(
...
static void test_primary_new_sdk_smoke(void) {
  BluefinDecryptxP2peSDK* client = bluefindecryptxp2pe_sdk_new(v_undef());
