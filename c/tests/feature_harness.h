// Behavioural feature-test harness for the BluefinDecryptxP2pe SDK (C port of the
...
#ifndef BLUEFINDECRYPTXP2PE_FEATURE_HARNESS_H
#define BLUEFINDECRYPTXP2PE_FEATURE_HARNESS_H
...
#endif // BLUEFINDECRYPTXP2PE_FEATURE_HARNESS_H
