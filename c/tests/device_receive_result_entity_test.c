...
int main(void) {
  ...
  Entity* e = bluefin_decryptx_p2pe_device_receive_result(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_decryptx_p2pe_device_receive_result(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = device_receive_result_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_decryptx_p2pe_device_receive_result(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = device_receive_result_stream(pe, "list", NULL, NULL, &perr);
