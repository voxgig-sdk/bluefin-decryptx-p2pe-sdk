...
int main(void) {
  ...
  Entity* e = bluefindecryptxp2pe_attestation(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefindecryptxp2pe_attestation(strsdk, NULL);
    PNError* serr = NULL;
    ...
    Entity* pe = bluefindecryptxp2pe_attestation(plainsdk, NULL);
    PNError* perr = NULL;
