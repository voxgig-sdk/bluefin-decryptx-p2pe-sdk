// Generated instance test for the attestation entity.
...
int main(void) {
  ...
  Entity* e = bluefin_decryptx_p2pe_attestation(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "attestation", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_decryptx_p2pe_attestation(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = attestation_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_decryptx_p2pe_attestation(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = attestation_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("attestation_entity");
}
