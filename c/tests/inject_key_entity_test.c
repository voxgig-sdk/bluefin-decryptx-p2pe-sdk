...
int main(void) {
  ...
  Entity* e = bluefindecryptxp2pe_inject_key(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefindecryptxp2pe_inject_key(strsdk, NULL);
    PNError* serr = NULL;
    ...
    Entity* pe = bluefindecryptxp2pe_inject_key(plainsdk, NULL);
    PNError* perr = NULL;
