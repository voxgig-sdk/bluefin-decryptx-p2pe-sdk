// Generated instance test for the inject_key entity.
...
int main(void) {
  ...
  Entity* e = bluefin_decryptx_p2pe_inject_key(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "inject_key", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_decryptx_p2pe_inject_key(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = inject_key_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_decryptx_p2pe_inject_key(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = inject_key_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("inject_key_entity");
}
