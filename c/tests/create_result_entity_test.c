...
int main(void) {
  ...
  Entity* e = bluefin_decryptx_p2pe_create_result(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_decryptx_p2pe_create_result(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = create_result_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_decryptx_p2pe_create_result(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = create_result_stream(pe, "list", NULL, NULL, &perr);
