// Generated instance test for the location entity.
...
int main(void) {
  ...
  Entity* e = bluefin_decryptx_p2pe_location(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "location", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_decryptx_p2pe_location(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = location_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_decryptx_p2pe_location(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = location_stream(pe, "list", NULL, NULL, &perr);
