...
int main(void) {
  ...
  Entity* e = bluefin_decryptx_p2pe_transaction(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_decryptx_p2pe_transaction(strsdk, NULL);
    PNError* serr = NULL;
    ...
    Entity* pe = bluefin_decryptx_p2pe_transaction(plainsdk, NULL);
    PNError* perr = NULL;
