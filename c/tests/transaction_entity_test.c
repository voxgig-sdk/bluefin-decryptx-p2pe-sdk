...
int main(void) {
  ...
  Entity* e = bluefindecryptxp2pe_transaction(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefindecryptxp2pe_transaction(strsdk, NULL);
    PNError* serr = NULL;
    ...
    Entity* pe = bluefindecryptxp2pe_transaction(plainsdk, NULL);
    PNError* perr = NULL;
