...
static BluefinDecryptxP2peSDK* partner_direct_setup(voxgig_value* mockres) {
...
int main(void) {
  ...
  // LIST
  {
    ...
    BluefinDecryptxP2peSDK* sdk = partner_direct_setup(mockres);
  ...
  TEST_SUMMARY("bluefin_decryptx_p2pe_partner_direct");
}
