// Generated instance test for the device entity.
...
int main(void) {
  ...
  Entity* e = bluefin_decryptx_p2pe_device(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "device", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_decryptx_p2pe_device(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = device_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_decryptx_p2pe_device(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = device_stream(pe, "list", NULL, NULL, &perr);
