...
int main(void) {
  ...
  BluefinDecryptxP2peSDK* t = test_sdk(NULL, NULL);
  ...
  BluefinDecryptxP2peSDK* sdk = bluefindecryptxp2pe_sdk_new(opts);
  ...
  BluefinDecryptxP2peSDK* rsdk = bluefindecryptxp2pe_sdk_new(ropts);
  PNError* rerr = NULL;
