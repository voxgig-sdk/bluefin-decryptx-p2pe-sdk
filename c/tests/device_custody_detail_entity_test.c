...
int main(void) {
  ...
  Entity* e = bluefin_decryptx_p2pe_device_custody_detail(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_decryptx_p2pe_device_custody_detail(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = device_custody_detail_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_decryptx_p2pe_device_custody_detail(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = device_custody_detail_stream(pe, "list", NULL, NULL, &perr);
