...
int main(void) {
  ...
  Entity* e = bluefindecryptxp2pe_device_custody_list(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefindecryptxp2pe_device_custody_list(strsdk, NULL);
    PNError* serr = NULL;
    ...
    Entity* pe = bluefindecryptxp2pe_device_custody_list(plainsdk, NULL);
    PNError* perr = NULL;
