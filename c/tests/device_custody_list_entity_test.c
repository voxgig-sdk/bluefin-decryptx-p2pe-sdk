// Generated instance test for the device_custody_list entity.
...
int main(void) {
  ...
  Entity* e = bluefin_decryptx_p2pe_device_custody_list(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "device_custody_list", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_decryptx_p2pe_device_custody_list(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = device_custody_list_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_decryptx_p2pe_device_custody_list(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = device_custody_list_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("device_custody_list_entity");
}
