...
int main(void) {
  ...
  Entity* e = bluefin_decryptx_p2pe_decryption(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_decryptx_p2pe_decryption(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = decryption_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_decryptx_p2pe_decryption(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = decryption_stream(pe, "list", NULL, NULL, &perr);
