...
static BluefinDecryptxP2peSDK* client_direct_setup(voxgig_value* mockres) {
...
int main(void) {
  ...
  // LIST
  {
    ...
    BluefinDecryptxP2peSDK* sdk = client_direct_setup(mockres);
  ...
  TEST_SUMMARY("bluefin_decryptx_p2pe_client_direct");
}
