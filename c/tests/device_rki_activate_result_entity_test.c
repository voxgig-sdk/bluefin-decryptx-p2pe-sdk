// Generated instance test for the device_rki_activate_result entity.
...
int main(void) {
  ...
  Entity* e = bluefin_decryptx_p2pe_device_rki_activate_result(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "device_rki_activate_result", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "device_rki_activate_result",
        cmap(2,
    ...
    Entity* se = bluefin_decryptx_p2pe_device_rki_activate_result(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = device_rki_activate_result_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_decryptx_p2pe_device_rki_activate_result(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = device_rki_activate_result_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("device_rki_activate_result_entity");
}
