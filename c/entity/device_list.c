// DeviceList entity client (generated — mirrors the rust Entity fragment).
...
typedef struct device_list_entity {
...
typedef void (*device_list_postdone_fn)(device_list_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT device_list_VT;
static const char* device_list_get_name(Entity* e);
static Entity* device_list_make(Entity* e);
static voxgig_value* device_list_data(Entity* e, voxgig_value* args);
static voxgig_value* device_list_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* device_list_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** device_list_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* device_list_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* device_list_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* device_list_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void device_list_mark_deleted(Entity* e);
static bool device_list_deleted(Entity* e);

static Context* device_list_ent_ctx(device_list_entity* self) {
  return self->entctx;
}
...
Entity* device_list_entity_new(BluefinDecryptxP2peSDK* client, voxgig_value* entopts) {
  ...
  device_list_entity* self = (device_list_entity*)calloc(1, sizeof(device_list_entity));
  self->base.vt = &device_list_VT;
  self->name = strdup("device_list");
  self->client = client;
...
static voxgig_value* device_list_run_op(device_list_entity* self, Context* ctx,
                                    device_list_postdone_fn post_done, PNError** err) {
...
voxgig_value* device_list_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  device_list_entity* self = (device_list_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, device_list_ent_ctx(self));
...
static const char* device_list_get_name(Entity* e) {
  return ((device_list_entity*)e)->name;
}
...
static Entity* device_list_make(Entity* e) {
  ...
  return device_list_entity_new(self->client, opts);
}
...
static voxgig_value* device_list_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(device_list_ent_ctx(self), "SetData");
  }
  feature_hook_util(device_list_ent_ctx(self), "GetData");
...
static voxgig_value* device_list_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(device_list_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(device_list_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void device_list_load_postdone(device_list_entity* self, Context* ctx) {
...
static Entity* device_list_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, device_list_ent_ctx(self));
  device_list_run_op(self, ctx, device_list_load_postdone, err);
  if (*err) return NULL;
...
static Entity** device_list_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "device_list");
  return NULL;
}

static Entity* device_list_create(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("create", "device_list");
  return NULL;
}

static Entity* device_list_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "device_list");
  return NULL;
}

static Entity* device_list_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "device_list");
  return NULL;
}
...
// live record.
static void device_list_mark_deleted(Entity* e) {
  ((device_list_entity*)e)->deleted = true;
}

static bool device_list_deleted(Entity* e) {
  return ((device_list_entity*)e)->deleted;
}

static const EntityVT device_list_VT = {
  device_list_get_name,
  device_list_make,
  device_list_data,
  device_list_matchv,
  device_list_mark_deleted,
  device_list_deleted,
  device_list_load,
  device_list_list,
  device_list_create,
