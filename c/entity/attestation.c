...
static Entity* attestation_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** attestation_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* attestation_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* attestation_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* attestation_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void attestation_mark_deleted(Entity* e);
static bool attestation_deleted(Entity* e);
...
static Entity* attestation_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, attestation_ent_ctx(self));
  attestation_run_op(self, ctx, attestation_load_postdone, err);
  if (*err) return NULL;
...
static Entity** attestation_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, attestation_ent_ctx(self));
  voxgig_value* out = attestation_run_op(self, ctx, attestation_list_postdone, err);
  if (*err) return NULL;
...
static Entity* attestation_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, attestation_ent_ctx(self));
  attestation_run_op(self, ctx, attestation_create_postdone, err);
  if (*err) return NULL;
...
static Entity* attestation_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "attestation");
  return NULL;
}

static Entity* attestation_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
...
// live record.
static void attestation_mark_deleted(Entity* e) {
  ((attestation_entity*)e)->deleted = true;
}

static bool attestation_deleted(Entity* e) {
  return ((attestation_entity*)e)->deleted;
}
