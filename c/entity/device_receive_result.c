// DeviceReceiveResult entity client (generated — mirrors the rust Entity fragment).
...
typedef struct device_receive_result_entity {
...
static const char* device_receive_result_get_name(Entity* e);
...
Entity* device_receive_result_entity_new(BluefinDecryptxP2peSDK* client, voxgig_value* entopts) {
  ...
  device_receive_result_entity* self = (device_receive_result_entity*)calloc(1, sizeof(device_receive_result_entity));
  self->base.vt = &device_receive_result_VT;
  self->name = strdup("device_receive_result");
  self->client = client;
...
static voxgig_value* device_receive_result_run_op(device_receive_result_entity* self, Context* ctx,
                                    device_receive_result_postdone_fn post_done, PNError** err) {
...
voxgig_value* device_receive_result_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* device_receive_result_get_name(Entity* e) {
  return ((device_receive_result_entity*)e)->name;
}
...
static Entity* device_receive_result_make(Entity* e) {
  ...
  return device_receive_result_entity_new(self->client, opts);
}
...
static voxgig_value* device_receive_result_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(device_receive_result_ent_ctx(self), "SetData");
  }
  feature_hook_util(device_receive_result_ent_ctx(self), "GetData");
...
static voxgig_value* device_receive_result_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(device_receive_result_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(device_receive_result_ent_ctx(self), "GetMatch");
...
static void device_receive_result_create_postdone(device_receive_result_entity* self, Context* ctx) {
...
static const EntityVT device_receive_result_VT = {
  device_receive_result_get_name,
  ...
  device_receive_result_update,
  device_receive_result_remove,
};
