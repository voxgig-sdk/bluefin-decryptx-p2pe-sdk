// Decryption entity client (generated — mirrors the rust Entity fragment).
...
typedef struct decryption_entity {
...
static const char* decryption_get_name(Entity* e);
...
Entity* decryption_entity_new(BluefinDecryptxP2peSDK* client, voxgig_value* entopts) {
  ...
  decryption_entity* self = (decryption_entity*)calloc(1, sizeof(decryption_entity));
  self->base.vt = &decryption_VT;
  self->name = strdup("decryption");
  self->client = client;
...
static voxgig_value* decryption_run_op(decryption_entity* self, Context* ctx,
                                    decryption_postdone_fn post_done, PNError** err) {
...
voxgig_value* decryption_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* decryption_get_name(Entity* e) {
  return ((decryption_entity*)e)->name;
}
...
static Entity* decryption_make(Entity* e) {
  ...
  return decryption_entity_new(self->client, opts);
}
...
static voxgig_value* decryption_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(decryption_ent_ctx(self), "SetData");
  }
  feature_hook_util(decryption_ent_ctx(self), "GetData");
...
static voxgig_value* decryption_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(decryption_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(decryption_ent_ctx(self), "GetMatch");
...
static void decryption_create_postdone(decryption_entity* self, Context* ctx) {
