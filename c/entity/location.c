// Location entity client (generated — mirrors the rust Entity fragment).
...
typedef struct location_entity {
...
typedef void (*location_postdone_fn)(location_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT location_VT;
static const char* location_get_name(Entity* e);
static Entity* location_make(Entity* e);
static voxgig_value* location_data(Entity* e, voxgig_value* args);
static voxgig_value* location_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* location_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** location_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* location_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* location_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* location_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void location_mark_deleted(Entity* e);
static bool location_deleted(Entity* e);

static Context* location_ent_ctx(location_entity* self) {
  return self->entctx;
}
...
Entity* location_entity_new(BluefinDecryptxP2peSDK* client, voxgig_value* entopts) {
  ...
  location_entity* self = (location_entity*)calloc(1, sizeof(location_entity));
  self->base.vt = &location_VT;
  self->name = strdup("location");
  self->client = client;
...
static voxgig_value* location_run_op(location_entity* self, Context* ctx,
                                    location_postdone_fn post_done, PNError** err) {
...
voxgig_value* location_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  location_entity* self = (location_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, location_ent_ctx(self));
...
static Entity* location_make(Entity* e) {
  ...
  return location_entity_new(self->client, opts);
}
...
static voxgig_value* location_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(location_ent_ctx(self), "SetData");
  }
  feature_hook_util(location_ent_ctx(self), "GetData");
...
static voxgig_value* location_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(location_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(location_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void location_load_postdone(location_entity* self, Context* ctx) {
...
static Entity* location_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, location_ent_ctx(self));
  location_run_op(self, ctx, location_load_postdone, err);
  if (*err) return NULL;
...
static void location_list_postdone(location_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    if (voxgig_is_map(resmatch)) self->mtch = resmatch;
...
static Entity** location_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, location_ent_ctx(self));
  voxgig_value* out = location_run_op(self, ctx, location_list_postdone, err);
  if (*err) return NULL;
...
static void location_create_postdone(location_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resdata = result->resdata;
    if (!v_is_noval(resdata) && !v_is_null(resdata)) {
...
static Entity* location_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, location_ent_ctx(self));
  location_run_op(self, ctx, location_create_postdone, err);
  if (*err) return NULL;
...
static Entity* location_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "location");
  return NULL;
}


static void location_remove_postdone(location_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static Entity* location_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, location_ent_ctx(self));
  location_run_op(self, ctx, location_remove_postdone, err);
  if (*err) return NULL;
...
// live record.
static void location_mark_deleted(Entity* e) {
  ((location_entity*)e)->deleted = true;
}

static bool location_deleted(Entity* e) {
  return ((location_entity*)e)->deleted;
}
