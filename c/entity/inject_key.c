// InjectKey entity client (generated — mirrors the rust Entity fragment).
...
typedef struct inject_key_entity {
...
typedef void (*inject_key_postdone_fn)(inject_key_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT inject_key_VT;
static const char* inject_key_get_name(Entity* e);
static Entity* inject_key_make(Entity* e);
static voxgig_value* inject_key_data(Entity* e, voxgig_value* args);
static voxgig_value* inject_key_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* inject_key_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** inject_key_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* inject_key_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* inject_key_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* inject_key_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void inject_key_mark_deleted(Entity* e);
static bool inject_key_deleted(Entity* e);

static Context* inject_key_ent_ctx(inject_key_entity* self) {
  return self->entctx;
}
...
Entity* inject_key_entity_new(BluefinDecryptxP2peSDK* client, voxgig_value* entopts) {
  ...
  inject_key_entity* self = (inject_key_entity*)calloc(1, sizeof(inject_key_entity));
  self->base.vt = &inject_key_VT;
  self->name = strdup("inject_key");
  self->client = client;
...
static voxgig_value* inject_key_run_op(inject_key_entity* self, Context* ctx,
                                    inject_key_postdone_fn post_done, PNError** err) {
...
voxgig_value* inject_key_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  inject_key_entity* self = (inject_key_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, inject_key_ent_ctx(self));
...
static const char* inject_key_get_name(Entity* e) {
  return ((inject_key_entity*)e)->name;
}
...
static Entity* inject_key_make(Entity* e) {
  ...
  return inject_key_entity_new(self->client, opts);
}
...
static voxgig_value* inject_key_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(inject_key_ent_ctx(self), "SetData");
  }
  feature_hook_util(inject_key_ent_ctx(self), "GetData");
...
static voxgig_value* inject_key_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(inject_key_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(inject_key_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void inject_key_load_postdone(inject_key_entity* self, Context* ctx) {
...
static Entity* inject_key_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, inject_key_ent_ctx(self));
  inject_key_run_op(self, ctx, inject_key_load_postdone, err);
  if (*err) return NULL;
...
static void inject_key_list_postdone(inject_key_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    if (voxgig_is_map(resmatch)) self->mtch = resmatch;
...
static Entity** inject_key_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, inject_key_ent_ctx(self));
  voxgig_value* out = inject_key_run_op(self, ctx, inject_key_list_postdone, err);
  if (*err) return NULL;
...
static Entity* inject_key_create(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("create", "inject_key");
  return NULL;
}

static Entity* inject_key_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "inject_key");
  return NULL;
}

static Entity* inject_key_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "inject_key");
  return NULL;
}
...
// live record.
static void inject_key_mark_deleted(Entity* e) {
  ((inject_key_entity*)e)->deleted = true;
}

static bool inject_key_deleted(Entity* e) {
  return ((inject_key_entity*)e)->deleted;
}
