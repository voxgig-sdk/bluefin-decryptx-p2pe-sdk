// DeviceCustodyList entity client (generated — mirrors the rust Entity fragment).
...
typedef struct device_custody_list_entity {
...
static const char* device_custody_list_get_name(Entity* e);
...
Entity* device_custody_list_entity_new(BluefinDecryptxP2peSDK* client, voxgig_value* entopts) {
  ...
  device_custody_list_entity* self = (device_custody_list_entity*)calloc(1, sizeof(device_custody_list_entity));
  self->base.vt = &device_custody_list_VT;
  self->name = strdup("device_custody_list");
  self->client = client;
...
static voxgig_value* device_custody_list_run_op(device_custody_list_entity* self, Context* ctx,
                                    device_custody_list_postdone_fn post_done, PNError** err) {
...
voxgig_value* device_custody_list_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* device_custody_list_get_name(Entity* e) {
  return ((device_custody_list_entity*)e)->name;
}
...
static Entity* device_custody_list_make(Entity* e) {
  ...
  return device_custody_list_entity_new(self->client, opts);
}
...
static voxgig_value* device_custody_list_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(device_custody_list_ent_ctx(self), "SetData");
  }
  feature_hook_util(device_custody_list_ent_ctx(self), "GetData");
...
static voxgig_value* device_custody_list_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(device_custody_list_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(device_custody_list_ent_ctx(self), "GetMatch");
...
static void device_custody_list_list_postdone(device_custody_list_entity* self, Context* ctx) {
...
static const EntityVT device_custody_list_VT = {
  ...
  device_custody_list_update,
  device_custody_list_remove,
};
