// CreateResult entity client (generated — mirrors the rust Entity fragment).
...
typedef struct create_result_entity {
  ...
  bool deleted;
} create_result_entity;

typedef void (*create_result_postdone_fn)(create_result_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT create_result_VT;
static const char* create_result_get_name(Entity* e);
static Entity* create_result_make(Entity* e);
static voxgig_value* create_result_data(Entity* e, voxgig_value* args);
static voxgig_value* create_result_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* create_result_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** create_result_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* create_result_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* create_result_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* create_result_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void create_result_mark_deleted(Entity* e);
static bool create_result_deleted(Entity* e);

static Context* create_result_ent_ctx(create_result_entity* self) {
  return self->entctx;
}
...
Entity* create_result_entity_new(BluefinDecryptxP2peSDK* client, voxgig_value* entopts) {
  ...
  create_result_entity* self = (create_result_entity*)calloc(1, sizeof(create_result_entity));
  self->base.vt = &create_result_VT;
  self->name = strdup("create_result");
  self->client = client;
...
static voxgig_value* create_result_run_op(create_result_entity* self, Context* ctx,
                                    create_result_postdone_fn post_done, PNError** err) {
...
voxgig_value* create_result_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  create_result_entity* self = (create_result_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, create_result_ent_ctx(self));
...
static const char* create_result_get_name(Entity* e) {
  return ((create_result_entity*)e)->name;
}
...
static Entity* create_result_make(Entity* e) {
  ...
  return create_result_entity_new(self->client, opts);
}
...
static voxgig_value* create_result_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(create_result_ent_ctx(self), "SetData");
  }
  feature_hook_util(create_result_ent_ctx(self), "GetData");
...
static voxgig_value* create_result_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(create_result_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(create_result_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static Entity* create_result_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "create_result");
  return NULL;
}

static Entity** create_result_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "create_result");
  return NULL;
}


static void create_result_create_postdone(create_result_entity* self, Context* ctx) {
...
static Entity* create_result_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, create_result_ent_ctx(self));
  create_result_run_op(self, ctx, create_result_create_postdone, err);
  if (*err) return NULL;
...
static Entity* create_result_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "create_result");
  return NULL;
}

static Entity* create_result_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "create_result");
  return NULL;
}
...
// live record.
static void create_result_mark_deleted(Entity* e) {
  ((create_result_entity*)e)->deleted = true;
}

static bool create_result_deleted(Entity* e) {
  return ((create_result_entity*)e)->deleted;
}

static const EntityVT create_result_VT = {
  create_result_get_name,
  create_result_make,
  create_result_data,
  create_result_matchv,
  create_result_mark_deleted,
  create_result_deleted,
  create_result_load,
  create_result_list,
  create_result_create,
  create_result_update,
  create_result_remove,
};
