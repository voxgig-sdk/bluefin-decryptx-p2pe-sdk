...
static Entity* partner_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** partner_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* partner_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* partner_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* partner_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void partner_mark_deleted(Entity* e);
static bool partner_deleted(Entity* e);
...
static Entity* partner_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, partner_ent_ctx(self));
  partner_run_op(self, ctx, partner_load_postdone, err);
  if (*err) return NULL;
...
static Entity** partner_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, partner_ent_ctx(self));
  voxgig_value* out = partner_run_op(self, ctx, partner_list_postdone, err);
  if (*err) return NULL;
...
static Entity* partner_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, partner_ent_ctx(self));
  partner_run_op(self, ctx, partner_create_postdone, err);
  if (*err) return NULL;
...
static Entity* partner_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "partner");
  return NULL;
}

static Entity* partner_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
...
// live record.
static void partner_mark_deleted(Entity* e) {
  ((partner_entity*)e)->deleted = true;
}

static bool partner_deleted(Entity* e) {
  return ((partner_entity*)e)->deleted;
}
