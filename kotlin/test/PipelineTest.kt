...
class PipelineTest {
  ...
  private fun plClient(sdkopts: MutableMap<String, Any?>?): BluefinDecryptxP2peSDK {
    return BluefinDecryptxP2peSDK.testSDK(null, sdkopts)
  }

  private fun plCtx(client: BluefinDecryptxP2peSDK, utility: Utility, ctrl: MutableMap<String, Any?>?): Context {
  ...
  private fun names(client: BluefinDecryptxP2peSDK): String {
