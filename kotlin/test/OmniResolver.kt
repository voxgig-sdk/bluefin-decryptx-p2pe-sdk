...
object OmniResolver {
  ...
  class Run internal constructor(
    ...
    val client: BluefinDecryptxP2peSDK?,
  ) {
   ...
   */
  fun makeRunner(testfile: Any?, client: BluefinDecryptxP2peSDK?): NamedRunner {
  ...
  private fun sdkProvider(client: BluefinDecryptxP2peSDK?): Provider = Provider(
    ...
    client = { options ->
      ...
      sdkProvider(BluefinDecryptxP2peSDK.testSDK(null, opts ?: linkedMapOf()))
    },
   ...
   * per section, by hand.)
   */
  fun omniCtx(arg: Any?, client: BluefinDecryptxP2peSDK?, utility: Utility?): Context {
