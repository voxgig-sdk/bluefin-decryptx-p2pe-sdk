...
object RunnerSupport {
  ...
  fun makeCtxFromMap(ctxmapIn: MutableMap<String, Any?>?, client: BluefinDecryptxP2peSDK?, utility: Utility?): Context {
  ...
  fun fixctx(ctx: Context?, client: BluefinDecryptxP2peSDK?) {
