...
class KifDirectTest {
  ...
  fun directListKif() {
    ...
    val reason = RunnerSupport.skipReason("direct", "direct-list-kif", mode)
  ...
  companion object {
    ...
    fun directSetup(mockres: Any?): DirectSetup {
      ...
      envm["BLUEFIN_DECRYPTX_P2PE_TEST_KIF_ENTID"] = linkedMapOf<String, Any?>()
      ...
      if (live) {
        ...
        var idmap: MutableMap<String, Any?> = linkedMapOf()
        val entidRaw = env["BLUEFIN_DECRYPTX_P2PE_TEST_KIF_ENTID"]
