...
class DeviceBuildEntityTest {
  ...
  fun basic() {
    ...
    val deviceBuildRef01DataDt0LoadResult = Helpers.toMapAny(deviceBuildRef01DataDt0Loaded) ?: linkedMapOf()
  ...
  companion object {
    fun deviceBuildBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINDECRYPTXP_PE_TEST_DEVICE_BUILD_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINDECRYPTXP_PE_TEST_DEVICE_BUILD_ENTID"] = idmap
