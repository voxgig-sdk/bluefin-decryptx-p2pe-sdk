...
class InjectKeyEntityTest {
  ...
  fun basic() {
    ...
    val injectKeyRef01DataDt0LoadResult = Helpers.toMapAny(if (injectKeyRef01DataDt0Loaded is SdkEntity) injectKeyRef01DataDt0Loaded.data() else injectKeyRef01DataDt0Loaded) ?: linkedMapOf()
  ...
  companion object {
    fun injectKeyBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFIN_DECRYPTX_P2PE_TEST_INJECT_KEY_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFIN_DECRYPTX_P2PE_TEST_INJECT_KEY_ENTID"] = idmap
      ...
      var idmapResolved = Helpers.toMapAny(env["BLUEFIN_DECRYPTX_P2PE_TEST_INJECT_KEY_ENTID"])
