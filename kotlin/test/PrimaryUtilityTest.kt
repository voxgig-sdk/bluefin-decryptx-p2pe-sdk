...
import voxgig.bluefindecryptxp2pesdk.sdktest.RunnerSupport.getSpec
import voxgig.bluefindecryptxp2pesdk.sdktest.RunnerSupport.loadTestSpec
import voxgig.bluefindecryptxp2pesdk.sdktest.RunnerSupport.makeCtxFromMap
import voxgig.bluefindecryptxp2pesdk.sdktest.RunnerSupport.runset
...
class PrimaryUtilityTest {
  ...
  private fun client(): BluefinDecryptxP2peSDK = BluefinDecryptxP2peSDK.testSDK()

  private fun makeTestCtx(client: BluefinDecryptxP2peSDK, utility: Utility, overrides: MutableMap<String, Any?>?): Context {
  ...
  private fun makeTestFullCtx(client: BluefinDecryptxP2peSDK, utility: Utility): Context {
  ...
  fun fetcherLive() {
    ...
    val liveClient = BluefinDecryptxP2peSDK(
      fhMap(
        "system",
        fhMap(
          "fetch",
  ...
  fun fetcherBlockedTestMode() {
    val blockedClient = BluefinDecryptxP2peSDK(
      fhMap(
        "system",
  ...
  fun makeSpecBasic() {
    ...
    val specClient = BluefinDecryptxP2peSDK.testSDK(null, setupOpts)
  ...
  fun prepareAuthBasic() {
    ...
    val authClient = BluefinDecryptxP2peSDK.testSDK(null, setupOpts)
