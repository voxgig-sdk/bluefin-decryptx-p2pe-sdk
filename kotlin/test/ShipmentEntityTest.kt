...
class ShipmentEntityTest {
  ...
  fun basic() {
    ...
    shipmentRef01Data = Helpers.toMapAny(shipmentRef01DataResult) ?: linkedMapOf()
    ...
    val shipmentRef01DataDt0LoadResult = Helpers.toMapAny(shipmentRef01DataDt0Loaded) ?: linkedMapOf()
  ...
  companion object {
    fun shipmentBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINDECRYPTXP_PE_TEST_SHIPMENT_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINDECRYPTXP_PE_TEST_SHIPMENT_ENTID"] = idmap
      ...
      var idmapResolved = Helpers.toMapAny(env["BLUEFINDECRYPTXP_PE_TEST_SHIPMENT_ENTID"])
