...
fun resultBasic(ctx: Context): voxgig.bluefindecryptxp2pesdk.core.Result {
...
fun resultBody(ctx: Context): voxgig.bluefindecryptxp2pesdk.core.Result {
  val response = ctx.response
  val result = ctx.result
...
fun resultHeaders(ctx: Context): voxgig.bluefindecryptxp2pesdk.core.Result {
  val response = ctx.response
  val result = ctx.result
