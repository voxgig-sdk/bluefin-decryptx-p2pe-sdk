...
class DeviceRkiActivateResultEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("device_rki_activate_result", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return DeviceRkiActivateResultEntity(this.client, opts)
  }
