...
class DeviceCustodyListEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("device_custody_list", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return DeviceCustodyListEntity(this.client, opts)
  }
