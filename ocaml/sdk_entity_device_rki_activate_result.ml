(* BluefinDecryptxP2pe SDK DeviceRkiActivateResult entity (generated by @voxgig/sdkgen).
 *
...
let rec make (client : sdk_client) (entopts_in : value) : entity_obj =
  ...
  let ent = {
    e_name = "device_rki_activate_result";
    e_client = client;
    e_utility = utility;
    e_entopts = entopts;
    e_data = empty_map ();
  ...
  ent.e_load <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"load\" not supported by entity \"device_rki_activate_result\".")));
  ent.e_list <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"list\" not supported by entity \"device_rki_activate_result\".")));
  ...
  ent.e_update <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"update\" not supported by entity \"device_rki_activate_result\".")));
  ent.e_remove <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"remove\" not supported by entity \"device_rki_activate_result\".")));
  ent
