(* Generated device_rki_activate_result direct-call test. *)
...
let () =
  test "device_rki_activate_result.direct_call" (fun () ->
      let calls = ref [] in
      ...
      let result = Sdk_client.direct client
          (jo [("path", Str "/device_rki_activate_result"); ("method", Str "GET")]) in
