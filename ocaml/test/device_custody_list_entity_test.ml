(* Generated device_custody_list entity test. *)
...
let () =
  test "device_custody_list.entity_instance" (fun () ->
      let client = Sdk_client.test () in
      let ent = Sdk_client.device_custody_list client Noval in
      check_str "name" ent.e_name "device_custody_list")

let () =
  test "device_custody_list.seeded_ops" (fun () ->
      let record = jo [("id", Str "device_custody_list01")] in
      let seed = jo [("device_custody_list",
                      jo [("device_custody_list01", record)])] in
...
let () =
  test "device_custody_list.stream" (fun () ->
      let mk_seed () =
        jo [("device_custody_list",
      ...
      let ent2 = Sdk_client.device_custody_list client2 Noval in
      let n = ref 0 in
      ...
      if has_streaming then begin
        ...
        let sent = Sdk_client.device_custody_list sclient Noval in
        ...
        let cent = Sdk_client.device_custody_list cclient Noval in
