;; BluefinDecryptxP2pe SDK DeviceBuild entity (generated by @voxgig/sdkgen).
(ns sdk.entity.device_build
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "device_build" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "device_build")
...
;; Canonical facade: (DeviceBuild client data) accessor delegates here.
...
;; Load a single DeviceBuild (reqmatch: id/query fields; nil = empty match).
...
;; List DeviceBuild items matching a filter (reqmatch: any subset of fields).
