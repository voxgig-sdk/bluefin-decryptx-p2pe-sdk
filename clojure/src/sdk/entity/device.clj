;; BluefinDecryptxP2pe SDK Device entity (generated by @voxgig/sdkgen).
(ns sdk.entity.device
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "device" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Device client data) accessor delegates here.
...
;; Load a single Device (reqmatch: id/query fields; nil = empty match).
...
;; List Device items matching a filter (reqmatch: any subset of fields).
...
;; Create a new Device (reqdata: body data).
