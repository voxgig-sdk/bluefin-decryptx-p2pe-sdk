;; BluefinDecryptxP2pe SDK Kif entity (generated by @voxgig/sdkgen).
(ns sdk.entity.kif
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "kif" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Kif client data) accessor delegates here.
...
;; List Kif items matching a filter (reqmatch: any subset of fields).
