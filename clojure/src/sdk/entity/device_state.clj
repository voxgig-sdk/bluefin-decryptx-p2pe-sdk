;; BluefinDecryptxP2pe SDK DeviceState entity (generated by @voxgig/sdkgen).
(ns sdk.entity.device_state
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "device_state" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "device_state")
...
;; Canonical facade: (DeviceState client data) accessor delegates here.
...
;; List DeviceState items matching a filter (reqmatch: any subset of fields).
