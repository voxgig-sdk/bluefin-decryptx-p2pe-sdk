;; BluefinDecryptxP2pe SDK Attestation entity (generated by @voxgig/sdkgen).
(ns sdk.entity.attestation
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "attestation" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "attestation")
...
;; Canonical facade: (Attestation client data) accessor delegates here.
...
;; Load a single Attestation (reqmatch: id/query fields; nil = empty match).
...
;; List Attestation items matching a filter (reqmatch: any subset of fields).
...
;; Create a new Attestation (reqdata: body data).
