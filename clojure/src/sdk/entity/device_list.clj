;; BluefinDecryptxP2pe SDK DeviceList entity (generated by @voxgig/sdkgen).
(ns sdk.entity.device_list
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "device_list" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "device_list")
...
;; Canonical facade: (DeviceList client data) accessor delegates here.
...
;; Load a single DeviceList (reqmatch: id/query fields; nil = empty match).
