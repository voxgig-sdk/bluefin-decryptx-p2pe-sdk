;; BluefinDecryptxP2pe SDK Success entity (generated by @voxgig/sdkgen).
(ns sdk.entity.success
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "success" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Success client data) accessor delegates here.
...
;; Create a new Success (reqdata: body data).
...
;; Remove an Success matching the criteria (reqmatch: id/query fields).
