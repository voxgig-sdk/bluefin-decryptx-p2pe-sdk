;; BluefinDecryptxP2pe SDK Shipment entity (generated by @voxgig/sdkgen).
(ns sdk.entity.shipment
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "shipment" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "shipment")
...
;; Canonical facade: (Shipment client data) accessor delegates here.
...
;; Load a single Shipment (reqmatch: id/query fields; nil = empty match).
...
;; List Shipment items matching a filter (reqmatch: any subset of fields).
...
;; Create a new Shipment (reqdata: body data).
