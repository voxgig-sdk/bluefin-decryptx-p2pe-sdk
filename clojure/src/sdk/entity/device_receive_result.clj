...
(ns sdk.entity.device_receive_result
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "device_receive_result" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "device_receive_result")
...
;; Canonical facade: (DeviceReceiveResult client data) accessor delegates here.
...
;; Create a new DeviceReceiveResult (reqdata: body data).
