;; BluefinDecryptxP2pe SDK DeviceCustodyDetail entity (generated by @voxgig/sdkgen).
(ns sdk.entity.device_custody_detail
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "device_custody_detail" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "device_custody_detail")
...
;; Canonical facade: (DeviceCustodyDetail client data) accessor delegates here.
...
;; Load a single DeviceCustodyDetail (reqmatch: id/query fields; nil = empty match).
