;; BluefinDecryptxP2pe SDK DeviceType entity (generated by @voxgig/sdkgen).
(ns sdk.entity.device_type
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "device_type" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "device_type")
...
;; Canonical facade: (DeviceType client data) accessor delegates here.
...
;; Load a single DeviceType (reqmatch: id/query fields; nil = empty match).
...
;; List DeviceType items matching a filter (reqmatch: any subset of fields).
