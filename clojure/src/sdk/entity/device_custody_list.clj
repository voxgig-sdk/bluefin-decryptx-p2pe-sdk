;; BluefinDecryptxP2pe SDK DeviceCustodyList entity (generated by @voxgig/sdkgen).
(ns sdk.entity.device_custody_list
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "device_custody_list" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "device_custody_list")
...
;; Canonical facade: (DeviceCustodyList client data) accessor delegates here.
...
;; List DeviceCustodyList items matching a filter (reqmatch: any subset of fields).
