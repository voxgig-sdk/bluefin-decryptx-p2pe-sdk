...
(ns sdk.entity.device_rki_activate_result
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "device_rki_activate_result" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "device_rki_activate_result")
...
;; Canonical facade: (DeviceRkiActivateResult client data) accessor delegates here.
...
;; Create a new DeviceRkiActivateResult (reqdata: body data).
