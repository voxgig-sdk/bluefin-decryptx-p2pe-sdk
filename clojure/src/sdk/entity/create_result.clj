;; BluefinDecryptxP2pe SDK CreateResult entity (generated by @voxgig/sdkgen).
(ns sdk.entity.create_result
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "create_result" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "create_result")
...
;; Canonical facade: (CreateResult client data) accessor delegates here.
...
;; Create a new CreateResult (reqdata: body data).
