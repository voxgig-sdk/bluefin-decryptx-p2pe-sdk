;; BluefinDecryptxP2pe SDK Location entity (generated by @voxgig/sdkgen).
(ns sdk.entity.location
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "location" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "location")
...
;; Canonical facade: (Location client data) accessor delegates here.
...
;; Load a single Location (reqmatch: id/query fields; nil = empty match).
...
;; List Location items matching a filter (reqmatch: any subset of fields).
...
;; Create a new Location (reqdata: body data).
...
;; Remove an Location matching the criteria (reqmatch: id/query fields).
