;; BluefinDecryptxP2pe SDK Decryption entity (generated by @voxgig/sdkgen).
(ns sdk.entity.decryption
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "decryption" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "decryption")
...
;; Canonical facade: (Decryption client data) accessor delegates here.
...
;; Create a new Decryption (reqdata: body data).
