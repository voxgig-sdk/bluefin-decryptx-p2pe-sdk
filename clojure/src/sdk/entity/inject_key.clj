;; BluefinDecryptxP2pe SDK InjectKey entity (generated by @voxgig/sdkgen).
(ns sdk.entity.inject_key
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "inject_key" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "inject_key")
...
;; Canonical facade: (InjectKey client data) accessor delegates here.
...
;; Load a single InjectKey (reqmatch: id/query fields; nil = empty match).
...
;; List InjectKey items matching a filter (reqmatch: any subset of fields).
