...
describe('DeviceStateDirect', async () => {
  ...
  test('direct-list-device_state', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-device_state', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['BLUEFINDECRYPTXP_PE_TEST_DEVICE_STATE_ENTID']
