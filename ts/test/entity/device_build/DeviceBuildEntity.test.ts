...
describe('DeviceBuildEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    const device_build_ref01_list = (await device_build_ref01_ent.list(device_build_ref01_match)).map((e: any) => e.data())
