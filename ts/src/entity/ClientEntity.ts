...
class ClientEntity extends BluefinDecryptxP2peEntityBase<Client> {
  ...
  async load(this: any, reqmatch?: ClientLoadMatch, ctrl?: Control): Promise<ClientEntity> {
  ...
  async list(this: any, reqmatch?: ClientListMatch, ctrl?: Control): Promise<ClientEntity[]> {
  ...
  async create(this: any, reqdata?: ClientCreateData, ctrl?: Control): Promise<ClientEntity> {
  ...
  async remove(
    this: any, reqmatch?: ClientRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<ClientEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
