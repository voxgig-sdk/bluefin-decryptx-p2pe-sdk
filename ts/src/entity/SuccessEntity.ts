...
class SuccessEntity extends BluefinDecryptxP2peEntityBase<Success> {
  ...
  make(this: SuccessEntity) {
    return new SuccessEntity(this._client, this.entopts())
  }
  ...
  async create(this: any, reqdata?: SuccessCreateData, ctrl?: Control): Promise<SuccessEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Success> return stays clean under strict null checks.
  ...
  async remove(
    this: any, reqmatch?: SuccessRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<SuccessEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
