...
class LocationEntity extends BluefinDecryptxP2peEntityBase<Location> {
  ...
  async create(this: any, reqdata?: LocationCreateData, ctrl?: Control): Promise<LocationEntity> {
  ...
  async remove(
    this: any, reqmatch?: LocationRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<LocationEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
