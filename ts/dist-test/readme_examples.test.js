...
const __1 = require("..");
const SDK_NAME = 'BluefinDecryptxP2peSDK';
...
const TEST_SEED = { "entity": { "attestation": { "test01": { "id": "test01" } }, "client": { "test01": { "id": "test01" } }, "create_result": { "test01": { "id": "test01" } }, "decryption": { "test01": { "id": "test01" } }, "device": { "test01": { "id": "test01" } }, "device_build": { "test01": { "id": "test01" } }, "device_custody_detail": { "test01": { "id": "test01" } }, "device_custody_list": { "test01": { "id": "test01" } }, "device_list": { "test01": { "id": "test01" } }, "device_receive_result": { "test01": { "id": "test01" } }, "device_rki_activate_result": { "test01": { "id": "test01" } }, "device_state": { "test01": { "id": "test01" } }, "device_type": { "test01": { "id": "test01" } }, "inject_key": { "test01": { "id": "test01" } }, "kif": { "test01": { "id": "test01" } }, "location": { "test01": { "id": "test01" } }, "partner": { "test01": { "id": "test01" } }, "shipment": { "test01": { "id": "test01" } }, "success": { "test01": { "id": "test01" } }, "transaction": { "test01": { "id": "test01" } }, "update_result": { "test01": { "id": "test01" } }, "user": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+BluefinDecryptxP2peSDK\b/.test(code) ||
        /\bBluefinDecryptxP2peSDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+BluefinDecryptxP2peSDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/BluefinDecryptxP2peSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);
