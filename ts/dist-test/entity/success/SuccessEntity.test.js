...
(0, node_test_1.describe)('SuccessEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != success_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/success/SuccessTestData.json');
    ...
    let idmap = transform(['success01', 'success02', 'success03', 'virtual_device01', 'virtual_device02', 'virtual_device03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=SuccessEntity.test.js.map