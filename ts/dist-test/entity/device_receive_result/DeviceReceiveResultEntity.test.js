...
(0, node_test_1.describe)('DeviceReceiveResultEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'device_receive_result.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != device_receive_result_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/device_receive_result/DeviceReceiveResultTestData.json');
    ...
    let idmap = transform(['device_receive_result01', 'device_receive_result02', 'device_receive_result03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['BLUEFIN_DECRYPTX_P2PE_TEST_DEVICE_RECEIVE_RESULT_ENTID'];
...
//# sourceMappingURL=DeviceReceiveResultEntity.test.js.map