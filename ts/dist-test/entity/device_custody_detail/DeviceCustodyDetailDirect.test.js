...
(0, node_test_1.describe)('DeviceCustodyDetailDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-device_custody_detail', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-device_custody_detail', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["device_type01", "id01", "serial_number01"]))
            return;
...
//# sourceMappingURL=DeviceCustodyDetailDirect.test.js.map