...
(0, node_test_1.describe)('DeviceStateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-device_state', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-device_state', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['BLUEFIN_DECRYPTX_P2PE_TEST_DEVICE_STATE_ENTID'];
...
//# sourceMappingURL=DeviceStateDirect.test.js.map