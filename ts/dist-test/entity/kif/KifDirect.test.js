...
(0, node_test_1.describe)('KifDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-kif', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-kif', setup.live))
            return;
...
//# sourceMappingURL=KifDirect.test.js.map