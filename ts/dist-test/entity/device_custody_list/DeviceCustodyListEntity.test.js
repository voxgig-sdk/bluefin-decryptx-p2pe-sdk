...
(0, node_test_1.describe)('DeviceCustodyListEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        ...
        const ent = testsdk.DeviceCustodyList();
        (0, node_assert_1.default)(null != ent);
    });
    (0, node_test_1.test)('basic', async (t) => {
        const live = 'TRUE' === process.env.BLUEFIN_DECRYPTX_P2PE_TEST_LIVE;
        for (const op of ['list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'device_custody_list.' + op, live))
                return;
        }
        ...
        let device_custody_list_ref01_data = Object.values(setup.data.existing.device_custody_list)[0];
        // LIST
        const device_custody_list_ref01_ent = client.DeviceCustodyList();
        const device_custody_list_ref01_match = {};
        ...
        const device_custody_list_ref01_list = (await device_custody_list_ref01_ent.list(device_custody_list_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/device_custody_list/DeviceCustodyListTestData.json');
    ...
    let idmap = transform(['device_custody_list01', 'device_custody_list02', 'device_custody_list03', 'device01', 'device02', 'device03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    idmap = env['BLUEFIN_DECRYPTX_P2PE_TEST_DEVICE_CUSTODY_LIST_ENTID'];
...
//# sourceMappingURL=DeviceCustodyListEntity.test.js.map