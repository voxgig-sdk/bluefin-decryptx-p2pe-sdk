...
(0, node_test_1.describe)('DeviceTypeEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(device_type_ref01_data_dt0.id === device_type_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/device_type/DeviceTypeTestData.json');
    ...
    let idmap = transform(['device_type01', 'device_type02', 'device_type03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=DeviceTypeEntity.test.js.map