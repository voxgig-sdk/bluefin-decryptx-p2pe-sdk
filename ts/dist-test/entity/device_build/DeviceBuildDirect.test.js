...
(0, node_test_1.describe)('DeviceBuildDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-device_build', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-device_build', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-device_build', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-device_build', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['BLUEFIN_DECRYPTX_P2PE_TEST_DEVICE_BUILD_ENTID'];
...
//# sourceMappingURL=DeviceBuildDirect.test.js.map