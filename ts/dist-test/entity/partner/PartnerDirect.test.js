...
(0, node_test_1.describe)('PartnerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-partner', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-partner', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-partner', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-partner', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'BLUEFIN_DECRYPTX_P2PE_TEST_PARTNER_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['BLUEFIN_DECRYPTX_P2PE_TEST_PARTNER_ENTID'];
...
//# sourceMappingURL=PartnerDirect.test.js.map