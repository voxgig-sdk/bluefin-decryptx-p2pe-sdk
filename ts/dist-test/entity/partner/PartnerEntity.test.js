...
(0, node_test_1.describe)('PartnerEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'partner.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != partner_ref01_data.id);
        // LIST
        const partner_ref01_match = {};
        const partner_ref01_list = (await partner_ref01_ent.list(partner_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(partner_ref01_list, { id: partner_ref01_data.id })));
        // LOAD
        ...
        (0, node_assert_1.default)(partner_ref01_data_dt0.id === partner_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/partner/PartnerTestData.json');
    ...
    let idmap = transform(['partner01', 'partner02', 'partner03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['BLUEFIN_DECRYPTX_P2PE_TEST_PARTNER_ENTID'];
...
//# sourceMappingURL=PartnerEntity.test.js.map