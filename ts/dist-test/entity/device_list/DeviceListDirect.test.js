...
(0, node_test_1.describe)('DeviceListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-device_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-device_list', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["share_partner_to01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['BLUEFIN_DECRYPTX_P2PE_TEST_DEVICE_LIST_ENTID'];
...
//# sourceMappingURL=DeviceListDirect.test.js.map