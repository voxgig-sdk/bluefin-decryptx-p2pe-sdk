...
(0, node_test_1.describe)('DeviceRkiActivateResultEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != device_rki_activate_result_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/device_rki_activate_result/DeviceRkiActivateResultTestData.json');
    ...
    let idmap = transform(['device_rki_activate_result01', 'device_rki_activate_result02', 'device_rki_activate_result03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    if (live) {
        const rawIds = process.env['BLUEFIN_DECRYPTX_P2PE_TEST_DEVICE_RKI_ACTIVATE_RESULT_ENTID'];
...
//# sourceMappingURL=DeviceRkiActivateResultEntity.test.js.map