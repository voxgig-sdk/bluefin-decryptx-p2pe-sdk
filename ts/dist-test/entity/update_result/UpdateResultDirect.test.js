...
(0, node_test_1.describe)('UpdateResultDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-update_result', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-update_result', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['BLUEFIN_DECRYPTX_P2PE_TEST_UPDATE_RESULT_ENTID'];
...
//# sourceMappingURL=UpdateResultDirect.test.js.map