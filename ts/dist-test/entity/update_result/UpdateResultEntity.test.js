...
(0, node_test_1.describe)('UpdateResultEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'update_result.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != update_result_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(update_result_ref01_list, { id: update_result_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(update_result_ref01_resdata_up0.id === update_result_ref01_data_up0.id);
        (0, node_assert_1.default)(update_result_ref01_resdata_up0[update_result_ref01_markdef_up0.name] === update_result_ref01_markdef_up0.value);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/update_result/UpdateResultTestData.json');
    ...
    let idmap = transform(['update_result01', 'update_result02', 'update_result03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=UpdateResultEntity.test.js.map