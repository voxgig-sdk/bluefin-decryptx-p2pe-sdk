...
```ts
const client = new BluefinDecryptxP2peSDK({ apikey: '...', secret: '...' })
...
BLUEFIN_DECRYPTX_P2PE_SECRET=<your-secret>
```
...
| --- | --- | --- |
| `client` | `Record<string, any>` | Reference to the associated Client resource. |
...
| `device` | `Record<string, any>` | Reference to the associated Device resource. |
...
| Field | Type | Description |
| --- | --- | --- |
| `contact` | `Record<string, any>` | Reference to the associated User resource. |
| `created` | `string` | Creation timestamp in ISO 8601 format. |
| `directPartner` | `Record<string, any>` | Reference to the associated Partner. |
| `id` | `string` | This resource's unique identifier. |
| `isActive` | `boolean` | This property indicates if the Client account is active or disabled. |
| `location` | `Record<string, any>` | Reference to the associated Location resource. |
| `mid` | `string` | Some Partners will have an merchant ids on their own software offerings. |
| `modified` | `string` | Last modified timestamp. |
| `name` | `string` | The Client's name. |
| `partner` | `Record<string, any>` | Reference to the Client's root Partner. |
...
| Field | Type | Description |
| --- | --- | --- |
| `activatedBy` | `Record<string, any>` | Reference to the associated User resource. |
...
| `client` | `Record<string, any>` | Reference to the associated Client resource. |
| `created` | `string` | Creation timestamp in ISO 8601 format. |
| `createdBy` | `Record<string, any>` | Reference to the associated User resource. |
| `deviceBuild` | `Record<string, any>` | Reference to the associated Device Build resource. |
| `deviceState` | `Record<string, any>` | Reference to the associated Device State resource. |
| `deviceType` | `Record<string, any>` | Reference to the associated Device Type resource. |
...
| `initializedBy` | `Record<string, any>` | Reference to the associated User resource. |
| `initializedDate` | `string` | Timestamp from when the Device was initialized. |
| `injectKey` | `Record<string, any>` | Reference to the associated Device resource. |
| `isVirtual` | `boolean` | Indicates if a Device is Virtual (represents a Device shared with a partner). |
| `kif` | `Record<string, any>` | Reference to the associated KIF resource. |
| `lastActivityDate` | `string` | Timestamp from the last time that the Device was used. |
| `location` | `Record<string, any>` | Reference to the associated Location resource. |
| `modified` | `string` | Last modified timestamp. |
| `modifiedBy` | `Record<string, any>` | Reference to the associated User resource. |
| `name` | `string` | The Device's name. |
| `notes` | `string` | Arbitary note that can be attached to a Device entry. |
| `partner` | `Record<string, any>` | Reference to the associated Partner. |
...
| `created` | `string` | Creation timestamp in ISO 8601 format. |
| `createdBy` | `Record<string, any>` | Reference to the associated User resource. |
| `custodian` | `Record<string, any>` | Reference to the associated User resource. |
| `device` | `Record<string, any>` | Reference to the associated Device resource. |
| `id` | `number` | This resource's unique identifier. |
| `location` | `Record<string, any>` | Reference to the associated Location resource. |
| `modified` | `string` | Last modified timestamp. |
...
| `status` | `Record<string, any>` | Reference to the associated Custody Status. |
| `transferMethod` | `Record<string, any>` | Reference to the associated Transfer Method. |
| `version` | `number` | The number of times that this resource has been updated. |
...
```ts
const locations = await client.Location().list({ client: "example" })
```
...
| `parent` | `Record<string, any>` | Reference to the associated Partner. |
...
| `dcKif` | `Record<string, any>` | Reference to the associated KIF resource. |
| `id` | `string` | This resource's unique identifier. |
| `items` | `any[]` |  |
| `kif` | `Record<string, any>` | Reference to the associated KIF resource. |
| `modified` | `string` | Last modified timestamp. |
...
```ts
const shipments = await client.Shipment().list({ kif: "example" })
```
...
| `userRole` | `Record<string, any>` | Reference to the associated User Role. |
| `version` | `number` | The number of times that this resource has been updated. |
