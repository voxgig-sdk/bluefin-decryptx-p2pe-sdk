...
func NewClientEntity(client *core.BluefinDecryptxP2peSDK, entopts map[string]any) *ClientEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
