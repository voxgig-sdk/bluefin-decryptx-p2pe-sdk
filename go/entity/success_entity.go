...
func NewSuccessEntity(client *core.BluefinDecryptxP2peSDK, entopts map[string]any) *SuccessEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SuccessEntity) GetName() string { return e.name }
...
func (e *SuccessEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SuccessEntity) Deleted() bool {
	return e.deleted
}


func (e *SuccessEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSuccessEntity(e.client, opts)
}

func (e *SuccessEntity) Data(args ...any) any {
...
func (e *SuccessEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Success; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SuccessEntity) DataTyped(data ...Success) Success {
	if len(data) > 0 {
		return typedFrom[Success](e.Data(asMap(data[0])))
	}
	return typedFrom[Success](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Success (all fields
// optional at the wire level).
func (e *SuccessEntity) MatchTyped(match ...Success) Success {
	if len(match) > 0 {
		return typedFrom[Success](e.Match(asMap(match[0])))
	}
	return typedFrom[Success](e.Match())
}
...
func (e *SuccessEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SuccessEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SuccessEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *SuccessEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SuccessCreateData and returns an Success. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *SuccessEntity) CreateTyped(reqdata SuccessCreateData, ctrl map[string]any) (Success, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Success{}, err
	}
	return typedFrom[Success](res), nil
}



func (e *SuccessEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *SuccessEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// SuccessRemoveMatch and returns an Success. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *SuccessEntity) RemoveTyped(reqmatch SuccessRemoveMatch, ctrl map[string]any) (Success, error) {
...
func (e *SuccessEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
