...
func NewDecryptionEntity(client *core.BluefinDecryptxP2peSDK, entopts map[string]any) *DecryptionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DecryptionEntity) GetName() string { return e.name }
...
func (e *DecryptionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DecryptionEntity) Deleted() bool {
	return e.deleted
}


func (e *DecryptionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDecryptionEntity(e.client, opts)
}

func (e *DecryptionEntity) Data(args ...any) any {
...
func (e *DecryptionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Decryption; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DecryptionEntity) DataTyped(data ...Decryption) Decryption {
	if len(data) > 0 {
		return typedFrom[Decryption](e.Data(asMap(data[0])))
	}
	return typedFrom[Decryption](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Decryption (all fields
// optional at the wire level).
func (e *DecryptionEntity) MatchTyped(match ...Decryption) Decryption {
	if len(match) > 0 {
		return typedFrom[Decryption](e.Match(asMap(match[0])))
	}
	return typedFrom[Decryption](e.Match())
}
...
func (e *DecryptionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DecryptionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DecryptionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DecryptionEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DecryptionCreateData and returns an Decryption. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DecryptionEntity) CreateTyped(reqdata DecryptionCreateData, ctrl map[string]any) (Decryption, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Decryption{}, err
	}
	return typedFrom[Decryption](res), nil
}



func (e *DecryptionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DecryptionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DecryptionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
