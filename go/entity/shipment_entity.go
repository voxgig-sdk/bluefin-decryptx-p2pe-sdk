...
func NewShipmentEntity(client *core.BluefinDecryptxP2peSDK, entopts map[string]any) *ShipmentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ShipmentEntity) GetName() string { return e.name }
...
func (e *ShipmentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ShipmentEntity) Deleted() bool {
	return e.deleted
}


func (e *ShipmentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewShipmentEntity(e.client, opts)
}

func (e *ShipmentEntity) Data(args ...any) any {
...
func (e *ShipmentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Shipment; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ShipmentEntity) DataTyped(data ...Shipment) Shipment {
	if len(data) > 0 {
		return typedFrom[Shipment](e.Data(asMap(data[0])))
	}
	return typedFrom[Shipment](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Shipment (all fields
// optional at the wire level).
func (e *ShipmentEntity) MatchTyped(match ...Shipment) Shipment {
	if len(match) > 0 {
		return typedFrom[Shipment](e.Match(asMap(match[0])))
	}
	return typedFrom[Shipment](e.Match())
}
...
func (e *ShipmentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ShipmentEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ShipmentLoadMatch and returns an Shipment. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ShipmentEntity) LoadTyped(reqmatch ShipmentLoadMatch, ctrl map[string]any) (Shipment, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Shipment{}, err
	}
	return typedFrom[Shipment](res), nil
}




func (e *ShipmentEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ShipmentListMatch and returns []Shipment. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ShipmentEntity) ListTyped(reqmatch ShipmentListMatch, ctrl map[string]any) ([]Shipment, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Shipment](res), nil
}




func (e *ShipmentEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// ShipmentCreateData and returns an Shipment. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ShipmentEntity) CreateTyped(reqdata ShipmentCreateData, ctrl map[string]any) (Shipment, error) {
...
func (e *ShipmentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ShipmentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ShipmentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
