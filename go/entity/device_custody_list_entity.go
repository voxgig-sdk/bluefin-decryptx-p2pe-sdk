...
type DeviceCustodyListEntity struct {
	name    string
...
func NewDeviceCustodyListEntity(client *core.BluefinDecryptxP2peSDK, entopts map[string]any) *DeviceCustodyListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeviceCustodyListEntity) GetName() string { return e.name }
...
func (e *DeviceCustodyListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeviceCustodyListEntity) Deleted() bool {
	return e.deleted
}


func (e *DeviceCustodyListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeviceCustodyListEntity(e.client, opts)
}

func (e *DeviceCustodyListEntity) Data(args ...any) any {
...
func (e *DeviceCustodyListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DeviceCustodyList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeviceCustodyListEntity) DataTyped(data ...DeviceCustodyList) DeviceCustodyList {
	if len(data) > 0 {
		return typedFrom[DeviceCustodyList](e.Data(asMap(data[0])))
	}
	return typedFrom[DeviceCustodyList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DeviceCustodyList (all fields
// optional at the wire level).
func (e *DeviceCustodyListEntity) MatchTyped(match ...DeviceCustodyList) DeviceCustodyList {
	if len(match) > 0 {
		return typedFrom[DeviceCustodyList](e.Match(asMap(match[0])))
	}
	return typedFrom[DeviceCustodyList](e.Match())
}
...
func (e *DeviceCustodyListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeviceCustodyListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DeviceCustodyListEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeviceCustodyListListMatch and returns []DeviceCustodyList. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DeviceCustodyListEntity) ListTyped(reqmatch DeviceCustodyListListMatch, ctrl map[string]any) ([]DeviceCustodyList, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[DeviceCustodyList](res), nil
}



func (e *DeviceCustodyListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DeviceCustodyListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DeviceCustodyListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DeviceCustodyListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
