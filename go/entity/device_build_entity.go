...
func NewDeviceBuildEntity(client *core.BluefinDecryptxP2peSDK, entopts map[string]any) *DeviceBuildEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeviceBuildEntity) GetName() string { return e.name }
...
func (e *DeviceBuildEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeviceBuildEntity) Deleted() bool {
	return e.deleted
}


func (e *DeviceBuildEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeviceBuildEntity(e.client, opts)
}

func (e *DeviceBuildEntity) Data(args ...any) any {
...
func (e *DeviceBuildEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DeviceBuild; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeviceBuildEntity) DataTyped(data ...DeviceBuild) DeviceBuild {
	if len(data) > 0 {
		return typedFrom[DeviceBuild](e.Data(asMap(data[0])))
	}
	return typedFrom[DeviceBuild](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DeviceBuild (all fields
// optional at the wire level).
func (e *DeviceBuildEntity) MatchTyped(match ...DeviceBuild) DeviceBuild {
	if len(match) > 0 {
		return typedFrom[DeviceBuild](e.Match(asMap(match[0])))
	}
	return typedFrom[DeviceBuild](e.Match())
}
...
func (e *DeviceBuildEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeviceBuildEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeviceBuildLoadMatch and returns an DeviceBuild. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DeviceBuildEntity) LoadTyped(reqmatch DeviceBuildLoadMatch, ctrl map[string]any) (DeviceBuild, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return DeviceBuild{}, err
	}
	return typedFrom[DeviceBuild](res), nil
}




func (e *DeviceBuildEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// DeviceBuildListMatch and returns []DeviceBuild. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DeviceBuildEntity) ListTyped(reqmatch DeviceBuildListMatch, ctrl map[string]any) ([]DeviceBuild, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[DeviceBuild](res), nil
}



func (e *DeviceBuildEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DeviceBuildEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DeviceBuildEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DeviceBuildEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
