...
func NewKifEntity(client *core.BluefinDecryptxP2peSDK, entopts map[string]any) *KifEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *KifEntity) GetName() string { return e.name }
...
func (e *KifEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *KifEntity) Deleted() bool {
	return e.deleted
}


func (e *KifEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewKifEntity(e.client, opts)
}

func (e *KifEntity) Data(args ...any) any {
...
func (e *KifEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Kif; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *KifEntity) DataTyped(data ...Kif) Kif {
	if len(data) > 0 {
		return typedFrom[Kif](e.Data(asMap(data[0])))
	}
	return typedFrom[Kif](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Kif (all fields
// optional at the wire level).
func (e *KifEntity) MatchTyped(match ...Kif) Kif {
	if len(match) > 0 {
		return typedFrom[Kif](e.Match(asMap(match[0])))
	}
	return typedFrom[Kif](e.Match())
}
...
func (e *KifEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *KifEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *KifEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// KifListMatch and returns []Kif. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *KifEntity) ListTyped(reqmatch KifListMatch, ctrl map[string]any) ([]Kif, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Kif](res), nil
}



func (e *KifEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *KifEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *KifEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *KifEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
