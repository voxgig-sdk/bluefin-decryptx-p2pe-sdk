...
func NewPartnerEntity(client *core.BluefinDecryptxP2peSDK, entopts map[string]any) *PartnerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
