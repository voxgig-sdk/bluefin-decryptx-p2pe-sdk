...
func NewDeviceListEntity(client *core.BluefinDecryptxP2peSDK, entopts map[string]any) *DeviceListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeviceListEntity) GetName() string { return e.name }
...
func (e *DeviceListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeviceListEntity) Deleted() bool {
	return e.deleted
}


func (e *DeviceListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeviceListEntity(e.client, opts)
}

func (e *DeviceListEntity) Data(args ...any) any {
...
func (e *DeviceListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DeviceList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeviceListEntity) DataTyped(data ...DeviceList) DeviceList {
	if len(data) > 0 {
		return typedFrom[DeviceList](e.Data(asMap(data[0])))
	}
	return typedFrom[DeviceList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DeviceList (all fields
// optional at the wire level).
func (e *DeviceListEntity) MatchTyped(match ...DeviceList) DeviceList {
	if len(match) > 0 {
		return typedFrom[DeviceList](e.Match(asMap(match[0])))
	}
	return typedFrom[DeviceList](e.Match())
}
...
func (e *DeviceListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeviceListEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeviceListLoadMatch and returns an DeviceList. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DeviceListEntity) LoadTyped(reqmatch DeviceListLoadMatch, ctrl map[string]any) (DeviceList, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return DeviceList{}, err
	}
	return typedFrom[DeviceList](res), nil
}



func (e *DeviceListEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DeviceListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DeviceListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DeviceListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DeviceListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
