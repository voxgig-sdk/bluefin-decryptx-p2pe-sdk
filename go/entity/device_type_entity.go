...
func NewDeviceTypeEntity(client *core.BluefinDecryptxP2peSDK, entopts map[string]any) *DeviceTypeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeviceTypeEntity) GetName() string { return e.name }
...
func (e *DeviceTypeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeviceTypeEntity) Deleted() bool {
	return e.deleted
}


func (e *DeviceTypeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeviceTypeEntity(e.client, opts)
}

func (e *DeviceTypeEntity) Data(args ...any) any {
...
func (e *DeviceTypeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DeviceType; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeviceTypeEntity) DataTyped(data ...DeviceType) DeviceType {
	if len(data) > 0 {
		return typedFrom[DeviceType](e.Data(asMap(data[0])))
	}
	return typedFrom[DeviceType](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DeviceType (all fields
// optional at the wire level).
func (e *DeviceTypeEntity) MatchTyped(match ...DeviceType) DeviceType {
	if len(match) > 0 {
		return typedFrom[DeviceType](e.Match(asMap(match[0])))
	}
	return typedFrom[DeviceType](e.Match())
}
...
func (e *DeviceTypeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeviceTypeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeviceTypeLoadMatch and returns an DeviceType. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DeviceTypeEntity) LoadTyped(reqmatch DeviceTypeLoadMatch, ctrl map[string]any) (DeviceType, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return DeviceType{}, err
	}
	return typedFrom[DeviceType](res), nil
}




func (e *DeviceTypeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// DeviceTypeListMatch and returns []DeviceType. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DeviceTypeEntity) ListTyped(reqmatch DeviceTypeListMatch, ctrl map[string]any) ([]DeviceType, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[DeviceType](res), nil
}



func (e *DeviceTypeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DeviceTypeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DeviceTypeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DeviceTypeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
