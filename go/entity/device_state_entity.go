...
func NewDeviceStateEntity(client *core.BluefinDecryptxP2peSDK, entopts map[string]any) *DeviceStateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeviceStateEntity) GetName() string { return e.name }
...
func (e *DeviceStateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeviceStateEntity) Deleted() bool {
	return e.deleted
}


func (e *DeviceStateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeviceStateEntity(e.client, opts)
}

func (e *DeviceStateEntity) Data(args ...any) any {
...
func (e *DeviceStateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DeviceState; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeviceStateEntity) DataTyped(data ...DeviceState) DeviceState {
	if len(data) > 0 {
		return typedFrom[DeviceState](e.Data(asMap(data[0])))
	}
	return typedFrom[DeviceState](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DeviceState (all fields
// optional at the wire level).
func (e *DeviceStateEntity) MatchTyped(match ...DeviceState) DeviceState {
	if len(match) > 0 {
		return typedFrom[DeviceState](e.Match(asMap(match[0])))
	}
	return typedFrom[DeviceState](e.Match())
}
...
func (e *DeviceStateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeviceStateEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DeviceStateEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeviceStateListMatch and returns []DeviceState. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DeviceStateEntity) ListTyped(reqmatch DeviceStateListMatch, ctrl map[string]any) ([]DeviceState, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[DeviceState](res), nil
}



func (e *DeviceStateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DeviceStateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DeviceStateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DeviceStateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
