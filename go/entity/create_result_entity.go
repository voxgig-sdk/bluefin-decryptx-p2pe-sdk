...
type CreateResultEntity struct {
	name    string
...
func NewCreateResultEntity(client *core.BluefinDecryptxP2peSDK, entopts map[string]any) *CreateResultEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CreateResultEntity) GetName() string { return e.name }
...
func (e *CreateResultEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CreateResultEntity) Deleted() bool {
	return e.deleted
}


func (e *CreateResultEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCreateResultEntity(e.client, opts)
}

func (e *CreateResultEntity) Data(args ...any) any {
...
func (e *CreateResultEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CreateResult; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CreateResultEntity) DataTyped(data ...CreateResult) CreateResult {
	if len(data) > 0 {
		return typedFrom[CreateResult](e.Data(asMap(data[0])))
	}
	return typedFrom[CreateResult](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CreateResult (all fields
// optional at the wire level).
func (e *CreateResultEntity) MatchTyped(match ...CreateResult) CreateResult {
	if len(match) > 0 {
		return typedFrom[CreateResult](e.Match(asMap(match[0])))
	}
	return typedFrom[CreateResult](e.Match())
}
...
func (e *CreateResultEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CreateResultEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CreateResultEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CreateResultEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CreateResultCreateData and returns an CreateResult. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CreateResultEntity) CreateTyped(reqdata CreateResultCreateData, ctrl map[string]any) (CreateResult, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return CreateResult{}, err
	}
	return typedFrom[CreateResult](res), nil
}



func (e *CreateResultEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CreateResultEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CreateResultEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
