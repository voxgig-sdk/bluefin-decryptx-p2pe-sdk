...
func NewInjectKeyEntity(client *core.BluefinDecryptxP2peSDK, entopts map[string]any) *InjectKeyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InjectKeyEntity) GetName() string { return e.name }
...
func (e *InjectKeyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InjectKeyEntity) Deleted() bool {
	return e.deleted
}


func (e *InjectKeyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInjectKeyEntity(e.client, opts)
}

func (e *InjectKeyEntity) Data(args ...any) any {
...
func (e *InjectKeyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an InjectKey; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *InjectKeyEntity) DataTyped(data ...InjectKey) InjectKey {
	if len(data) > 0 {
		return typedFrom[InjectKey](e.Data(asMap(data[0])))
	}
	return typedFrom[InjectKey](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through InjectKey (all fields
// optional at the wire level).
func (e *InjectKeyEntity) MatchTyped(match ...InjectKey) InjectKey {
	if len(match) > 0 {
		return typedFrom[InjectKey](e.Match(asMap(match[0])))
	}
	return typedFrom[InjectKey](e.Match())
}
...
func (e *InjectKeyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InjectKeyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// InjectKeyLoadMatch and returns an InjectKey. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *InjectKeyEntity) LoadTyped(reqmatch InjectKeyLoadMatch, ctrl map[string]any) (InjectKey, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return InjectKey{}, err
	}
	return typedFrom[InjectKey](res), nil
}




func (e *InjectKeyEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// InjectKeyListMatch and returns []InjectKey. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *InjectKeyEntity) ListTyped(reqmatch InjectKeyListMatch, ctrl map[string]any) ([]InjectKey, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[InjectKey](res), nil
}



func (e *InjectKeyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *InjectKeyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *InjectKeyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *InjectKeyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
