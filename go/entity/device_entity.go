...
func NewDeviceEntity(client *core.BluefinDecryptxP2peSDK, entopts map[string]any) *DeviceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeviceEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeviceLoadMatch and returns an Device. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DeviceEntity) LoadTyped(reqmatch DeviceLoadMatch, ctrl map[string]any) (Device, error) {
...
func (e *DeviceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DeviceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
