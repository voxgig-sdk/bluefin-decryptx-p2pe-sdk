...
func NewTransactionEntity(client *core.BluefinDecryptxP2peSDK, entopts map[string]any) *TransactionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TransactionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TransactionEntity) Deleted() bool {
	return e.deleted
}
...
func (e *TransactionEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// TransactionCreateData and returns an Transaction. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TransactionEntity) CreateTyped(reqdata TransactionCreateData, ctrl map[string]any) (Transaction, error) {
