...
func TestDeviceEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		deviceRef01DataDt0LoadResult := core.ToMapAny(entityData(deviceRef01DataDt0Loaded))
...
func deviceBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("BLUEFIN_DECRYPTX_P2PE_TEST_DEVICE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["BLUEFIN_DECRYPTX_P2PE_TEST_DEVICE_ENTID"])
