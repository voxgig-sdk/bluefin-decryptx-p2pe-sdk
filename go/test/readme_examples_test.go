...
const testSeed = `map[string]any{"entity": map[string]any{"attestation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "client": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "create_result": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "decryption": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "device": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "device_build": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "device_custody_detail": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "device_custody_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "device_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "device_receive_result": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "device_rki_activate_result": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "device_state": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "device_type": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "inject_key": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "kif": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "location": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "partner": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "shipment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "success": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "transaction": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "update_result": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
