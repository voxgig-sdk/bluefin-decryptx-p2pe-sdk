...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("BLUEFINDECRYPTXP2PE_TEST_LIVE") == "TRUE" ||
		os.Getenv("BLUEFINDECRYPTXP2PE_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("BLUEFINDECRYPTXP2PE_TEST_EXPLAIN"); explain != "" {
