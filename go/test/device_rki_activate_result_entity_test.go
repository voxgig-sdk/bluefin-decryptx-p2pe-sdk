...
func TestDeviceRkiActivateResultEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		deviceRkiActivateResultRef01Data = core.ToMapAny(entityData(deviceRkiActivateResultRef01DataResult))
...
func device_rki_activate_resultBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("BLUEFIN_DECRYPTX_P2PE_TEST_DEVICE_RKI_ACTIVATE_RESULT_ENTID")
