// BluefinDecryptxP2pe SDK — shared test runner support (mirrors java
...
inline CtxPtr make_ctx_from_map(const Value& ctxmap_, std::shared_ptr<BluefinDecryptxP2peSDK> client,
                                UtilityPtr utility) {
...
inline void fixctx(CtxPtr ctx, std::shared_ptr<BluefinDecryptxP2peSDK> client) {
