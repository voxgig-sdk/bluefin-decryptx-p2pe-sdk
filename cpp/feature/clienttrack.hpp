// BluefinDecryptxP2pe SDK — clienttrack feature (mirrors java feature/ClienttrackFeature.java).
...
private:
  std::string name() {
    std::string nm = fopt::foptStr(options, "clientName", "BluefinDecryptxP2pe-SDK");
