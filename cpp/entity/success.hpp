// Success entity client (generated). Shared entity runtime (data/match
...
class SuccessEntity : public EntityBase {
public:
  SuccessEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("success", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<SuccessEntity>(this->client, opts);
  }
