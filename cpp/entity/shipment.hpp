// Shipment entity client (generated). Shared entity runtime (data/match
...
class ShipmentEntity : public EntityBase {
public:
  ShipmentEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("shipment", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<ShipmentEntity>(this->client, opts);
  }
