// DeviceReceiveResult entity client (generated). Shared entity runtime (data/match
...
class DeviceReceiveResultEntity : public EntityBase {
public:
  DeviceReceiveResultEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("device_receive_result", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<DeviceReceiveResultEntity>(this->client, opts);
  }
