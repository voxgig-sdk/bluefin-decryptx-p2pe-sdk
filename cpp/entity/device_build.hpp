// DeviceBuild entity client (generated). Shared entity runtime (data/match
...
class DeviceBuildEntity : public EntityBase {
public:
  DeviceBuildEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("device_build", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<DeviceBuildEntity>(this->client, opts);
  }
