// Device entity client (generated). Shared entity runtime (data/match
...
class DeviceEntity : public EntityBase {
public:
  DeviceEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("device", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<DeviceEntity>(this->client, opts);
  }
