// DeviceCustodyDetail entity client (generated). Shared entity runtime (data/match
...
class DeviceCustodyDetailEntity : public EntityBase {
public:
  DeviceCustodyDetailEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("device_custody_detail", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<DeviceCustodyDetailEntity>(this->client, opts);
  }
