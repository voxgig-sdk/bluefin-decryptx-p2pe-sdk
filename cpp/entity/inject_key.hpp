// InjectKey entity client (generated). Shared entity runtime (data/match
...
class InjectKeyEntity : public EntityBase {
public:
  InjectKeyEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("inject_key", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<InjectKeyEntity>(this->client, opts);
  }
