// DeviceType entity client (generated). Shared entity runtime (data/match
...
class DeviceTypeEntity : public EntityBase {
public:
  DeviceTypeEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("device_type", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<DeviceTypeEntity>(this->client, opts);
  }
