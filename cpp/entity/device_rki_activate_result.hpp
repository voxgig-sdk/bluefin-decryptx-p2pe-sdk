// DeviceRkiActivateResult entity client (generated). Shared entity runtime (data/match
...
class DeviceRkiActivateResultEntity : public EntityBase {
public:
  DeviceRkiActivateResultEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("device_rki_activate_result", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<DeviceRkiActivateResultEntity>(this->client, opts);
  }
