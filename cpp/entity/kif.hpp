// Kif entity client (generated). Shared entity runtime (data/match
...
class KifEntity : public EntityBase {
public:
  KifEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("kif", client, entopts) {}
