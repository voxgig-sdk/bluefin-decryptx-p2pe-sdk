// DeviceList entity client (generated). Shared entity runtime (data/match
...
class DeviceListEntity : public EntityBase {
public:
  DeviceListEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("device_list", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<DeviceListEntity>(this->client, opts);
  }
