// DeviceCustodyList entity client (generated). Shared entity runtime (data/match
...
class DeviceCustodyListEntity : public EntityBase {
public:
  DeviceCustodyListEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("device_custody_list", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<DeviceCustodyListEntity>(this->client, opts);
  }
