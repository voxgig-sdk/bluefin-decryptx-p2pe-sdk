// Decryption entity client (generated). Shared entity runtime (data/match
...
class DecryptionEntity : public EntityBase {
public:
  DecryptionEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("decryption", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<DecryptionEntity>(this->client, opts);
  }
