// Location entity client (generated). Shared entity runtime (data/match
...
class LocationEntity : public EntityBase {
public:
  LocationEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("location", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<LocationEntity>(this->client, opts);
  }
