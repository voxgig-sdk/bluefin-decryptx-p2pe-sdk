// CreateResult entity client (generated). Shared entity runtime (data/match
...
class CreateResultEntity : public EntityBase {
public:
  CreateResultEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("create_result", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<CreateResultEntity>(this->client, opts);
  }
