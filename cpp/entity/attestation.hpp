// Attestation entity client (generated). Shared entity runtime (data/match
...
class AttestationEntity : public EntityBase {
public:
  AttestationEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("attestation", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<AttestationEntity>(this->client, opts);
  }
