...
class Utility private (noregister: Boolean) {
  ...
  val struct: voxgig.bluefindecryptxp2pesdk.utility.StructUtility.type = voxgig.bluefindecryptxp2pesdk.utility.StructUtility

  def this() = {
    this(false)
    voxgig.bluefindecryptxp2pesdk.utility.Register.registerAll(this)
  }
