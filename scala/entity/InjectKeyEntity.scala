...
class InjectKeyEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("inject_key", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new InjectKeyEntity(this.client, opts)
  }
