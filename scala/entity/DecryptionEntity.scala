...
class DecryptionEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("decryption", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new DecryptionEntity(this.client, opts)
  }
