...
class AttestationEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("attestation", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new AttestationEntity(this.client, opts)
  }
