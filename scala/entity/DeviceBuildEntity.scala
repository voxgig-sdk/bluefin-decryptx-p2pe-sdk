...
class DeviceBuildEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("device_build", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new DeviceBuildEntity(this.client, opts)
  }
