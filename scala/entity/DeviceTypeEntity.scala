...
class DeviceTypeEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("device_type", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new DeviceTypeEntity(this.client, opts)
  }
