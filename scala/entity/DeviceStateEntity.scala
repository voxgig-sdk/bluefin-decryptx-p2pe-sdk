...
class DeviceStateEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("device_state", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new DeviceStateEntity(this.client, opts)
  }
