...
class DeviceCustodyDetailEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("device_custody_detail", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new DeviceCustodyDetailEntity(this.client, opts)
  }
