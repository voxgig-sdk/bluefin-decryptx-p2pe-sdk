...
class DeviceReceiveResultEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("device_receive_result", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new DeviceReceiveResultEntity(this.client, opts)
  }
