# BluefinDecryptxP2pe SDK Transaction entity
...
# Returns the loaded Transaction data (hashref); dies with BluefinDecryptxP2peError
# on failure.
sub load {
...
#
# reqdata: body data hashref (TransactionCreateData shape). ctrl: optional
# per-call control. Returns the created Transaction data (hashref); dies
