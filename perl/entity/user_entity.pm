# BluefinDecryptxP2pe SDK User entity
...
# Returns the loaded User data (hashref); dies with BluefinDecryptxP2peError
# on failure.
sub load {
...
#
# reqmatch: match criteria hashref (id/query fields; UserRemoveMatch
# shape). ctrl: optional per-call control. Returns the removed User
