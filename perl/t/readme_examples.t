...
#      (BluefinDecryptxP2peSDK->test) against the real SDK. Captured output is scanned for
...
my $SDK_CLASS = 'BluefinDecryptxP2peSDK';
...
# becomes BluefinDecryptxP2peSDK->test(<fixtures>); a block that only uses $client gets
