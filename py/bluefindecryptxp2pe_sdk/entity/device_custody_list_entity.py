...
class DeviceCustodyListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DeviceCustodyListEntity(self._client, opts)
    ...
    def data_get(self) -> DeviceCustodyList:
    ...
    def match_get(self) -> DeviceCustodyList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[DeviceCustodyList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.DeviceCustodyList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
