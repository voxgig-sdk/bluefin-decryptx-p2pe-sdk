...
class CreateResultEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CreateResultEntity(self._client, opts)
    ...
    def data_get(self) -> CreateResult:
    ...
    def match_get(self) -> CreateResult:
    ...
    def create(self, reqdata: CreateResultCreateData, ctrl=None) -> CreateResult:
        utility = self._utility
