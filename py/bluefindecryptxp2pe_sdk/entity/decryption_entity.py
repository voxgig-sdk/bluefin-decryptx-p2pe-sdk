...
class DecryptionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DecryptionEntity(self._client, opts)
    ...
    def create(self, reqdata: DecryptionCreateData, ctrl=None) -> Decryption:
        utility = self._utility
