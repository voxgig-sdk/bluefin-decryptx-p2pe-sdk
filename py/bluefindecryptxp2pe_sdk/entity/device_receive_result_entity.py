...
class DeviceReceiveResultEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DeviceReceiveResultEntity(self._client, opts)
    ...
    def data_get(self) -> DeviceReceiveResult:
    ...
    def match_get(self) -> DeviceReceiveResult:
    ...
    def create(self, reqdata: DeviceReceiveResultCreateData, ctrl=None) -> DeviceReceiveResult:
        utility = self._utility
