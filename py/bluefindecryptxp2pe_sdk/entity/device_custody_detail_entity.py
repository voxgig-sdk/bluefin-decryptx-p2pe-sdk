...
class DeviceCustodyDetailEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DeviceCustodyDetailEntity(self._client, opts)
    ...
    def data_get(self) -> DeviceCustodyDetail:
    ...
    def match_get(self) -> DeviceCustodyDetail:
    ...
    def load(self, reqmatch=None, ctrl=None) -> DeviceCustodyDetail:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.DeviceCustodyDetail().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
