...
class DeviceRkiActivateResultEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DeviceRkiActivateResultEntity(self._client, opts)
    ...
    def data_get(self) -> DeviceRkiActivateResult:
    ...
    def match_get(self) -> DeviceRkiActivateResult:
    ...
    def create(self, reqdata: DeviceRkiActivateResultCreateData, ctrl=None) -> DeviceRkiActivateResult:
        utility = self._utility
