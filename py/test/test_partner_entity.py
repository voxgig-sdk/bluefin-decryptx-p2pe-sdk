    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set BLUEFIN_DECRYPTX_P2PE_TEST_PARTNER_ENTID JSON to run live")
        client = setup["client"]
        ...
        partner_ref01_data = helpers.to_map(runner.entity_data(partner_ref01_ent.create(partner_ref01_data, None)))
        ...
        partner_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(partner_ref01_data_dt0_loaded))
...
def _partner_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("BLUEFIN_DECRYPTX_P2PE_TEST_PARTNER_ENTID"))
