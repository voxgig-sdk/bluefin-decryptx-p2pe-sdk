    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set BLUEFINDECRYPTXP_PE_TEST_DEVICE_ENTID JSON to run live")
        client = setup["client"]
        ...
        device_ref01_data = helpers.to_map(device_ref01_ent.create(device_ref01_data, None))
...
def _device_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("BLUEFINDECRYPTXP_PE_TEST_DEVICE_ENTID"))
