# BluefinDecryptxP2pe SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BluefinDecryptxP2peSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BluefinDecryptxP2peSDK(...) and BluefinDecryptxP2peSDK.test(...) become
#      BluefinDecryptxP2peSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "bluefindecryptxp2pe_sdk"
_SDK_CLASS = "BluefinDecryptxP2peSDK"
...
_ENTITIES = {
    ...
    "DeviceCustodyDetail": "device_custody_detail",
    "DeviceCustodyList": "device_custody_list",
    "DeviceList": "device_list",
    "DeviceReceiveResult": "device_receive_result",
    "DeviceRkiActivateResult": "device_rki_activate_result",
    "DeviceState": "device_state",
    "DeviceType": "device_type",
    "InjectKey": "inject_key",
    "Kif": "kif",
    "Location": "location",
    "Partner": "partner",
    "Shipment": "shipment",
