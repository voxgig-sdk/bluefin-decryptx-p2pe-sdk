...
from bluefindecryptxp2pe_sdk.core.response import BluefinDecryptxP2peResponse
from bluefindecryptxp2pe_sdk.core.operation import BluefinDecryptxP2peOperation
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return BluefinDecryptxP2peError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = BluefinDecryptxP2peSDK.test(None, None)
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except BluefinDecryptxP2peError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = BluefinDecryptxP2peResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = BluefinDecryptxP2peSDK.test(None, None)
        ...
        class TestInitFeature(BluefinDecryptxP2peBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(BluefinDecryptxP2peBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = BluefinDecryptxP2peSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = BluefinDecryptxP2peSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = BluefinDecryptxP2peSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = BluefinDecryptxP2peSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = BluefinDecryptxP2peOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = BluefinDecryptxP2peSDK.test(None, setup_opts)
