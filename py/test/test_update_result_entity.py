    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set BLUEFIN_DECRYPTX_P2PE_TEST_UPDATE_RESULT_ENTID JSON to run live")
        client = setup["client"]
        ...
        update_result_ref01_data = helpers.to_map(runner.entity_data(update_result_ref01_ent.create(update_result_ref01_data, None)))
        ...
        update_result_ref01_resdata_up0 = helpers.to_map(runner.entity_data(update_result_ref01_ent.update(update_result_ref01_data_up0_up, None)))
...
def _update_result_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("BLUEFIN_DECRYPTX_P2PE_TEST_UPDATE_RESULT_ENTID"))
