    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set BLUEFINDECRYPTXP_PE_TEST_DEVICE_RECEIVE_RESULT_ENTID JSON to run live")
        client = setup["client"]
        ...
        device_receive_result_ref01_data = helpers.to_map(device_receive_result_ref01_ent.create(device_receive_result_ref01_data, None))
...
def _device_receive_result_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("BLUEFINDECRYPTXP_PE_TEST_DEVICE_RECEIVE_RESULT_ENTID"))
