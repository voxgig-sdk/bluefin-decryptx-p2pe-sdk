...
class BluefinDecryptxP2peGraphql
{
    ...
    // equivalent.
    public static function body(BluefinDecryptxP2peContext $ctx): mixed
    {
    ...
    public static function errors(BluefinDecryptxP2peContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
