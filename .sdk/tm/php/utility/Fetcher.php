...
class BluefinDecryptxP2peFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BluefinDecryptxP2peSDK/1.0)';
    ...
    public static function call(BluefinDecryptxP2peContext $ctx, string $fullurl, array $fetchdef): array
    {
