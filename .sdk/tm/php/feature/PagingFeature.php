...
class BluefinDecryptxP2pePagingFeature extends BluefinDecryptxP2peBaseFeature
{
    ...
    private function _graphql_pre_request(BluefinDecryptxP2peContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(BluefinDecryptxP2peContext $ctx): bool
    {
