...
class BluefinDecryptxP2peClienttrackFeature extends BluefinDecryptxP2peBaseFeature
{
    ...
    public function PostConstruct(BluefinDecryptxP2peContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BluefinDecryptxP2pe-SDK';
