...
class BluefinDecryptxP2peStreamingFeature extends BluefinDecryptxP2peBaseFeature
{
    ...
    private function _iterate(BluefinDecryptxP2peResult $result): \Generator
    {
    ...
    private function _streamable(BluefinDecryptxP2peContext $ctx): bool
    {
