...
class BluefinDecryptxP2peProxyFeature extends BluefinDecryptxP2peBaseFeature
{
    ...
    public function init(BluefinDecryptxP2peContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BluefinDecryptxP2peContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
