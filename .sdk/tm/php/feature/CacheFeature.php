...
// BluefinDecryptxP2pe SDK cache feature
...
class BluefinDecryptxP2peCacheFeature extends BluefinDecryptxP2peBaseFeature
{
    ...
    private function _through(BluefinDecryptxP2peContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
