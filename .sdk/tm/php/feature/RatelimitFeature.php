...
// BluefinDecryptxP2pe SDK ratelimit feature
...
class BluefinDecryptxP2peRatelimitFeature extends BluefinDecryptxP2peBaseFeature
{
    ...
    private function _acquire(BluefinDecryptxP2peContext $ctx): void
    {
    ...
    private function _track(BluefinDecryptxP2peContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
