# BluefinDecryptxP2pe SDK generic entity behaviour
#
...
defmodule BluefinDecryptxP2pe.EntityBase do
  alias Voxgig.Struct, as: S
  alias BluefinDecryptxP2pe.Helpers, as: H
  alias BluefinDecryptxP2pe.{Context, Utility, Pipeline}
  ...
  def construct(module, client, name, entopts \\ nil) do
    ...
    S.setprop(ent, "_utility", BluefinDecryptxP2pe.get_utility(client))
    S.setprop(ent, "_entopts", entopts)
    S.setprop(ent, "_data", S.jm([]))
    S.setprop(ent, "_match", S.jm([]))

    entctx =
      Context.new(S.jm(["entity", ent, "entopts", entopts]), BluefinDecryptxP2pe.get_root_ctx(client))
