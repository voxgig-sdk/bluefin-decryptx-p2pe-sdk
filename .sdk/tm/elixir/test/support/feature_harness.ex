...
defmodule BluefinDecryptxP2pe.FeatureHarness do
  alias Voxgig.Struct, as: S
  alias BluefinDecryptxP2pe.Helpers, as: H
  alias BluefinDecryptxP2pe.{Control, Spec, Result, Context, Features}

  # True when this SDK was generated with the named feature.
  def has_feature(name) do
    feature = S.getprop(BluefinDecryptxP2pe.Config.make_config(), "feature")
