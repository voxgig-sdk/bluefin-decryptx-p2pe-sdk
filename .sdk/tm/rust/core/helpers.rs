// Shared Value helpers for the BluefinDecryptxP2pe SDK pipeline. The SDK data model
...
// underlying API spec doesn't define. The static BluefinDecryptxP2peEntity trait
...
pub fn unsupported_op(opname: &str, entityname: &str) -> BluefinDecryptxP2peError {
    BluefinDecryptxP2peError::new(
        "unsupported_op",
        &format!(
