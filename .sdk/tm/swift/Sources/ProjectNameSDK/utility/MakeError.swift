// BluefinDecryptxP2pe SDK utility: makeError - the single error surface of the
// pipeline. Throws the wrapped BluefinDecryptxP2peError unless the per-call ctrl
...
func makeErrorUtil(_ ctx: Context, _ err: Error?) throws -> Value {
  ...
  var msg = "BluefinDecryptxP2peSDK: " + opname + ": " + errmsg
  ...
  let code = (e as? BluefinDecryptxP2peError)?.code ?? ""
  let sdkErr = BluefinDecryptxP2peError(code, msg, ctx)
