...
{
  my $sdk = BluefinDecryptxP2peSDK->test({ 'net' => { 'offline' => 1 } }, undef);
...
{
  my $sdk = BluefinDecryptxP2peSDK->test({ 'net' => { 'failTimes' => 1, 'failStatus' => 503 } }, undef);
  my $res = $sdk->direct({ 'path' => '/ping' });
...
{
  my $sdk = BluefinDecryptxP2peSDK->test({ 'net' => { 'errorTimes' => 1 } }, undef);
  my $res = $sdk->direct({ 'path' => '/ping' });
...
{
  my $delay = 60;
  my $sdk = BluefinDecryptxP2peSDK->test({ 'net' => { 'latency' => $delay } }, undef);
...
{
  my $sdk = BluefinDecryptxP2peSDK->test(undef, undef);
