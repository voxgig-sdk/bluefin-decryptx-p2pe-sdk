...
local function make_error_util(ctx, err)
  ...
  local msg = "BluefinDecryptxP2peSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = BluefinDecryptxP2peError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == BluefinDecryptxP2peError then
