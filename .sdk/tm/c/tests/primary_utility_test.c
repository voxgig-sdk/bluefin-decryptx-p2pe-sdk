...
static void test_primary_fetcher_live(void) {
  ...
  BluefinDecryptxP2peSDK* live = projectname_sdk_new(
...
static void test_primary_fetcher_blocked_test_mode(void) {
  BluefinDecryptxP2peSDK* blocked = projectname_sdk_new(
...
static void test_primary_new_sdk_smoke(void) {
  BluefinDecryptxP2peSDK* client = projectname_sdk_new(v_undef());
