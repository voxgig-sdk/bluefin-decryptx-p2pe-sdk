...
// ---- SDK client-base generic helpers (Main.fragment BluefinDecryptxP2peSDK) -------
...
voxgig_value* sdk_options_map(BluefinDecryptxP2peSDK* sdk) { return voxgig_clone(sdk->options); }

Utility* sdk_get_utility(BluefinDecryptxP2peSDK* sdk) { return utility_copy(sdk->utility); }

Context* sdk_get_root_ctx(BluefinDecryptxP2peSDK* sdk) { return sdk->rootctx; }
