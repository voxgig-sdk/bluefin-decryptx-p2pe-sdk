...
|---|---|---|
| `js/` | @voxgig-sdk/bluefin-decryptx-p2pe-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/bluefin-decryptx-p2pe | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/bluefin-decryptx-p2pe-js \
      --repository voxgig-sdk/bluefin-decryptx-p2pe-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/bluefin-decryptx-p2pe-js` shows it, and
`npm trust revoke @voxgig-sdk/bluefin-decryptx-p2pe-js --id=<id>` removes it.
