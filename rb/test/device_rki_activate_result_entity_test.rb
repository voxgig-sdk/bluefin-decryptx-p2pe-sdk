...
class DeviceRkiActivateResultEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set BLUEFINDECRYPTXP_PE_TEST_DEVICE_RKI_ACTIVATE_RESULT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def device_rki_activate_result_basic_setup(extra)
  ...
  entid_env_raw = ENV["BLUEFINDECRYPTXP_PE_TEST_DEVICE_RKI_ACTIVATE_RESULT_ENTID"]
