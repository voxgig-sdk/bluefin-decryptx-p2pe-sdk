...
#      offline in seeded test mode (BluefinDecryptxP2peSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "BluefinDecryptxP2pe_sdk.rb")
  SDK_CLASS = "BluefinDecryptxP2peSDK"
  ...
  SDK_BASE = "BluefinDecryptxP2pe_sdk"
