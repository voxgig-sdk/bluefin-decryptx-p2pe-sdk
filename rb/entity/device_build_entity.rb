...
class DeviceBuildEntity
  ...
  def make
    opts = @_entopts.dup
    DeviceBuildEntity.new(@_client, opts)
  end
  ...
  # @return [DeviceBuild, Hash] the current DeviceBuild data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DeviceBuild fields)
  def match_get
  ...
  #
  # @param reqmatch [DeviceBuildLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.DeviceBuild.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [DeviceBuild, Hash] the loaded DeviceBuild; raises BluefinDecryptxP2peError on failure
  ...
  #
  # @param reqmatch [DeviceBuildListMatch, Hash, nil] match filter (any subset of
  #   DeviceBuild fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<DeviceBuild>, Array] the matching DeviceBuild items; raises BluefinDecryptxP2peError on failure
