...
class UpdateResultEntity
  ...
  # @return [Array<UpdateResult>, Array] the matching UpdateResult items; raises BluefinDecryptxP2peError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [UpdateResult, Hash] the created UpdateResult; raises BluefinDecryptxP2peError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [UpdateResult, Hash] the updated UpdateResult; raises BluefinDecryptxP2peError on failure
