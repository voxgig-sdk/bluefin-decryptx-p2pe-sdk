...
class CreateResultEntity
  ...
  def make
    opts = @_entopts.dup
    CreateResultEntity.new(@_client, opts)
  end
  ...
  # @return [CreateResult, Hash] the current CreateResult data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CreateResult fields)
  def match_get
  ...
  #
  # @param reqdata [CreateResultCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [CreateResult, Hash] the created CreateResult; raises BluefinDecryptxP2peError on failure
