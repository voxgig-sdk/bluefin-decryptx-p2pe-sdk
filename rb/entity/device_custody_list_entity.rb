...
class DeviceCustodyListEntity
  ...
  def make
    opts = @_entopts.dup
    DeviceCustodyListEntity.new(@_client, opts)
  end
  ...
  # @return [DeviceCustodyList, Hash] the current DeviceCustodyList data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DeviceCustodyList fields)
  def match_get
  ...
  #
  # @param reqmatch [DeviceCustodyListListMatch, Hash, nil] match filter (any subset of
  #   DeviceCustodyList fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<DeviceCustodyList>, Array] the matching DeviceCustodyList items; raises BluefinDecryptxP2peError on failure
