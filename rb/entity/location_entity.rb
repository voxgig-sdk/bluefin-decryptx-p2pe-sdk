...
class LocationEntity
  ...
  # @return [Location, Hash] the loaded Location; raises BluefinDecryptxP2peError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Location>, Array] the matching Location items; raises BluefinDecryptxP2peError on failure
  ...
  #
  # @param reqdata [LocationCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Location, Hash] the created Location; raises BluefinDecryptxP2peError on failure
  ...
  #
  # @param reqmatch [LocationRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Location, Hash] the removed Location; raises BluefinDecryptxP2peError on failure
