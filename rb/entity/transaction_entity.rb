...
class TransactionEntity
  ...
  # @return [Transaction, Hash] the loaded Transaction; raises BluefinDecryptxP2peError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Transaction>, Array] the matching Transaction items; raises BluefinDecryptxP2peError on failure
  ...
  #
  # @param reqdata [TransactionCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Transaction, Hash] the created Transaction; raises BluefinDecryptxP2peError on failure
