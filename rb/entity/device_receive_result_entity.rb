...
class DeviceReceiveResultEntity
  ...
  def make
    opts = @_entopts.dup
    DeviceReceiveResultEntity.new(@_client, opts)
  end
  ...
  # @return [DeviceReceiveResult, Hash] the current DeviceReceiveResult data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DeviceReceiveResult fields)
  def match_get
  ...
  #
  # @param reqdata [DeviceReceiveResultCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [DeviceReceiveResult, Hash] the created DeviceReceiveResult; raises BluefinDecryptxP2peError on failure
