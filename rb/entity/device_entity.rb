...
class DeviceEntity
  ...
  # @return [Device, Hash] the current Device data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Device fields)
  def match_get
  ...
  #
  # @param reqmatch [DeviceLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Device.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Device, Hash] the loaded Device; raises BluefinDecryptxP2peError on failure
  ...
  #
  # @param reqmatch [DeviceListMatch, Hash, nil] match filter (any subset of
  #   Device fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Device>, Array] the matching Device items; raises BluefinDecryptxP2peError on failure
  ...
  # Create a new Device.
  #
  # @param reqdata [DeviceCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Device, Hash] the created Device; raises BluefinDecryptxP2peError on failure
