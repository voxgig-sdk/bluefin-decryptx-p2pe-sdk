...
class KifEntity
  ...
  # @return [Kif, Hash] the current Kif data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Kif fields)
  def match_get
  ...
  #
  # @param reqmatch [KifListMatch, Hash, nil] match filter (any subset of
  #   Kif fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Kif>, Array] the matching Kif items; raises BluefinDecryptxP2peError on failure
