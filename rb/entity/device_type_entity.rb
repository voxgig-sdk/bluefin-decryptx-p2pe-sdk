...
class DeviceTypeEntity
  ...
  def make
    opts = @_entopts.dup
    DeviceTypeEntity.new(@_client, opts)
  end
  ...
  # @return [DeviceType, Hash] the current DeviceType data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DeviceType fields)
  def match_get
  ...
  #
  # @param reqmatch [DeviceTypeLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.DeviceType.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [DeviceType, Hash] the loaded DeviceType; raises BluefinDecryptxP2peError on failure
  ...
  #
  # @param reqmatch [DeviceTypeListMatch, Hash, nil] match filter (any subset of
  #   DeviceType fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<DeviceType>, Array] the matching DeviceType items; raises BluefinDecryptxP2peError on failure
