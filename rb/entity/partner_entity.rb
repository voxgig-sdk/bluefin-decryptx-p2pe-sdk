...
class PartnerEntity
  ...
  # @return [Partner, Hash] the loaded Partner; raises BluefinDecryptxP2peError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Partner>, Array] the matching Partner items; raises BluefinDecryptxP2peError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Partner, Hash] the created Partner; raises BluefinDecryptxP2peError on failure
