...
class ClientEntity
  ...
  # @return [Client, Hash] the loaded Client; raises BluefinDecryptxP2peError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Client>, Array] the matching Client items; raises BluefinDecryptxP2peError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Client, Hash] the created Client; raises BluefinDecryptxP2peError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Client, Hash] the removed Client; raises BluefinDecryptxP2peError on failure
