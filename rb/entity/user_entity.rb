...
class UserEntity
  ...
  # @return [User, Hash] the loaded User; raises BluefinDecryptxP2peError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [User, Hash] the removed User; raises BluefinDecryptxP2peError on failure
