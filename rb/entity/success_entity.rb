...
class SuccessEntity
  ...
  def make
    opts = @_entopts.dup
    SuccessEntity.new(@_client, opts)
  end
  ...
  # @return [Success, Hash] the created Success; raises BluefinDecryptxP2peError on failure
  ...
  #
  # @param reqmatch [SuccessRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Success, Hash] the removed Success; raises BluefinDecryptxP2peError on failure
