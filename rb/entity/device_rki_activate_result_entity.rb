...
class DeviceRkiActivateResultEntity
  ...
  def make
    opts = @_entopts.dup
    DeviceRkiActivateResultEntity.new(@_client, opts)
  end
  ...
  # @return [DeviceRkiActivateResult, Hash] the current DeviceRkiActivateResult data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DeviceRkiActivateResult fields)
  def match_get
  ...
  #
  # @param reqdata [DeviceRkiActivateResultCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [DeviceRkiActivateResult, Hash] the created DeviceRkiActivateResult; raises BluefinDecryptxP2peError on failure
