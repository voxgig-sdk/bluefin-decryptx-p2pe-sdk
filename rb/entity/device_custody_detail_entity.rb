...
class DeviceCustodyDetailEntity
  ...
  def make
    opts = @_entopts.dup
    DeviceCustodyDetailEntity.new(@_client, opts)
  end
  ...
  # @return [DeviceCustodyDetail, Hash] the current DeviceCustodyDetail data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DeviceCustodyDetail fields)
  def match_get
  ...
  #
  # @param reqmatch [DeviceCustodyDetailLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.DeviceCustodyDetail.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [DeviceCustodyDetail, Hash] the loaded DeviceCustodyDetail; raises BluefinDecryptxP2peError on failure
