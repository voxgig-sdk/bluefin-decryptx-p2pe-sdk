...
class DecryptionEntity
  ...
  def make
    opts = @_entopts.dup
    DecryptionEntity.new(@_client, opts)
  end
  ...
  # @return [Decryption, Hash] the current Decryption data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Decryption fields)
  def match_get
  ...
  #
  # @param reqdata [DecryptionCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Decryption, Hash] the created Decryption; raises BluefinDecryptxP2peError on failure
