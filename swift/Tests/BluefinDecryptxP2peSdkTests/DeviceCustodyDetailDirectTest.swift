// device_custody_detail direct API test (generated from the API model).

import XCTest

@testable import BluefinDecryptxP2peSdk

final class DeviceCustodyDetailDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let sdk = BluefinDecryptxP2peSDK(opts)

    let args = VMap()
    args.entries["path"] = .string("/device_custody_detail")
