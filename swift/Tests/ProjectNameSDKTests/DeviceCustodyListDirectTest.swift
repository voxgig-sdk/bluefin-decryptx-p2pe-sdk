// device_custody_list direct API test (generated from the API model).

import XCTest

@testable import BluefinDecryptxP2peSdk

final class DeviceCustodyListDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let args = VMap()
    args.entries["path"] = .string("/device_custody_list")
