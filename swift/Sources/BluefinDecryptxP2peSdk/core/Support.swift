// BluefinDecryptxP2pe SDK - shared value helpers for the loose object model.
//
...
// does not define.
func unsupportedOp(_ opname: String, _ entityname: String) -> BluefinDecryptxP2peError {
...
func errMessage(_ e: Error) -> String {
  if let se = e as? BluefinDecryptxP2peError { return se.message }
