// BluefinDecryptxP2pe SDK - operation context.
//
...
public final class Context {
  ...
  public var client: BluefinDecryptxP2peSDK?
  ...
  public init(_ ctxmap: [String: Any?]?, _ basectx: Context?) {
    ...
    // Client
    if let sdk = ctxProp(ctxmap, "client") as? BluefinDecryptxP2peSDK { client = sdk }
  ...
  public func makeError(_ code: String, _ msg: String) -> BluefinDecryptxP2peError {
