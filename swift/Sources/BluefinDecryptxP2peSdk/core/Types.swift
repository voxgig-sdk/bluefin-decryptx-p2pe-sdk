// BluefinDecryptxP2pe SDK - core contracts.
...
// BluefinDecryptxP2peEntityBase which implements this.
...
// Throws (typically BluefinDecryptxP2peError) on transport-level failure. A returned
