// BluefinDecryptxP2peEntityBase - shared entity behaviour: construction, data/match
...
open class BluefinDecryptxP2peEntityBase: Entity {
  var name: String
  var client: BluefinDecryptxP2peSDK
  var utility: Utility
  var entopts: VMap
  var data = VMap()
  var match = VMap()
  ...
  public init(_ client: BluefinDecryptxP2peSDK, _ entoptsIn: VMap?, _ name: String) {
  ...
  open func make() -> Entity {
    return BluefinDecryptxP2peEntityBase(client, cloneOpts(), name)
  }
