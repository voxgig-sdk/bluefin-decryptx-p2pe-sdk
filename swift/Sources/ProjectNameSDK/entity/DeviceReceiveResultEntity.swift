...
public final class DeviceReceiveResultEntity: BluefinDecryptxP2peEntityBase {
  public init(_ client: BluefinDecryptxP2peSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "device_receive_result")
  }

  public override func make() -> Entity {
    return DeviceReceiveResultEntity(client, cloneOpts())
  }
