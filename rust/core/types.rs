...
/// BluefinDecryptxP2peEntity: the full CRUD contract every generated entity
/// implements. Ops the API spec doesn't define are runtime-error stubs.
pub trait BluefinDecryptxP2peEntity: Entity + Sized {
...
pub type FetcherFn =
    Rc<dyn Fn(&Rc<Context>, &str, &Value) -> Result<Value, BluefinDecryptxP2peError>>;
