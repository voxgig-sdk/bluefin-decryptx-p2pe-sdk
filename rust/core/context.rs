...
pub struct CtxSpec {
    ...
    pub client: Option<Rc<BluefinDecryptxP2peSDK>>,
...
pub struct Context {
    ...
    pub client: RefCell<Option<Rc<BluefinDecryptxP2peSDK>>>,
...
impl Context {
    ...
    pub fn make_error(&self, code: &str, msg: &str) -> BluefinDecryptxP2peError {
