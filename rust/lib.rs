// BluefinDecryptxP2pe SDK for Rust (generated by @voxgig/sdkgen).
//
...
pub use crate::core::error::BluefinDecryptxP2peError;
...
pub use crate::core::sdk::{test_sdk, BluefinDecryptxP2peSDK};
pub use crate::core::spec::Spec;
pub use crate::core::types::{
    Entity, Feature, FeatureRef, FetcherFn, OutVal, BluefinDecryptxP2peEntity,
};
...
// No-argument convenience constructors: `bluefin_decryptx_p2pe_sdk::new()` /
// `bluefin_decryptx_p2pe_sdk::test()` for the common no-options case.
use std::rc::Rc;

pub fn new() -> Rc<BluefinDecryptxP2peSDK> {
    BluefinDecryptxP2peSDK::new(Value::Noval)
}

pub fn test() -> Rc<BluefinDecryptxP2peSDK> {
