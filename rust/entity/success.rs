// Success entity client (generated — mirrors the go Entity fragment).
...
impl SuccessEntity {
    pub fn new(client: &Rc<BluefinDecryptxP2peSDK>, entopts: Value) -> Rc<SuccessEntity> {
...
impl Entity for SuccessEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        SuccessEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinDecryptxP2peEntity for SuccessEntity {
    ...
    fn remove(self: &Rc<Self>, reqmatch: Value, ctrl: Value) -> Result<Rc<Self>, BluefinDecryptxP2peError> {
        let ctx = self.utility.make_context(
            CtxSpec {
