// DeviceList entity client (generated — mirrors the go Entity fragment).
...
impl DeviceListEntity {
    pub fn new(client: &Rc<BluefinDecryptxP2peSDK>, entopts: Value) -> Rc<DeviceListEntity> {
...
impl Entity for DeviceListEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        DeviceListEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinDecryptxP2peEntity for DeviceListEntity {
