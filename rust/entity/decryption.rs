// Decryption entity client (generated — mirrors the go Entity fragment).
...
impl DecryptionEntity {
    pub fn new(client: &Rc<BluefinDecryptxP2peSDK>, entopts: Value) -> Rc<DecryptionEntity> {
...
impl Entity for DecryptionEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        DecryptionEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinDecryptxP2peEntity for DecryptionEntity {
