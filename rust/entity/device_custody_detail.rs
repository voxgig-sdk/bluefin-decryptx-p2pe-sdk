// DeviceCustodyDetail entity client (generated — mirrors the go Entity fragment).
...
pub struct DeviceCustodyDetailEntity {
    name: String,
    #[allow(dead_code)]
...
impl DeviceCustodyDetailEntity {
    pub fn new(client: &Rc<BluefinDecryptxP2peSDK>, entopts: Value) -> Rc<DeviceCustodyDetailEntity> {
        ...
        let e = Rc::new(DeviceCustodyDetailEntity {
            name: "device_custody_detail".to_string(),
            client: client.clone(),
...
impl Entity for DeviceCustodyDetailEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        DeviceCustodyDetailEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinDecryptxP2peEntity for DeviceCustodyDetailEntity {
