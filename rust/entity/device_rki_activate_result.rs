// DeviceRkiActivateResult entity client (generated — mirrors the go Entity fragment).
...
use crate::core::sdk::BluefinDecryptxP2peSDK;
use crate::core::types::{Entity, BluefinDecryptxP2peEntity};
use crate::core::utility_type::Utility;
use crate::utility::voxgigstruct as vs;
use crate::utility::voxgigstruct::Value;

pub struct DeviceRkiActivateResultEntity {
    name: String,
    #[allow(dead_code)]
...
impl DeviceRkiActivateResultEntity {
    pub fn new(client: &Rc<BluefinDecryptxP2peSDK>, entopts: Value) -> Rc<DeviceRkiActivateResultEntity> {
        ...
        let e = Rc::new(DeviceRkiActivateResultEntity {
            name: "device_rki_activate_result".to_string(),
            client: client.clone(),
    ...
    pub fn stream(
        ...
        args: Value,
        callopts: Value,
    ) -> Result<std::vec::IntoIter<Value>, BluefinDecryptxP2peError> {
...
impl Entity for DeviceRkiActivateResultEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        DeviceRkiActivateResultEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinDecryptxP2peEntity for DeviceRkiActivateResultEntity {
    fn load(self: &Rc<Self>, _reqmatch: Value, _ctrl: Value) -> Result<Rc<Self>, BluefinDecryptxP2peError> {
        Err(crate::core::helpers::unsupported_op("load", &self.name))
    }

    fn list(self: &Rc<Self>, _reqmatch: Value, _ctrl: Value) -> Result<Vec<Rc<Self>>, BluefinDecryptxP2peError> {
        Err(crate::core::helpers::unsupported_op("list", &self.name))
    }


    fn create(self: &Rc<Self>, reqdata: Value, ctrl: Value) -> Result<Rc<Self>, BluefinDecryptxP2peError> {
        let ctx = self.utility.make_context(
            CtxSpec {
