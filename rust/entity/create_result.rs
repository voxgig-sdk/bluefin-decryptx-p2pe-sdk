// CreateResult entity client (generated — mirrors the go Entity fragment).
...
impl CreateResultEntity {
    pub fn new(client: &Rc<BluefinDecryptxP2peSDK>, entopts: Value) -> Rc<CreateResultEntity> {
        ...
        let e = Rc::new(CreateResultEntity {
...
impl Entity for CreateResultEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        CreateResultEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinDecryptxP2peEntity for CreateResultEntity {
