// DeviceCustodyList entity client (generated — mirrors the go Entity fragment).
...
pub struct DeviceCustodyListEntity {
    name: String,
    #[allow(dead_code)]
...
impl DeviceCustodyListEntity {
    pub fn new(client: &Rc<BluefinDecryptxP2peSDK>, entopts: Value) -> Rc<DeviceCustodyListEntity> {
        ...
        let e = Rc::new(DeviceCustodyListEntity {
            name: "device_custody_list".to_string(),
            client: client.clone(),
...
impl Entity for DeviceCustodyListEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        DeviceCustodyListEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinDecryptxP2peEntity for DeviceCustodyListEntity {
    ...
    fn list(self: &Rc<Self>, reqmatch: Value, ctrl: Value) -> Result<Vec<Rc<Self>>, BluefinDecryptxP2peError> {
        ...
        if let Value::List(list) = &out {
            for entry in list.borrow().iter() {
                let ent = DeviceCustodyListEntity::new(&self.client, vs::clone(&self.entopts));
