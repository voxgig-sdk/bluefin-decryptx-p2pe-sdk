// DeviceType entity client (generated — mirrors the go Entity fragment).
...
impl DeviceTypeEntity {
    pub fn new(client: &Rc<BluefinDecryptxP2peSDK>, entopts: Value) -> Rc<DeviceTypeEntity> {
...
impl Entity for DeviceTypeEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        DeviceTypeEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
