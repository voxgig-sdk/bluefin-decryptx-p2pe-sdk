// DeviceReceiveResult entity client (generated — mirrors the go Entity fragment).
...
pub struct DeviceReceiveResultEntity {
    name: String,
    #[allow(dead_code)]
...
impl DeviceReceiveResultEntity {
    pub fn new(client: &Rc<BluefinDecryptxP2peSDK>, entopts: Value) -> Rc<DeviceReceiveResultEntity> {
        ...
        let e = Rc::new(DeviceReceiveResultEntity {
            name: "device_receive_result".to_string(),
            client: client.clone(),
...
impl Entity for DeviceReceiveResultEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        DeviceReceiveResultEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinDecryptxP2peEntity for DeviceReceiveResultEntity {
