...
impl UpdateResultEntity {
    pub fn new(client: &Rc<BluefinDecryptxP2peSDK>, entopts: Value) -> Rc<UpdateResultEntity> {
...
impl BluefinDecryptxP2peEntity for UpdateResultEntity {
    ...
    fn update(self: &Rc<Self>, reqdata: Value, ctrl: Value) -> Result<Rc<Self>, BluefinDecryptxP2peError> {
        let ctx = self.utility.make_context(
            CtxSpec {
