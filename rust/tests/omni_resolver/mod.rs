...
// tm/swift/Tests/BluefinDecryptxP2peSDKTests/OmniResolver.swift, and it follows the
...
use bluefin_decryptx_p2pe_sdk::utility::voxgigstruct::ordered_map::OrderedMap;
use bluefin_decryptx_p2pe_sdk::utility::voxgigstruct::value::Value;
use bluefin_decryptx_p2pe_sdk::utility::voxgigstruct::InjectDef;
use bluefin_decryptx_p2pe_sdk::BluefinDecryptxP2peError;
...
pub fn vget(val: &Value, key: &str) -> Value {
    bluefin_decryptx_p2pe_sdk::utility::voxgigstruct::lookup(val, &Value::str(key))
}
