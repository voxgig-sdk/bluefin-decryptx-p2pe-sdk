...
test('stream', (t) async {
    ...
    test('basic', (t) async {
      ...
      if (true == setup['syntheticOnly']) {
        t.skip('live entity test uses synthetic IDs from fixture — set BLUEFIN_DECRYPTX_P_PE_TEST_LOCATION_ENTID JSON to run live');
        return;
      }
      ...
      final location_ref01_list = await location_ref01_ent.list(location_ref01_match);
      ...
      final location_ref01_data_dt0 = await location_ref01_ent.load(location_ref01_match_dt0);
      ...
      final location_ref01_list_rt0 = await location_ref01_ent.list(location_ref01_match_rt0);
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_DECRYPTX_P_PE_TEST_LOCATION_ENTID'];
