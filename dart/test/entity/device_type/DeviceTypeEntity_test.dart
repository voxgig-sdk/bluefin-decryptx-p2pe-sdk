...
test('stream', (t) async {
    ...
    test('basic', (t) async {
      ...
      final device_type_ref01_list = (await device_type_ref01_ent.list(device_type_ref01_match)).map((e) => e.data()).toList();


      // LOAD
      final device_type_ref01_match_dt0 = <String, dynamic>{};
      device_type_ref01_match_dt0['id'] = device_type_ref01_data['id'];
      final device_type_ref01_data_dt0 = (await device_type_ref01_ent.load(device_type_ref01_match_dt0)).data();
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_DECRYPTX_P2PE_TEST_DEVICE_TYPE_ENTID'];
