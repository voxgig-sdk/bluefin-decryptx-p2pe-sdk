...
void tests() {
  describe('DeviceCustodyDetailDirect', () {
    ...
    test('direct-load-device_custody_detail', (t) async {
      final setup = directSetup({'id': 'direct01'});
      if (maybeSkipControl(
          t, 'direct', 'direct-load-device_custody_detail', true == setup['live'])) {
        return;
      }
      if (skipIfMissingIds(t, setup, ["device_type01","id01","serial_number01"])) {
        return;
      }
