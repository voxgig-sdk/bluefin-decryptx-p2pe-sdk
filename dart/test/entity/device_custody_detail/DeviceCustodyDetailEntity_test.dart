  ...
  describe('DeviceCustodyDetailEntity', () {
    ...
    test('basic', (t) async {
      ...
      if (true == setup['syntheticOnly']) {
        t.skip('live entity test uses synthetic IDs from fixture — set BLUEFIN_DECRYPTX_P2PE_TEST_DEVICE_CUSTODY_DETAIL_ENTID JSON to run live');
        return;
      }
      ...
      final device_custody_detail_ref01_data_dt0 = (await device_custody_detail_ref01_ent.load(device_custody_detail_ref01_match_dt0)).data();
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_DECRYPTX_P2PE_TEST_DEVICE_CUSTODY_DETAIL_ENTID'];
