...
void tests() {
  describe('DeviceCustodyDetailEntity', () {
    test('instance', (t) async {
      final testsdk = BluefinDecryptxP2peSDK.test();
      final ent = testsdk.DeviceCustodyDetail();
      ok(null != ent);
    });
    ...
    test('stream', (t) async {
      ...
      final plainent = plainsdk.DeviceCustodyDetail();
      final seen2 = [];
    ...
    test('basic', (t) async {
      ...
      for (final op in ['load']) {
        if (maybeSkipControl(t, 'entityOp', 'device_custody_detail.' + op, live)) {
          return;
        }
      }
      ...
      if (true == setup['syntheticOnly']) {
        t.skip('live entity test uses synthetic IDs from fixture — set BLUEFIN_DECRYPTX_P_PE_TEST_DEVICE_CUSTODY_DETAIL_ENTID JSON to run live');
        return;
      }
      ...
      final device_custody_detail_ref01_data =
          (setup['data']['existing']['device_custody_detail'] as Map).values.first;

      // LOAD
      final device_custody_detail_ref01_ent = client.DeviceCustodyDetail();
      final device_custody_detail_ref01_match_dt0 = <String, dynamic>{};
      device_custody_detail_ref01_match_dt0['id'] = device_custody_detail_ref01_data['id'];
      final device_custody_detail_ref01_data_dt0 = await device_custody_detail_ref01_ent.load(device_custody_detail_ref01_match_dt0);
      ok(device_custody_detail_ref01_data_dt0['id'] == device_custody_detail_ref01_data['id']);
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  dynamic idmap = transform(
      <dynamic>['device_custody_detail01', 'device_custody_detail02', 'device_custody_detail03', 'device01', 'device02', 'device03'],
      <String, dynamic>{
        '`\$PACK`': <dynamic>[
          '',
          <String, dynamic>{
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_DECRYPTX_P_PE_TEST_DEVICE_CUSTODY_DETAIL_ENTID'];
