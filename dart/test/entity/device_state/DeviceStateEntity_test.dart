...
test('stream', (t) async {
    ...
    test('basic', (t) async {
      ...
      final device_state_ref01_list = (await device_state_ref01_ent.list(device_state_ref01_match)).map((e) => e.data()).toList();
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_DECRYPTX_P2PE_TEST_DEVICE_STATE_ENTID'];
