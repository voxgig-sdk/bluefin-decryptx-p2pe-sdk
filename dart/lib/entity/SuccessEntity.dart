...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (Success and the per-op request/match types).
class SuccessEntity extends BluefinDecryptxP2peEntityBase {
  SuccessEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'success';
    name_ = 'success';
    Name = 'Success';
  }
  ...
  SuccessEntity make() {
    return SuccessEntity(client, entopts());
  }




  /// Create a Success (see SuccessCreateData in
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (Success).
  ...
  /// Remove a Success by match (see SuccessRemoveMatch in
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (Success).
