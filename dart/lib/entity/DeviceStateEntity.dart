...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (DeviceState and the per-op request/match types).
class DeviceStateEntity extends BluefinDecryptxP2peEntityBase {
  DeviceStateEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'device_state';
    name_ = 'device_state';
    Name = 'DeviceState';
  }

  DeviceStateEntity make() {
    return DeviceStateEntity(client, entopts());
  }



  /// List DeviceState entities by match (see DeviceStateListMatch in
  /// BluefinDecryptxP2peTypes.dart). Returns a list of DeviceState entity instances.
