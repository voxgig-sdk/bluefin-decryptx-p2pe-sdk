...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (DeviceReceiveResult and the per-op request/match types).
class DeviceReceiveResultEntity extends BluefinDecryptxP2peEntityBase {
  DeviceReceiveResultEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'device_receive_result';
    name_ = 'device_receive_result';
    Name = 'DeviceReceiveResult';
  }

  DeviceReceiveResultEntity make() {
    return DeviceReceiveResultEntity(client, entopts());
  }




  /// Create a DeviceReceiveResult (see DeviceReceiveResultCreateData in
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (DeviceReceiveResult).
