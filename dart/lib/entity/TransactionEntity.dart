...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (Transaction and the per-op request/match types).
class TransactionEntity extends BluefinDecryptxP2peEntityBase {
  ...
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (Transaction).
  ...
  /// BluefinDecryptxP2peTypes.dart). Returns a list of Transaction entity instances.
  ...
  /// Create a Transaction (see TransactionCreateData in
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (Transaction).
