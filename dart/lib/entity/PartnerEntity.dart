...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (Partner and the per-op request/match types).
class PartnerEntity extends BluefinDecryptxP2peEntityBase {
  ...
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (Partner).
  ...
  /// BluefinDecryptxP2peTypes.dart). Returns a list of Partner entity instances.
