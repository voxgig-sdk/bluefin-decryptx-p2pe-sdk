...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (Decryption and the per-op request/match types).
class DecryptionEntity extends BluefinDecryptxP2peEntityBase {
  DecryptionEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'decryption';
    name_ = 'decryption';
    Name = 'Decryption';
  }

  DecryptionEntity make() {
    return DecryptionEntity(client, entopts());
  }




  /// Create a Decryption (see DecryptionCreateData in
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (Decryption).
