...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (UpdateResult and the per-op request/match types).
class UpdateResultEntity extends BluefinDecryptxP2peEntityBase {
  ...
  /// BluefinDecryptxP2peTypes.dart). Returns a list of UpdateResult entity instances.
  ...
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (UpdateResult).
