...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (DeviceType and the per-op request/match types).
class DeviceTypeEntity extends BluefinDecryptxP2peEntityBase {
  DeviceTypeEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'device_type';
    name_ = 'device_type';
    Name = 'DeviceType';
  }

  DeviceTypeEntity make() {
    return DeviceTypeEntity(client, entopts());
  }


  /// Load a DeviceType by match (see DeviceTypeLoadMatch in
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (DeviceType).
  ...
  /// List DeviceType entities by match (see DeviceTypeListMatch in
  /// BluefinDecryptxP2peTypes.dart). Returns a list of DeviceType entity instances.
