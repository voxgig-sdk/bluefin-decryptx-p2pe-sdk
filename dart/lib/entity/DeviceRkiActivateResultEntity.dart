...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (DeviceRkiActivateResult and the per-op request/match types).
class DeviceRkiActivateResultEntity extends BluefinDecryptxP2peEntityBase {
  DeviceRkiActivateResultEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'device_rki_activate_result';
    name_ = 'device_rki_activate_result';
    Name = 'DeviceRkiActivateResult';
  }

  DeviceRkiActivateResultEntity make() {
    return DeviceRkiActivateResultEntity(client, entopts());
  }




  /// Create a DeviceRkiActivateResult (see DeviceRkiActivateResultCreateData in
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (DeviceRkiActivateResult).
