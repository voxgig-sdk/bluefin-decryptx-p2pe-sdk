...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (CreateResult and the per-op request/match types).
class CreateResultEntity extends BluefinDecryptxP2peEntityBase {
  CreateResultEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'create_result';
    name_ = 'create_result';
    Name = 'CreateResult';
  }

  CreateResultEntity make() {
    return CreateResultEntity(client, entopts());
  }




  /// Create a CreateResult (see CreateResultCreateData in
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (CreateResult).
