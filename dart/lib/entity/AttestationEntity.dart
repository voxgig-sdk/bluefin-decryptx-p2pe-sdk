...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (Attestation and the per-op request/match types).
class AttestationEntity extends BluefinDecryptxP2peEntityBase {
  AttestationEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'attestation';
    name_ = 'attestation';
    Name = 'Attestation';
  }

  AttestationEntity make() {
    return AttestationEntity(client, entopts());
  }


  /// Load a Attestation by match (see AttestationLoadMatch in
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (Attestation).
  ...
  /// List Attestation entities by match (see AttestationListMatch in
  /// BluefinDecryptxP2peTypes.dart). Returns a list of Attestation entity instances.
  ...
  /// Create a Attestation (see AttestationCreateData in
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (Attestation).
