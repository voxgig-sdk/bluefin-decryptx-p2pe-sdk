...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (Device and the per-op request/match types).
class DeviceEntity extends BluefinDecryptxP2peEntityBase {
  DeviceEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'device';
    name_ = 'device';
    Name = 'Device';
  }
  ...
  DeviceEntity make() {
    return DeviceEntity(client, entopts());
  }


  /// Load a Device by match (see DeviceLoadMatch in
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (Device).
  ...
  /// List Device entities by match (see DeviceListMatch in
  /// BluefinDecryptxP2peTypes.dart). Returns a list of Device entity instances.
  ...
  /// Create a Device (see DeviceCreateData in
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (Device).
