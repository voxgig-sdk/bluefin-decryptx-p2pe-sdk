...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (Client and the per-op request/match types).
class ClientEntity extends BluefinDecryptxP2peEntityBase {
  ...
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (Client).
  ...
  /// BluefinDecryptxP2peTypes.dart). Returns a list of Client entity instances.
