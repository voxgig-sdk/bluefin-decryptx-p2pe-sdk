...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (Kif and the per-op request/match types).
class KifEntity extends BluefinDecryptxP2peEntityBase {
  KifEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'kif';
    name_ = 'kif';
    Name = 'Kif';
  }
  ...
  KifEntity make() {
    return KifEntity(client, entopts());
  }



  /// List Kif entities by match (see KifListMatch in
  /// BluefinDecryptxP2peTypes.dart). Returns a list of Kif entity instances.
