...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (DeviceCustodyDetail and the per-op request/match types).
class DeviceCustodyDetailEntity extends BluefinDecryptxP2peEntityBase {
  DeviceCustodyDetailEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'device_custody_detail';
    name_ = 'device_custody_detail';
    Name = 'DeviceCustodyDetail';
  }

  DeviceCustodyDetailEntity make() {
    return DeviceCustodyDetailEntity(client, entopts());
  }


  /// Load a DeviceCustodyDetail by match (see DeviceCustodyDetailLoadMatch in
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (DeviceCustodyDetail).
