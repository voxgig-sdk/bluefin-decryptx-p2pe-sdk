...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (User and the per-op request/match types).
class UserEntity extends BluefinDecryptxP2peEntityBase {
  ...
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (User).
  ...
  /// Remove a User by match (see UserRemoveMatch in
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (User).
