...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (DeviceCustodyList and the per-op request/match types).
class DeviceCustodyListEntity extends BluefinDecryptxP2peEntityBase {
  DeviceCustodyListEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'device_custody_list';
    name_ = 'device_custody_list';
    Name = 'DeviceCustodyList';
  }

  DeviceCustodyListEntity make() {
    return DeviceCustodyListEntity(client, entopts());
  }



  /// List DeviceCustodyList entities by match (see DeviceCustodyListListMatch in
  /// BluefinDecryptxP2peTypes.dart). Returns a list of DeviceCustodyList entity instances.
