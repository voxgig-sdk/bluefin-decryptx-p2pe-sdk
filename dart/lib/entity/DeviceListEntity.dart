...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (DeviceList and the per-op request/match types).
class DeviceListEntity extends BluefinDecryptxP2peEntityBase {
  DeviceListEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'device_list';
    name_ = 'device_list';
    Name = 'DeviceList';
  }

  DeviceListEntity make() {
    return DeviceListEntity(client, entopts());
  }


  /// Load a DeviceList by match (see DeviceListLoadMatch in
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (DeviceList).
