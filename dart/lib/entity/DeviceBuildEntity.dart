...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (DeviceBuild and the per-op request/match types).
class DeviceBuildEntity extends BluefinDecryptxP2peEntityBase {
  DeviceBuildEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'device_build';
    name_ = 'device_build';
    Name = 'DeviceBuild';
  }

  DeviceBuildEntity make() {
    return DeviceBuildEntity(client, entopts());
  }


  /// Load a DeviceBuild by match (see DeviceBuildLoadMatch in
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (DeviceBuild).
  ...
  /// List DeviceBuild entities by match (see DeviceBuildListMatch in
  /// BluefinDecryptxP2peTypes.dart). Returns a list of DeviceBuild entity instances.
