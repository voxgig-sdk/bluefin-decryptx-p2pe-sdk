...
// Typed models: see ../BluefinDecryptxP2peTypes.dart (Shipment and the per-op request/match types).
class ShipmentEntity extends BluefinDecryptxP2peEntityBase {
  ShipmentEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'shipment';
    name_ = 'shipment';
    Name = 'Shipment';
  }
  ...
  ShipmentEntity make() {
    return ShipmentEntity(client, entopts());
  }


  /// Load a Shipment by match (see ShipmentLoadMatch in
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (Shipment).
  ...
  /// List Shipment entities by match (see ShipmentListMatch in
  /// BluefinDecryptxP2peTypes.dart). Returns a list of Shipment entity instances.
  ...
  /// Create a Shipment (see ShipmentCreateData in
  /// BluefinDecryptxP2peTypes.dart). Returns the entity data map (Shipment).
