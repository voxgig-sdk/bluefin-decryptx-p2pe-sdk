// Command BluefinDecryptxP2pe-mcp is an MCP server exposing the BluefinDecryptxP2pe
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BluefinDecryptxP2pe_list  — list records of an entity
//	BluefinDecryptxP2pe_load  — load a single record of an entity
//
