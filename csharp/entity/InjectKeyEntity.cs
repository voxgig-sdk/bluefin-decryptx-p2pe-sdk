...
public class InjectKeyEntity : BluefinDecryptxP2peEntityBase
{
    public InjectKeyEntity(BluefinDecryptxP2peSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "inject_key")
    {
    }

    public override IEntity Make()
    {
        return new InjectKeyEntity(client, CloneOpts());
    }
