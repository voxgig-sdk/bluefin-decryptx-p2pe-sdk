...
public class CreateResultEntity : BluefinDecryptxP2peEntityBase
{
    public CreateResultEntity(BluefinDecryptxP2peSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "create_result")
    {
    }

    public override IEntity Make()
    {
        return new CreateResultEntity(client, CloneOpts());
    }
