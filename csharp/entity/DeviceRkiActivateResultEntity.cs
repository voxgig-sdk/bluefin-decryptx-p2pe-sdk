...
public class DeviceRkiActivateResultEntity : BluefinDecryptxP2peEntityBase
{
    public DeviceRkiActivateResultEntity(BluefinDecryptxP2peSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "device_rki_activate_result")
    {
    }

    public override IEntity Make()
    {
        return new DeviceRkiActivateResultEntity(client, CloneOpts());
    }
