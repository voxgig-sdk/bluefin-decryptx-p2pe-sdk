// DeviceList entity client for the BluefinDecryptxP2pe SDK.

using Voxgig.Struct;

namespace BluefinDecryptxP2peSdk.Entity;

public class DeviceListEntity : BluefinDecryptxP2peEntityBase
{
    public DeviceListEntity(BluefinDecryptxP2peSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "device_list")
    {
    }

    public override IEntity Make()
    {
        return new DeviceListEntity(client, CloneOpts());
    }
