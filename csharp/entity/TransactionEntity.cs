// Transaction entity client for the BluefinDecryptxP2pe SDK.

using Voxgig.Struct;

namespace BluefinDecryptxP2peSdk.Entity;

public class TransactionEntity : BluefinDecryptxP2peEntityBase
{
    public TransactionEntity(BluefinDecryptxP2peSDK client, Dictionary<string, object?>? entopts = null)
