// Decryption entity client for the BluefinDecryptxP2pe SDK.

using Voxgig.Struct;

namespace BluefinDecryptxP2peSdk.Entity;

public class DecryptionEntity : BluefinDecryptxP2peEntityBase
{
    public DecryptionEntity(BluefinDecryptxP2peSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "decryption")
    {
    }

    public override IEntity Make()
    {
        return new DecryptionEntity(client, CloneOpts());
    }
