// Client entity client for the BluefinDecryptxP2pe SDK.

using Voxgig.Struct;

namespace BluefinDecryptxP2peSdk.Entity;

public class ClientEntity : BluefinDecryptxP2peEntityBase
{
    public ClientEntity(BluefinDecryptxP2peSDK client, Dictionary<string, object?>? entopts = null)
