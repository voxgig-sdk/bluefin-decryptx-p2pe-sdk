// Location entity client for the BluefinDecryptxP2pe SDK.

using Voxgig.Struct;

namespace BluefinDecryptxP2peSdk.Entity;

public class LocationEntity : BluefinDecryptxP2peEntityBase
{
    public LocationEntity(BluefinDecryptxP2peSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "location")
    {
    }

    public override IEntity Make()
    {
        return new LocationEntity(client, CloneOpts());
    }
