// DeviceType entity client for the BluefinDecryptxP2pe SDK.

using Voxgig.Struct;

namespace BluefinDecryptxP2peSdk.Entity;

public class DeviceTypeEntity : BluefinDecryptxP2peEntityBase
{
    public DeviceTypeEntity(BluefinDecryptxP2peSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "device_type")
    {
    }

    public override IEntity Make()
    {
        return new DeviceTypeEntity(client, CloneOpts());
    }
