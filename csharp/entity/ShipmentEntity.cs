// Shipment entity client for the BluefinDecryptxP2pe SDK.

using Voxgig.Struct;

namespace BluefinDecryptxP2peSdk.Entity;

public class ShipmentEntity : BluefinDecryptxP2peEntityBase
{
    public ShipmentEntity(BluefinDecryptxP2peSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "shipment")
    {
    }

    public override IEntity Make()
    {
        return new ShipmentEntity(client, CloneOpts());
    }
