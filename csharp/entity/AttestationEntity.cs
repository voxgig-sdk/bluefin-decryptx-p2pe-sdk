// Attestation entity client for the BluefinDecryptxP2pe SDK.

using Voxgig.Struct;

namespace BluefinDecryptxP2peSdk.Entity;

public class AttestationEntity : BluefinDecryptxP2peEntityBase
{
    public AttestationEntity(BluefinDecryptxP2peSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "attestation")
    {
    }

    public override IEntity Make()
    {
        return new AttestationEntity(client, CloneOpts());
    }
