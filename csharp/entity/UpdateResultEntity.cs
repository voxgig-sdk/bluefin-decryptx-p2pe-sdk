// UpdateResult entity client for the BluefinDecryptxP2pe SDK.

using Voxgig.Struct;

namespace BluefinDecryptxP2peSdk.Entity;

public class UpdateResultEntity : BluefinDecryptxP2peEntityBase
{
    public UpdateResultEntity(BluefinDecryptxP2peSDK client, Dictionary<string, object?>? entopts = null)
