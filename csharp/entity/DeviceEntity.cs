// Device entity client for the BluefinDecryptxP2pe SDK.

using Voxgig.Struct;

namespace BluefinDecryptxP2peSdk.Entity;

public class DeviceEntity : BluefinDecryptxP2peEntityBase
{
    public DeviceEntity(BluefinDecryptxP2peSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "device")
    {
    }

    public override IEntity Make()
    {
        return new DeviceEntity(client, CloneOpts());
    }
