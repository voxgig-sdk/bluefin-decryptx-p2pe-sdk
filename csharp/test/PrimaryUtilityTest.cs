...
public class PrimaryUtilityTest
{
    ...
    private static OmniResolver.Run Run()
    {
        lock (RunLock)
        {
            if (RUN == null)
            {
                CLIENT = BluefinDecryptxP2peSDK.TestSDK(null, null);
    ...
    private static BluefinDecryptxP2peSDK GetClient()
    {
        Run();
        return CLIENT!;
    }
    ...
    private static Context MakeTestCtx(BluefinDecryptxP2peSDK client, Utility utility,
    ...
    private static Context MakeTestFullCtx(BluefinDecryptxP2peSDK client, Utility utility)
    {
    ...
    {
        var hookClient = BluefinDecryptxP2peSDK.TestSDK(null, null);
    ...
    {
        var initClient = BluefinDecryptxP2peSDK.TestSDK(null, null);
    ...
    public void FetcherBlockedTestMode()
    {
        ...
        var blockedClient = new BluefinDecryptxP2peSDK(new Dictionary<string, object?>
        {
            ["base"] = "http://localhost:8080",
            ["system"] = new Dictionary<string, object?>
            {
    ...
    public void MakeSpecBasic()
    {
        ...
        var specClient = BluefinDecryptxP2peSDK.TestSDK(null, setupOpts);
    ...
    // BluefinDecryptxP2peError. The corpus says `match: out: code` for both, so
    ...
    public void MakePointBasic()
    {
        runsection("makePoint", args =>
        {
            ...
            catch (BluefinDecryptxP2peError e)
            {
    ...
    public void PrepareAuthBasic()
    {
        ...
        var authClient = BluefinDecryptxP2peSDK.TestSDK(null, setupOpts);
