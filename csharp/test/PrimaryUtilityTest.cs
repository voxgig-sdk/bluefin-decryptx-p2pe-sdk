...
public class PrimaryUtilityTest
{
    ...
    private readonly BluefinDecryptxP2peSDK _client;
    ...
    public PrimaryUtilityTest()
    {
        ...
        _client = BluefinDecryptxP2peSDK.TestSDK(null, null);
        _utility = _client.GetUtility();
    }

    // Helper: create basic test context.
    private Context MakeTestCtx(BluefinDecryptxP2peSDK client, Utility utility,
    ...
    private Context MakeTestFullCtx(BluefinDecryptxP2peSDK client, Utility utility)
    {
