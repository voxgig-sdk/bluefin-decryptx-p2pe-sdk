...
public class AttestationEntityTest
{
    ...
    public void Basic()
    {
        ...
        // and 4xx; set BLUEFIN_DECRYPTX_P2PE_TEST_ATTESTATION_ENTID JSON to run live.
        ...
        attestationRef01Data = Helpers.ToMapAny(attestationRef01DataResult is IEntity ce ? ce.Data() : attestationRef01DataResult);
        ...
        var attestationRef01DataDt0LoadResult = Helpers.ToMapAny(attestationRef01DataDt0Loaded is IEntity le ? le.Data() : attestationRef01DataDt0Loaded);
