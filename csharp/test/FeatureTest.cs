...
internal static class Fh
{
    ...
    {
        return err is BluefinDecryptxP2peError se ? se.Code : "";
    }
}
...
public class FeaturePagingTest
{
    ...
    public void StampsPageLimitAndReadsHeaders()
    {
        ...
        Assert.Equal(2, BluefinDecryptxP2peSdk.Helpers.ToInt(paging["nextPage"]));
        Assert.Equal(5, BluefinDecryptxP2peSdk.Helpers.ToInt(paging["totalCount"]));
