...
public class DeviceBuildEntityTest
{
    ...
    public void Basic()
    {
        ...
        // and 4xx; set BLUEFIN_DECRYPTX_P2PE_TEST_DEVICE_BUILD_ENTID JSON to run live.
        ...
        var deviceBuildRef01DataDt0LoadResult = Helpers.ToMapAny(deviceBuildRef01DataDt0Loaded is IEntity le ? le.Data() : deviceBuildRef01DataDt0Loaded);
