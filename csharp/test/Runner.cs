// BluefinDecryptxP2pe SDK test-runner SUPPORT (vendor-tag rollout): env overrides,
...
public static class TestRunner
{
    ...
    {
        if (Environment.GetEnvironmentVariable("BLUEFIN_DECRYPTX_P2PE_TEST_LIVE") == "TRUE" ||
            Environment.GetEnvironmentVariable("BLUEFIN_DECRYPTX_P2PE_TEST_OVERRIDE") == "TRUE")
        {
        ...
        var explain = Environment.GetEnvironmentVariable("BLUEFIN_DECRYPTX_P2PE_TEST_EXPLAIN");
    ...
    public static int LiveDelayMs()
    {
        ...
        {
            var n = BluefinDecryptxP2peSdk.Helpers.ToInt(v);
            if (n >= 0)
            {
                return n;
            }
    ...
    public static Context MakeCtxFromMap(Dictionary<string, object?>? ctxmap,
        BluefinDecryptxP2peSDK? client, Utility? utility)
    {
            ...
            resRaw is Dictionary<string, object?> resMap)
        {
            ...
            {
                ctx.Result.Err = new BluefinDecryptxP2peError("", msg, null);
            }
        }
    ...
    public static void FixCtx(Context ctx, BluefinDecryptxP2peSDK client)
    {
    ...
    public static Exception? ErrFromMap(Dictionary<string, object?>? m)
    {
        ...
        return new BluefinDecryptxP2peError(code, msg, null);
    }
