// device_state direct API tests (generated from the API model).
...
public class DeviceStateDirectTest
{
    [Fact]
    public void DirectList()
    {
        var setup = DeviceStateDirectSetup(new List<object?>
        {
        ...
        var (_shouldSkip, _) = TestRunner.IsControlSkipped(
            "direct", "direct-list-device_state", _mode);
        if (_shouldSkip)
        {
    ...
    private class DeviceStateDirectSetupResult
    {
    ...
    private static DeviceStateDirectSetupResult DeviceStateDirectSetup(object? mockres)
    {
        ...
        if (live)
        {
            ...
            return new DeviceStateDirectSetupResult
            {
                Client = liveClient,
                Calls = calls,
                Live = true,
