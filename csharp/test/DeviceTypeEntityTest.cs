...
public class DeviceTypeEntityTest
{
    ...
    public void Basic()
    {
        ...
        // and 4xx; set BLUEFIN_DECRYPTX_P2PE_TEST_DEVICE_TYPE_ENTID JSON to run live.
        ...
        var deviceTypeRef01DataDt0LoadResult = Helpers.ToMapAny(deviceTypeRef01DataDt0Loaded is IEntity le ? le.Data() : deviceTypeRef01DataDt0Loaded);
