// kif direct API tests (generated from the API model).
...
public class KifDirectTest
{
    [Fact]
    public void DirectList()
    {
        var setup = KifDirectSetup(new List<object?>
        {
    ...
    private class KifDirectSetupResult
    {
    ...
    private static KifDirectSetupResult KifDirectSetup(object? mockres)
    {
        ...
        {
            ["BLUEFIN_DECRYPTX_P2PE_TEST_KIF_ENTID"] = new Dictionary<string, object?>(),
        ...
        if (live)
        {
            ...
            var entidRaw = env["BLUEFIN_DECRYPTX_P2PE_TEST_KIF_ENTID"];
            ...
            return new KifDirectSetupResult
            {
                Client = liveClient,
                Calls = calls,
                Live = true,
