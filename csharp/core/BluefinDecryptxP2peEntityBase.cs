...
public abstract class BluefinDecryptxP2peEntityBase : IEntity
{
    protected string name;
    protected BluefinDecryptxP2peSDK client;
    ...
    protected BluefinDecryptxP2peEntityBase(BluefinDecryptxP2peSDK client,
