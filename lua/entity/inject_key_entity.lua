...
local InjectKeyEntity = {}
InjectKeyEntity.__index = InjectKeyEntity


function InjectKeyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, InjectKeyEntity)
  self._name = "inject_key"
  self._client = client
...
function InjectKeyEntity:get_name()
  return self._name
end


function InjectKeyEntity:make()
  local opts = {}
...
function InjectKeyEntity:mark_deleted()
  self._deleted = true
end


function InjectKeyEntity:deleted()
  return true == self._deleted
end


function InjectKeyEntity:data_set(args)
  if args ~= nil then
...
function InjectKeyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function InjectKeyEntity:match_set(args)
  if args ~= nil then
...
function InjectKeyEntity:match_get()
...
function InjectKeyEntity:stream(action, args, callopts)
...
---@param reqmatch InjectKeyLoadMatch
---@param ctrl? table
---@return InjectKey
---@return string? err
function InjectKeyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch InjectKeyListMatch
---@param ctrl? table
---@return InjectKey[]
---@return string? err
function InjectKeyEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function InjectKeyEntity:_run_op(ctx, post_done)
  local utility = self._utility
