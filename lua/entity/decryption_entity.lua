...
local DecryptionEntity = {}
DecryptionEntity.__index = DecryptionEntity


function DecryptionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DecryptionEntity)
  self._name = "decryption"
  self._client = client
...
function DecryptionEntity:get_name()
  return self._name
end


function DecryptionEntity:make()
  local opts = {}
...
function DecryptionEntity:mark_deleted()
  self._deleted = true
end


function DecryptionEntity:deleted()
  return true == self._deleted
end


function DecryptionEntity:data_set(args)
  if args ~= nil then
...
function DecryptionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DecryptionEntity:match_set(args)
  if args ~= nil then
...
function DecryptionEntity:match_get()
...
function DecryptionEntity:stream(action, args, callopts)
...
---@param reqdata DecryptionCreateData
---@param ctrl? table
---@return Decryption
---@return string? err
function DecryptionEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function DecryptionEntity:_run_op(ctx, post_done)
  local utility = self._utility
