...
---@param reqdata LocationCreateData
---@param ctrl? table
---@return Location
---@return string? err
function LocationEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqmatch LocationRemoveMatch
---@param ctrl? table
---@return Location
---@return string? err
function LocationEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
