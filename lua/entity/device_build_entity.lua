...
local DeviceBuildEntity = {}
DeviceBuildEntity.__index = DeviceBuildEntity


function DeviceBuildEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeviceBuildEntity)
  self._name = "device_build"
  self._client = client
...
function DeviceBuildEntity:get_name()
  return self._name
end


function DeviceBuildEntity:make()
  local opts = {}
...
function DeviceBuildEntity:mark_deleted()
  self._deleted = true
end


function DeviceBuildEntity:deleted()
  return true == self._deleted
end


function DeviceBuildEntity:data_set(args)
  if args ~= nil then
...
function DeviceBuildEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeviceBuildEntity:match_set(args)
  if args ~= nil then
...
function DeviceBuildEntity:match_get()
...
function DeviceBuildEntity:stream(action, args, callopts)
...
---@param reqmatch DeviceBuildLoadMatch
---@param ctrl? table
---@return DeviceBuild
---@return string? err
function DeviceBuildEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch DeviceBuildListMatch
---@param ctrl? table
---@return DeviceBuild[]
---@return string? err
function DeviceBuildEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function DeviceBuildEntity:_run_op(ctx, post_done)
  local utility = self._utility
