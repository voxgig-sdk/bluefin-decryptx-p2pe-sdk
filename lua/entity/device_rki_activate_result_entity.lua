...
local DeviceRkiActivateResultEntity = {}
DeviceRkiActivateResultEntity.__index = DeviceRkiActivateResultEntity


function DeviceRkiActivateResultEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeviceRkiActivateResultEntity)
  self._name = "device_rki_activate_result"
  self._client = client
...
function DeviceRkiActivateResultEntity:get_name()
  return self._name
end


function DeviceRkiActivateResultEntity:make()
  local opts = {}
...
function DeviceRkiActivateResultEntity:mark_deleted()
  self._deleted = true
end


function DeviceRkiActivateResultEntity:deleted()
  return true == self._deleted
end


function DeviceRkiActivateResultEntity:data_set(args)
  if args ~= nil then
...
function DeviceRkiActivateResultEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeviceRkiActivateResultEntity:match_set(args)
  if args ~= nil then
...
function DeviceRkiActivateResultEntity:match_get()
...
function DeviceRkiActivateResultEntity:stream(action, args, callopts)
...
---@param reqdata DeviceRkiActivateResultCreateData
---@param ctrl? table
---@return DeviceRkiActivateResult
---@return string? err
function DeviceRkiActivateResultEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function DeviceRkiActivateResultEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DeviceRkiActivateResultEntity
