...
local KifEntity = {}
KifEntity.__index = KifEntity


function KifEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, KifEntity)
  self._name = "kif"
  self._client = client
...
function KifEntity:get_name()
  return self._name
end


function KifEntity:make()
  local opts = {}
...
function KifEntity:mark_deleted()
  self._deleted = true
end


function KifEntity:deleted()
  return true == self._deleted
end


function KifEntity:data_set(args)
  if args ~= nil then
...
function KifEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function KifEntity:match_set(args)
  if args ~= nil then
...
function KifEntity:stream(action, args, callopts)
...
---@param reqmatch KifListMatch
---@param ctrl? table
---@return Kif[]
---@return string? err
function KifEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function KifEntity:_run_op(ctx, post_done)
  local utility = self._utility
