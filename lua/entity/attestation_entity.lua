...
local AttestationEntity = {}
AttestationEntity.__index = AttestationEntity


function AttestationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AttestationEntity)
  self._name = "attestation"
  self._client = client
...
function AttestationEntity:get_name()
  return self._name
end


function AttestationEntity:make()
  local opts = {}
...
function AttestationEntity:mark_deleted()
  self._deleted = true
end


function AttestationEntity:deleted()
  return true == self._deleted
end


function AttestationEntity:data_set(args)
  if args ~= nil then
...
function AttestationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AttestationEntity:match_set(args)
  if args ~= nil then
...
function AttestationEntity:match_get()
...
function AttestationEntity:stream(action, args, callopts)
...
---@param reqmatch AttestationLoadMatch
---@param ctrl? table
---@return Attestation
---@return string? err
function AttestationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch AttestationListMatch
---@param ctrl? table
---@return Attestation[]
---@return string? err
function AttestationEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata AttestationCreateData
---@param ctrl? table
---@return Attestation
---@return string? err
function AttestationEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function AttestationEntity:_run_op(ctx, post_done)
  local utility = self._utility
