...
local DeviceTypeEntity = {}
DeviceTypeEntity.__index = DeviceTypeEntity


function DeviceTypeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeviceTypeEntity)
...
function DeviceTypeEntity:get_name()
  return self._name
end


function DeviceTypeEntity:make()
  local opts = {}
...
function DeviceTypeEntity:mark_deleted()
  self._deleted = true
end


function DeviceTypeEntity:deleted()
  return true == self._deleted
end


function DeviceTypeEntity:data_set(args)
  if args ~= nil then
...
function DeviceTypeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeviceTypeEntity:match_set(args)
  if args ~= nil then
...
function DeviceTypeEntity:match_get()
...
function DeviceTypeEntity:stream(action, args, callopts)
...
---@param reqmatch DeviceTypeLoadMatch
---@param ctrl? table
---@return DeviceType
---@return string? err
function DeviceTypeEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch DeviceTypeListMatch
---@param ctrl? table
---@return DeviceType[]
---@return string? err
function DeviceTypeEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function DeviceTypeEntity:_run_op(ctx, post_done)
  local utility = self._utility
