...
local DeviceStateEntity = {}
DeviceStateEntity.__index = DeviceStateEntity


function DeviceStateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeviceStateEntity)
  self._name = "device_state"
  self._client = client
...
function DeviceStateEntity:get_name()
  return self._name
end


function DeviceStateEntity:make()
  local opts = {}
...
function DeviceStateEntity:mark_deleted()
  self._deleted = true
end


function DeviceStateEntity:deleted()
  return true == self._deleted
end


function DeviceStateEntity:data_set(args)
  if args ~= nil then
...
function DeviceStateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeviceStateEntity:match_set(args)
  if args ~= nil then
...
function DeviceStateEntity:match_get()
...
function DeviceStateEntity:stream(action, args, callopts)
...
---@param reqmatch DeviceStateListMatch
---@param ctrl? table
---@return DeviceState[]
---@return string? err
function DeviceStateEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function DeviceStateEntity:_run_op(ctx, post_done)
  local utility = self._utility
