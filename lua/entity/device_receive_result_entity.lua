...
local DeviceReceiveResultEntity = {}
DeviceReceiveResultEntity.__index = DeviceReceiveResultEntity


function DeviceReceiveResultEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeviceReceiveResultEntity)
  self._name = "device_receive_result"
  self._client = client
...
function DeviceReceiveResultEntity:get_name()
  return self._name
end


function DeviceReceiveResultEntity:make()
  local opts = {}
...
function DeviceReceiveResultEntity:mark_deleted()
  self._deleted = true
end


function DeviceReceiveResultEntity:deleted()
  return true == self._deleted
end


function DeviceReceiveResultEntity:data_set(args)
  if args ~= nil then
...
function DeviceReceiveResultEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeviceReceiveResultEntity:match_set(args)
  if args ~= nil then
...
function DeviceReceiveResultEntity:match_get()
...
function DeviceReceiveResultEntity:stream(action, args, callopts)
...
---@param reqdata DeviceReceiveResultCreateData
---@param ctrl? table
---@return DeviceReceiveResult
---@return string? err
function DeviceReceiveResultEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function DeviceReceiveResultEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DeviceReceiveResultEntity
