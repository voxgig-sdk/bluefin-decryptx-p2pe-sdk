...
function TransactionEntity:mark_deleted()
  self._deleted = true
end


function TransactionEntity:deleted()
...
---@param reqdata TransactionCreateData
---@param ctrl? table
---@return Transaction
---@return string? err
function TransactionEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
