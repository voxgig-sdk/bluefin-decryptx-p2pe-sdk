...
local SuccessEntity = {}
SuccessEntity.__index = SuccessEntity


function SuccessEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SuccessEntity)
  self._name = "success"
  self._client = client
...
function SuccessEntity:get_name()
  return self._name
end


function SuccessEntity:make()
  local opts = {}
...
function SuccessEntity:mark_deleted()
  self._deleted = true
end


function SuccessEntity:deleted()
  return true == self._deleted
end


function SuccessEntity:data_set(args)
  if args ~= nil then
...
function SuccessEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SuccessEntity:match_set(args)
  if args ~= nil then
...
function SuccessEntity:match_get()
...
function SuccessEntity:stream(action, args, callopts)
...
---@param reqmatch SuccessRemoveMatch
---@param ctrl? table
---@return Success
---@return string? err
function SuccessEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function SuccessEntity:_run_op(ctx, post_done)
  local utility = self._utility
