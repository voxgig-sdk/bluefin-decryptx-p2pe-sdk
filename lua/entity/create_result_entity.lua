...
local CreateResultEntity = {}
CreateResultEntity.__index = CreateResultEntity


function CreateResultEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CreateResultEntity)
  self._name = "create_result"
  self._client = client
...
function CreateResultEntity:get_name()
  return self._name
end


function CreateResultEntity:make()
  local opts = {}
...
function CreateResultEntity:mark_deleted()
  self._deleted = true
end


function CreateResultEntity:deleted()
  return true == self._deleted
end


function CreateResultEntity:data_set(args)
  if args ~= nil then
...
function CreateResultEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CreateResultEntity:match_set(args)
  if args ~= nil then
...
function CreateResultEntity:match_get()
...
function CreateResultEntity:stream(action, args, callopts)
...
---@param reqdata CreateResultCreateData
---@param ctrl? table
---@return CreateResult
---@return string? err
function CreateResultEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function CreateResultEntity:_run_op(ctx, post_done)
  local utility = self._utility
