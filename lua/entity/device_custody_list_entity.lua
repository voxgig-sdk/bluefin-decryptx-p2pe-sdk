...
local DeviceCustodyListEntity = {}
DeviceCustodyListEntity.__index = DeviceCustodyListEntity


function DeviceCustodyListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeviceCustodyListEntity)
  self._name = "device_custody_list"
  self._client = client
...
function DeviceCustodyListEntity:get_name()
  return self._name
end


function DeviceCustodyListEntity:make()
  local opts = {}
...
function DeviceCustodyListEntity:mark_deleted()
  self._deleted = true
end


function DeviceCustodyListEntity:deleted()
  return true == self._deleted
end


function DeviceCustodyListEntity:data_set(args)
  if args ~= nil then
...
function DeviceCustodyListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeviceCustodyListEntity:match_set(args)
  if args ~= nil then
...
function DeviceCustodyListEntity:match_get()
...
function DeviceCustodyListEntity:stream(action, args, callopts)
...
---@param reqmatch DeviceCustodyListListMatch
---@param ctrl? table
---@return DeviceCustodyList[]
---@return string? err
function DeviceCustodyListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function DeviceCustodyListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DeviceCustodyListEntity
