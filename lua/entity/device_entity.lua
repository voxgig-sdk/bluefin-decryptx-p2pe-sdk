...
function DeviceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeviceEntity)
  self._name = "device"
  self._client = client
...
function DeviceEntity:get_name()
  return self._name
end


function DeviceEntity:make()
  local opts = {}
...
function DeviceEntity:mark_deleted()
  self._deleted = true
end


function DeviceEntity:deleted()
  return true == self._deleted
end


function DeviceEntity:data_set(args)
  if args ~= nil then
...
function DeviceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeviceEntity:match_set(args)
  if args ~= nil then
...
function DeviceEntity:match_get()
...
function DeviceEntity:stream(action, args, callopts)
...
---@param reqmatch DeviceLoadMatch
---@param ctrl? table
---@return Device
---@return string? err
function DeviceEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch DeviceListMatch
---@param ctrl? table
---@return Device[]
---@return string? err
function DeviceEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata DeviceCreateData
---@param ctrl? table
---@return Device
---@return string? err
function DeviceEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function DeviceEntity:_run_op(ctx, post_done)
  local utility = self._utility
