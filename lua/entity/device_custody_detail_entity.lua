...
local DeviceCustodyDetailEntity = {}
DeviceCustodyDetailEntity.__index = DeviceCustodyDetailEntity


function DeviceCustodyDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeviceCustodyDetailEntity)
  self._name = "device_custody_detail"
  self._client = client
...
function DeviceCustodyDetailEntity:get_name()
  return self._name
end


function DeviceCustodyDetailEntity:make()
  local opts = {}
...
function DeviceCustodyDetailEntity:mark_deleted()
  self._deleted = true
end


function DeviceCustodyDetailEntity:deleted()
  return true == self._deleted
end


function DeviceCustodyDetailEntity:data_set(args)
  if args ~= nil then
...
function DeviceCustodyDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeviceCustodyDetailEntity:match_set(args)
  if args ~= nil then
...
function DeviceCustodyDetailEntity:match_get()
...
function DeviceCustodyDetailEntity:stream(action, args, callopts)
...
---@param reqmatch DeviceCustodyDetailLoadMatch
---@param ctrl? table
---@return DeviceCustodyDetail
---@return string? err
function DeviceCustodyDetailEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function DeviceCustodyDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DeviceCustodyDetailEntity
