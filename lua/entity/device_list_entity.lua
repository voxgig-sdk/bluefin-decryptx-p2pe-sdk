...
local DeviceListEntity = {}
DeviceListEntity.__index = DeviceListEntity


function DeviceListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeviceListEntity)
  self._name = "device_list"
  self._client = client
...
function DeviceListEntity:get_name()
  return self._name
end


function DeviceListEntity:make()
  local opts = {}
...
function DeviceListEntity:mark_deleted()
  self._deleted = true
end


function DeviceListEntity:deleted()
  return true == self._deleted
end


function DeviceListEntity:data_set(args)
  if args ~= nil then
...
function DeviceListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeviceListEntity:match_set(args)
  if args ~= nil then
...
function DeviceListEntity:match_get()
...
function DeviceListEntity:stream(action, args, callopts)
...
---@param reqmatch DeviceListLoadMatch
---@param ctrl? table
---@return DeviceList
---@return string? err
function DeviceListEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function DeviceListEntity:_run_op(ctx, post_done)
  local utility = self._utility
