...
describe("AttestationDirect", function()
  it("should direct-list-attestation", function()
    local setup = attestation_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-attestation", setup.live and "live" or "unit")
  ...
  it("should direct-load-attestation", function()
    local setup = attestation_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-attestation", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function attestation_direct_setup(mockres)
