...
describe("KifDirect", function()
  it("should direct-list-kif", function()
    local setup = kif_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-kif", setup.live and "live" or "unit")
...
function kif_direct_setup(mockres)
