...
describe("DeviceListDirect", function()
  it("should direct-load-device_list", function()
    local setup = device_list_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-device_list", setup.live and "live" or "unit")
...
function device_list_direct_setup(mockres)
