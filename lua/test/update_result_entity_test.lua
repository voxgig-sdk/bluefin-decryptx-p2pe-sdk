...
describe("UpdateResultEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BLUEFINDECRYPTXP_PE_TEST_UPDATE_RESULT_ENTID JSON to run live")
      return
    end
...
function update_result_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BLUEFINDECRYPTXP_PE_TEST_UPDATE_RESULT_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["BLUEFINDECRYPTXP_PE_TEST_UPDATE_RESULT_ENTID"])
