...
describe("UpdateResultEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BLUEFIN_DECRYPTX_P2PE_TEST_UPDATE_RESULT_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    update_result_ref01_data = helpers.to_map(type(update_result_ref01_data_result) == 'table' and update_result_ref01_data_result.data_get and update_result_ref01_data_result:data_get() or update_result_ref01_data_result)
    ...
    local update_result_ref01_markdef_up0_name = "email"
    ...
    assert.is_nil(err)
    local update_result_ref01_resdata_up0 = helpers.to_map(type(update_result_ref01_resdata_up0_result) == 'table' and update_result_ref01_resdata_up0_result.data_get and update_result_ref01_resdata_up0_result:data_get() or update_result_ref01_resdata_up0_result)
...
function update_result_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BLUEFIN_DECRYPTX_P2PE_TEST_UPDATE_RESULT_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["BLUEFIN_DECRYPTX_P2PE_TEST_UPDATE_RESULT_ENTID"])
