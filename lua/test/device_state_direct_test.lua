...
describe("DeviceStateDirect", function()
  it("should direct-list-device_state", function()
    local setup = device_state_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-device_state", setup.live and "live" or "unit")
...
function device_state_direct_setup(mockres)
