...
describe("DeviceCustodyDetailDirect", function()
  it("should direct-load-device_custody_detail", function()
    local setup = device_custody_detail_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-device_custody_detail", setup.live and "live" or "unit")
...
function device_custody_detail_direct_setup(mockres)
