...
// BluefinDecryptxP2pe SDK timeout feature
...
class BluefinDecryptxP2peTimeoutFeature extends BluefinDecryptxP2peBaseFeature
{
    ...
    private function _with_timeout(BluefinDecryptxP2peContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BluefinDecryptxP2peContext $_ctx, float $ms): void
    {
        $client = $this->client;
