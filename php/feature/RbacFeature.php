...
// BluefinDecryptxP2pe SDK rbac feature
...
class BluefinDecryptxP2peRbacFeature extends BluefinDecryptxP2peBaseFeature
{
    ...
    private function _required(BluefinDecryptxP2peContext $ctx): ?string
    {
    ...
    private function _reject(BluefinDecryptxP2peContext $ctx, string $required): void
    {
    ...
    private function _track(BluefinDecryptxP2peContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
