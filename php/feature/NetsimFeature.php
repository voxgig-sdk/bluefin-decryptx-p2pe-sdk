...
// BluefinDecryptxP2pe SDK netsim feature
...
class BluefinDecryptxP2peNetsimFeature extends BluefinDecryptxP2peBaseFeature
{
    ...
    private function _simulate(BluefinDecryptxP2peContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BluefinDecryptxP2peContext $ctx, array $applied): void
    {
        $client = $this->client;
