...
// BluefinDecryptxP2pe SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BluefinDecryptxP2peMakeRequest
{
    public static function call(BluefinDecryptxP2peContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BluefinDecryptxP2peResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BluefinDecryptxP2peResponse($fetched);
        } else {
