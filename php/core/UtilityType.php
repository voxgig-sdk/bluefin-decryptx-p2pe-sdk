...
// BluefinDecryptxP2pe SDK utility type

class BluefinDecryptxP2peUtility
{
    ...
    public static function copy(BluefinDecryptxP2peUtility $src): BluefinDecryptxP2peUtility
    {
        $u = new BluefinDecryptxP2peUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
