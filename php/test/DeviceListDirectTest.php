...
class DeviceListDirectTest extends TestCase
{
    public function test_direct_load_device_list(): void
    {
        $setup = device_list_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-device_list", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
