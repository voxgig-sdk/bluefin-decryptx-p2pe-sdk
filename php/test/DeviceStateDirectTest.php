...
class DeviceStateDirectTest extends TestCase
{
    public function test_direct_list_device_state(): void
    {
        $setup = device_state_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-device_state", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
