...
class LocationEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set BLUEFIN_DECRYPTX_P2PE_TEST_LOCATION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $location_ref01_data_result = $location_ref01_ent->create($location_ref01_data, null);
        $location_ref01_data = Helpers::to_map(is_object($location_ref01_data_result) && method_exists($location_ref01_data_result, 'data_get') ? $location_ref01_data_result->data_get() : $location_ref01_data_result);
        $this->assertNotNull($location_ref01_data);
        $this->assertNotNull($location_ref01_data["id"]);
        ...
        $location_ref01_ent->remove($location_ref01_match_rm0, null);

        // LIST
        $location_ref01_match_rt0 = [];

        $location_ref01_list_rt0_result = $location_ref01_ent->list($location_ref01_match_rt0, null);
        $this->assertIsArray($location_ref01_list_rt0_result);
...
function location_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("BLUEFIN_DECRYPTX_P2PE_TEST_LOCATION_ENTID");
