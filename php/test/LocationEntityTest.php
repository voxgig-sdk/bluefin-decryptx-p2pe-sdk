...
class LocationEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set BLUEFINDECRYPTXP_PE_TEST_LOCATION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function location_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("BLUEFINDECRYPTXP_PE_TEST_LOCATION_ENTID");
