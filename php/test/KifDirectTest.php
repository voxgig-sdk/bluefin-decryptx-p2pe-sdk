...
class KifDirectTest extends TestCase
{
    public function test_direct_list_kif(): void
    {
        $setup = kif_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-kif", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
