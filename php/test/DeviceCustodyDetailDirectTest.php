...
class DeviceCustodyDetailDirectTest extends TestCase
{
    public function test_direct_load_device_custody_detail(): void
    {
        $setup = device_custody_detail_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-device_custody_detail", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
