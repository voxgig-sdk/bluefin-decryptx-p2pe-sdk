...
// BluefinDecryptxP2pe SDK pipeline test
//
...
{
    private static function utility(): BluefinDecryptxP2peUtility
    {
        return new BluefinDecryptxP2peUtility();
    }
    ...
    private static function ctx(array $over = []): BluefinDecryptxP2peContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BluefinDecryptxP2peContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BluefinDecryptxP2peOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BluefinDecryptxP2peError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BluefinDecryptxP2peOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BluefinDecryptxP2peMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BluefinDecryptxP2peOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BluefinDecryptxP2peMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BluefinDecryptxP2peOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BluefinDecryptxP2peMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BluefinDecryptxP2peSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BluefinDecryptxP2peMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BluefinDecryptxP2peResponse([]),
            'result' => new BluefinDecryptxP2peResult([]),
        ]);
        [, $err] = BluefinDecryptxP2peMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BluefinDecryptxP2peSpec([]),
            'response' => null,
            'result' => new BluefinDecryptxP2peResult([]),
        ]);
        [, $err] = BluefinDecryptxP2peMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BluefinDecryptxP2peSpec(['step' => 's']),
            'response' => new BluefinDecryptxP2peResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BluefinDecryptxP2peResult([]),
        ]);
        [, $err] = BluefinDecryptxP2peMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BluefinDecryptxP2peSpec(['step' => 's']),
            'response' => new BluefinDecryptxP2peResponse(self::resp(200, ['v' => 1])),
            'result' => new BluefinDecryptxP2peResult([]),
        ]);
        [, $err] = BluefinDecryptxP2peMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BluefinDecryptxP2peSpec(['step' => 's']),
            'response' => new BluefinDecryptxP2peResponse(self::resp(200, ['v' => 2])),
            'result' => new BluefinDecryptxP2peResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BluefinDecryptxP2peMakeResponse::call($ctx);
    ...
    {
        $preset = new BluefinDecryptxP2peResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BluefinDecryptxP2peSpec([]),
            'response' => new BluefinDecryptxP2peResponse([]),
            'result' => new BluefinDecryptxP2peResult([]),
        ...
        [$got, $err] = BluefinDecryptxP2peMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BluefinDecryptxP2peResult([])]);
        [, $err] = BluefinDecryptxP2peMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BluefinDecryptxP2peSpec([]), 'result' => null]);
        [, $err] = BluefinDecryptxP2peMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BluefinDecryptxP2peSpec(['step' => 's']),
            'result' => new BluefinDecryptxP2peResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BluefinDecryptxP2peOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BluefinDecryptxP2peMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BluefinDecryptxP2peSpec(['step' => 's']),
            'result' => new BluefinDecryptxP2peResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BluefinDecryptxP2peOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BluefinDecryptxP2peMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BluefinDecryptxP2peResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BluefinDecryptxP2peSpec([]),
            'result' => new BluefinDecryptxP2peResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BluefinDecryptxP2peMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BluefinDecryptxP2peMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BluefinDecryptxP2peError('boom', 'boom');
        $utility->fetcher = function (BluefinDecryptxP2peContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BluefinDecryptxP2peSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BluefinDecryptxP2peMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BluefinDecryptxP2peContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BluefinDecryptxP2peMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BluefinDecryptxP2peResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        BluefinDecryptxP2peMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BluefinDecryptxP2peContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BluefinDecryptxP2peSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BluefinDecryptxP2peMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BluefinDecryptxP2peResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BluefinDecryptxP2peSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BluefinDecryptxP2peMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BluefinDecryptxP2peMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BluefinDecryptxP2peMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BluefinDecryptxP2peResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BluefinDecryptxP2peDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BluefinDecryptxP2peResult(['ok' => false])]);
        $this->expectException(BluefinDecryptxP2peError::class);
        BluefinDecryptxP2peDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BluefinDecryptxP2peResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BluefinDecryptxP2peMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BluefinDecryptxP2peMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BluefinDecryptxP2peBaseFeature();
        $b = new BluefinDecryptxP2peBaseFeature();
        BluefinDecryptxP2peFeatureAdd::call($ctx, $a);
        BluefinDecryptxP2peFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BluefinDecryptxP2peBaseFeature
    {
        $f = new BluefinDecryptxP2peBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BluefinDecryptxP2peFeatureAdd::call($ctx, self::named_feature('a'));
        BluefinDecryptxP2peFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        BluefinDecryptxP2peFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        BluefinDecryptxP2peFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        BluefinDecryptxP2peFeatureAdd::call($ctx, $replace);
        ...
        BluefinDecryptxP2peFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BluefinDecryptxP2peContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BluefinDecryptxP2peSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BluefinDecryptxP2pePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        BluefinDecryptxP2pePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BluefinDecryptxP2peResponse(['headers' => null]),
            'result' => new BluefinDecryptxP2peResult([]),
        ]);
        BluefinDecryptxP2peResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        BluefinDecryptxP2peResultBody::call($ctx);
