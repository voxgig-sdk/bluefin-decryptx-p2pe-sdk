...
class SuccessEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SuccessEntity($this->_client, $opts);
    }

    /**
     * @param Success|array $args Success data (assoc-array) to store.
     */
    ...
    /**
     * @return Success|array The current Success data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Success fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Success fields).
     */
     ...
     *
     * @param SuccessCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SuccessCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Success|array The created Success as an assoc-array at the
     ...
     *
     * @param SuccessRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; SuccessRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Success|array The removed Success as an assoc-array at the
     *   SDK boundary; throws BluefinDecryptxP2peError on failure (item-5 convention).
     */
