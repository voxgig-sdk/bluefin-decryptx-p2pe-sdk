...
// BluefinDecryptxP2pe SDK DeviceType entity
...
class DeviceTypeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeviceTypeEntity($this->_client, $opts);
    }

    /**
     * @param DeviceType|array $args DeviceType data (assoc-array) to store.
     */
    ...
    /**
     * @return DeviceType|array The current DeviceType data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeviceType fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeviceType fields).
     */
    ...
    /**
     * Load a single DeviceType.
     *
     * @param DeviceTypeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DeviceTypeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeviceType|array The loaded DeviceType as an assoc-array at the
    ...
    /**
     * List DeviceType items matching the given filter.
     *
     * @param DeviceTypeListMatch|array|null $reqmatch Match filter (any subset
     *   of DeviceType fields) as an assoc-array; DeviceTypeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeviceType[]|array A list of DeviceType items as assoc-arrays at
