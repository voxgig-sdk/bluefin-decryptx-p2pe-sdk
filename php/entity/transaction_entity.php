...
class TransactionEntity
{
     ...
     *
     * @param TransactionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TransactionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Transaction|array The created Transaction as an assoc-array at the
     *   SDK boundary; throws BluefinDecryptxP2peError on failure (item-5 convention).
     */
