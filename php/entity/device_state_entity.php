...
class DeviceStateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeviceStateEntity($this->_client, $opts);
    }

    /**
     * @param DeviceState|array $args DeviceState data (assoc-array) to store.
     */
    ...
    /**
     * @return DeviceState|array The current DeviceState data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeviceState fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeviceState fields).
     */
     ...
     *
     * @param DeviceStateListMatch|array|null $reqmatch Match filter (any subset
     *   of DeviceState fields) as an assoc-array; DeviceStateListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeviceState[]|array A list of DeviceState items as assoc-arrays at
