...
class DeviceEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeviceEntity($this->_client, $opts);
    }

    /**
     * @param Device|array $args Device data (assoc-array) to store.
     */
    ...
    /**
     * @return Device|array The current Device data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Device fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Device fields).
     */
     ...
     *
     * @param DeviceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DeviceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Device|array The loaded Device as an assoc-array at the
     ...
     *
     * @param DeviceListMatch|array|null $reqmatch Match filter (any subset
     *   of Device fields) as an assoc-array; DeviceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Device[]|array A list of Device items as assoc-arrays at
     ...
     * Create a new Device.
     *
     * @param DeviceCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DeviceCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Device|array The created Device as an assoc-array at the
     *   SDK boundary; throws BluefinDecryptxP2peError on failure (item-5 convention).
     */
