...
class DeviceListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeviceListEntity($this->_client, $opts);
    }

    /**
     * @param DeviceList|array $args DeviceList data (assoc-array) to store.
     */
    ...
    /**
     * @return DeviceList|array The current DeviceList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeviceList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeviceList fields).
     */
     ...
     *
     * @param DeviceListLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DeviceListLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeviceList|array The loaded DeviceList as an assoc-array at the
