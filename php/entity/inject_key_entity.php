...
// BluefinDecryptxP2pe SDK InjectKey entity
...
class InjectKeyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InjectKeyEntity($this->_client, $opts);
    }

    /**
     * @param InjectKey|array $args InjectKey data (assoc-array) to store.
     */
    ...
    /**
     * @return InjectKey|array The current InjectKey data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of InjectKey fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of InjectKey fields).
     */
    ...
    /**
     * Load a single InjectKey.
     *
     * @param InjectKeyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed InjectKeyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return InjectKey|array The loaded InjectKey as an assoc-array at the
    ...
    /**
     * List InjectKey items matching the given filter.
     *
     * @param InjectKeyListMatch|array|null $reqmatch Match filter (any subset
     *   of InjectKey fields) as an assoc-array; InjectKeyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return InjectKey[]|array A list of InjectKey items as assoc-arrays at
