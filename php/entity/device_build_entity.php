...
// BluefinDecryptxP2pe SDK DeviceBuild entity
...
class DeviceBuildEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeviceBuildEntity($this->_client, $opts);
    }

    /**
     * @param DeviceBuild|array $args DeviceBuild data (assoc-array) to store.
     */
    ...
    /**
     * @return DeviceBuild|array The current DeviceBuild data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeviceBuild fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeviceBuild fields).
     */
    ...
    /**
     * Load a single DeviceBuild.
     *
     * @param DeviceBuildLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DeviceBuildLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeviceBuild|array The loaded DeviceBuild as an assoc-array at the
    ...
    /**
     * List DeviceBuild items matching the given filter.
     *
     * @param DeviceBuildListMatch|array|null $reqmatch Match filter (any subset
     *   of DeviceBuild fields) as an assoc-array; DeviceBuildListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeviceBuild[]|array A list of DeviceBuild items as assoc-arrays at
