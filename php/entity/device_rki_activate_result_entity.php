...
class DeviceRkiActivateResultEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "device_rki_activate_result";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DeviceRkiActivateResultEntity($this->_client, $opts);
    }

    /**
     * @param DeviceRkiActivateResult|array $args DeviceRkiActivateResult data (assoc-array) to store.
     */
    ...
    /**
     * @return DeviceRkiActivateResult|array The current DeviceRkiActivateResult data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeviceRkiActivateResult fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeviceRkiActivateResult fields).
     */
     ...
     *
     * @param DeviceRkiActivateResultCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DeviceRkiActivateResultCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeviceRkiActivateResult|array The created DeviceRkiActivateResult as an assoc-array at the
