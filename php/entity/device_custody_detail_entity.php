...
// BluefinDecryptxP2pe SDK DeviceCustodyDetail entity
...
class DeviceCustodyDetailEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "device_custody_detail";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DeviceCustodyDetailEntity($this->_client, $opts);
    }

    /**
     * @param DeviceCustodyDetail|array $args DeviceCustodyDetail data (assoc-array) to store.
     */
    ...
    /**
     * @return DeviceCustodyDetail|array The current DeviceCustodyDetail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeviceCustodyDetail fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeviceCustodyDetail fields).
     */
    ...
    /**
     * Load a single DeviceCustodyDetail.
     *
     * @param DeviceCustodyDetailLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DeviceCustodyDetailLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeviceCustodyDetail|array The loaded DeviceCustodyDetail as an assoc-array at the
