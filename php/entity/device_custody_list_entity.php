...
class DeviceCustodyListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "device_custody_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DeviceCustodyListEntity($this->_client, $opts);
    }

    /**
     * @param DeviceCustodyList|array $args DeviceCustodyList data (assoc-array) to store.
     */
    ...
    /**
     * @return DeviceCustodyList|array The current DeviceCustodyList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeviceCustodyList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeviceCustodyList fields).
     */
     ...
     *
     * @param DeviceCustodyListListMatch|array|null $reqmatch Match filter (any subset
     *   of DeviceCustodyList fields) as an assoc-array; DeviceCustodyListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeviceCustodyList[]|array A list of DeviceCustodyList items as assoc-arrays at
