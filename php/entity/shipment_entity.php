...
// BluefinDecryptxP2pe SDK Shipment entity
...
class ShipmentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ShipmentEntity($this->_client, $opts);
    }

    /**
     * @param Shipment|array $args Shipment data (assoc-array) to store.
     */
    ...
    /**
     * @return Shipment|array The current Shipment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Shipment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Shipment fields).
     */
    ...
    /**
     * Load a single Shipment.
     *
     * @param ShipmentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ShipmentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Shipment|array The loaded Shipment as an assoc-array at the
    ...
    /**
     * List Shipment items matching the given filter.
     *
     * @param ShipmentListMatch|array|null $reqmatch Match filter (any subset
     *   of Shipment fields) as an assoc-array; ShipmentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Shipment[]|array A list of Shipment items as assoc-arrays at
     ...
     *
     * @param ShipmentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ShipmentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Shipment|array The created Shipment as an assoc-array at the
     *   SDK boundary; throws BluefinDecryptxP2peError on failure (item-5 convention).
     */
