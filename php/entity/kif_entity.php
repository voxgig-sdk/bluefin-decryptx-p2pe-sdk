...
class KifEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new KifEntity($this->_client, $opts);
    }

    /**
     * @param Kif|array $args Kif data (assoc-array) to store.
     */
    ...
    /**
     * @return Kif|array The current Kif data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Kif fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Kif fields).
     */
     ...
     *
     * @param KifListMatch|array|null $reqmatch Match filter (any subset
     *   of Kif fields) as an assoc-array; KifListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Kif[]|array A list of Kif items as assoc-arrays at
