...
class LocationEntity
{
     ...
     *
     * @param LocationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LocationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Location|array The created Location as an assoc-array at the
     *   SDK boundary; throws BluefinDecryptxP2peError on failure (item-5 convention).
     */
     ...
     *
     * @param LocationRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; LocationRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Location|array The removed Location as an assoc-array at the
     *   SDK boundary; throws BluefinDecryptxP2peError on failure (item-5 convention).
     */
