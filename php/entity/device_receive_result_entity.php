...
class DeviceReceiveResultEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "device_receive_result";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DeviceReceiveResultEntity($this->_client, $opts);
    }

    /**
     * @param DeviceReceiveResult|array $args DeviceReceiveResult data (assoc-array) to store.
     */
    ...
    /**
     * @return DeviceReceiveResult|array The current DeviceReceiveResult data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeviceReceiveResult fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeviceReceiveResult fields).
     */
     ...
     *
     * @param DeviceReceiveResultCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DeviceReceiveResultCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeviceReceiveResult|array The created DeviceReceiveResult as an assoc-array at the
