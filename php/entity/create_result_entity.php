...
class CreateResultEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CreateResultEntity($this->_client, $opts);
    }

    /**
     * @param CreateResult|array $args CreateResult data (assoc-array) to store.
     */
    ...
    /**
     * @return CreateResult|array The current CreateResult data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CreateResult fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CreateResult fields).
     */
     ...
     *
     * @param CreateResultCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CreateResultCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CreateResult|array The created CreateResult as an assoc-array at the
