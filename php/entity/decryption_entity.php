...
class DecryptionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DecryptionEntity($this->_client, $opts);
    }

    /**
     * @param Decryption|array $args Decryption data (assoc-array) to store.
     */
    ...
    /**
     * @return Decryption|array The current Decryption data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Decryption fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Decryption fields).
     */
     ...
     *
     * @param DecryptionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DecryptionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Decryption|array The created Decryption as an assoc-array at the
